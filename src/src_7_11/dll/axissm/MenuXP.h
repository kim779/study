...
public:
	...
	//	add define function
	BOOL	InsertMenuX(UINT nPosition, UINT nFlags, UINT nIDNewItem = 0, LPCTSTR lpszNewItem = NULL);
	BOOL	AppendMenuX(UINT nFlags, UINT nIDNewItem = 0, LPCTSTR lpszNewItem = NULL);
