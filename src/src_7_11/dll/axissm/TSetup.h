...
// Construction
public:
	CTSetup(class CTMenu* menu, CString home, CString user, CWnd* pParent = NULL);   // standard constructor
	virtual ~CTSetup();
...
public:
	afx_msg void OnBnClickedUpmove();
	afx_msg void OnBnClickedDownmove();
};
