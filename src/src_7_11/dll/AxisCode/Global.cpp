...
void CGlobal::LoadBitmaps()
{
	...
	sModulePath.Replace(_T("exe"), _T("image"));
...
CString CGlobal::GetBitmapFileName(UINT nBitmapID)
{
	switch( nBitmapID )
	{
	case IDX_BMP_CAPTION_LEFT				:	return _T("caption_left.bmp");			break;
	case IDX_BMP_CAPTION_CENTER				:	return _T("caption_center.bmp");			break;
	case IDX_BMP_CAPTION_RIGHT				:	return _T("caption_right.bmp");			break;
	case IDX_BMP_FRAME_LEFT					:	return _T("frame_left.bmp");				break;
	case IDX_BMP_FRAME_LEFT_BOTTOM			:	return _T("frame_leftbottom.bmp");		break;
	case IDX_BMP_FRAME_BOTTOM				:	return _T("frame_bottom.bmp");			break;
	case IDX_BMP_FRAME_RIGHT_BOTTOM			:	return _T("frame_rightbottom.bmp");		break;
	case IDX_BMP_FRAME_RIGHT				:	return _T("frame_right.bmp");				break;
	case IDX_BMP_BOX_MINIMIZE				:	return _T("box_minimize.bmp");			break;
	case IDX_BMP_BOX_MAXMIZE				:	return _T("box_maximize.bmp");			break;
	case IDX_BMP_BOX_RESTORE				:	return _T("box_restore.bmp");				break;
	case IDX_BMP_BOX_EXIT					:	return _T("box_exit.bmp");				break;
	case IDX_BMP_BOX_MINIMIZE_ON			:	return _T("box_minimize_on.bmp");			break;
	case IDX_BMP_BOX_MAXMIZE_ON				:	return _T("box_maximize_on.bmp");			break;
	case IDX_BMP_BOX_RESTORE_ON				:	return _T("box_restore_on.bmp");			break;
	case IDX_BMP_BOX_EXIT_ON				:	return _T("box_exit_on.bmp");				break;
	case IDX_BMP_BOX_MINIMIZE_OVER			:	return _T("box_minimize_over.bmp");		break;
	case IDX_BMP_BOX_MAXMIZE_OVER			:	return _T("box_maximize_over.bmp");		break;
	case IDX_BMP_BOX_RESTORE_OVER			:	return _T("box_restore_over.bmp");		break;
	case IDX_BMP_BOX_EXIT_OVER				:	return _T("box_exit_over.bmp");			break;
	case IDX_BMP_BTN_BASE					:	return _T("BTN_65.bmp");				break;
	case IDX_BMP_LIST_HEADER_SHADOW			:	return _T("list_header_shadow.bmp");		break;
	case IDX_BMP_LIST_HEADER_DIVISION		:	
		return _T("list_header_division.bmp");		break;
	}
	return _T("");
}
...
CString CGlobal::GetIconFileName(UINT nIconID)
{
	switch( nIconID )
	{
		case IDX_ICON_SKIN							:	return _T("skin.ico");					break;
		case IDX_ICON_SKIN_INACTIVE					:	return _T("skin_inactive.ico");			break;
		case IDX_ICON_OK							:	return _T("ok.ico");						break;
		case IDX_ICON_CANCEL						:	return _T("close.ico");					break;
		case IDX_ICON_HOME							:	return _T("home.ico");					break;
		case IDX_ICON_FAVORITES						:	return _T("favorites.ico");				break;
		case IDX_ICON_INTERNET						:	return _T("internet.ico");				break;
		case IDX_ICON_SETTING						:	return _T("setting.ico");					break;
	}
	return _T("");
}
