...
IMPLEMENT_DYNAMIC(CXHeaderCtrl, CHeaderCtrl)
...
//void CXHeaderCtrl::OnMButtonDown(UINT nFlags, CPoint point)
//{
//	// TODO: Add your message handler code here and/or call default
//
...
void CXHeaderCtrl::OnMouseHWheel(UINT nFlags, short zDelta, CPoint pt)
{
	// This feature requires Windows Vista or greater.
	// The symbol _WIN32_WINNT must be >= 0x0600.
	// TODO: Add your message handler code here and/or call default

	CHeaderCtrl::OnMouseHWheel(nFlags, zDelta, pt);
}
