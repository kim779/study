========================================================================
		ActiveX Control DLL : XECURE
========================================================================

ControlWizard has created this project for your XECURE ActiveX Control
...
that make up your XECURE ActiveX Control DLL.
...
XecureCtl.h
	This file contains the declaration of the CXecureCtrl C++ class.

XecureCtl.cpp
	This file contains the implementation of the CXecureCtrl C++ class.

XecurePpg.h
	This file contains the declaration of the CXecurePropPage C++ class.

XecurePpg.cpp
	This file contains the implementation of the CXecurePropPage C++ class.

XecureCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CXecureCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Xecure.rc.
