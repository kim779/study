...
#define GUI_TODAY	0x22	// 당일
#define GUI_CME	    0x24	// 야간	
...
#define	BUPCR	RGB(220,   2,   2)	// basic bong up color, 적색
#define	BDNCR	RGB(  0,   1, 200)	// basic bong dn color, 청색
...
#define	DEFCR4	RGB(126,  26,  77)	// default color(갈색)
...
#define	DEFCR8	RGB( 84, 164,   5)	// default color(녹색)
