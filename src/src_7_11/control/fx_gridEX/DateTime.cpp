...
BOOL CDateTime::OnDateTimeChangeNotify(NMHDR *dt, LRESULT* pResult)
{
	*pResult = 0;    // docs say we must return 0

	NMDATETIMECHANGE *dtmh = (NMDATETIMECHANGE*)dt;
...
BOOL CDateTime::OnFormatQuery(NMHDR* lpDT, LRESULT* pResult)
{
	NMDATETIMEFORMATQUERY* lpDTFormatQuery = (NMDATETIMEFORMATQUERY*)lpDT;
