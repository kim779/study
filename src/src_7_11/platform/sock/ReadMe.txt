========================================================================
		ActiveX Control DLL : SOCK
========================================================================

ControlWizard has created this project for your SOCK ActiveX Control
...
that make up your SOCK ActiveX Control DLL.
...
SockCtl.h
	This file contains the declaration of the CSockCtrl C++ class.

SockCtl.cpp
	This file contains the implementation of the CSockCtrl C++ class.

SockPpg.h
	This file contains the declaration of the CSockPropPage C++ class.

SockPpg.cpp
	This file contains the implementation of the CSockPropPage C++ class.

SockCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CSockCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Sock.rc.
