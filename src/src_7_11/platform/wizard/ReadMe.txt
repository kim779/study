========================================================================
		ActiveX Control DLL : WIZARD
========================================================================

ControlWizard has created this project for your WIZARD ActiveX Control
...
that make up your WIZARD ActiveX Control DLL.
...
WizardCtl.h
	This file contains the declaration of the CWizardCtrl C++ class.

WizardCtl.cpp
	This file contains the implementation of the CWizardCtrl C++ class.

WizardPpg.h
	This file contains the declaration of the CWizardPropPage C++ class.

WizardPpg.cpp
	This file contains the implementation of the CWizardPropPage C++ class.

WizardCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CWizardCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Wizard.rc.
