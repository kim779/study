...
int CListBoxST::OnMouseActivate(CWnd* pDesktopWnd, UINT nHitTest, UINT message) 
{
...
void CListBoxST::OnLButtonDblClk(UINT nFlags, CPoint point) 
{
...
void CListBoxST::OnLButtonUp(UINT nFlags, CPoint point) 
{
	int cy = 0;
	for (int ii = 0; ii < GetCount(); ii++)
	{
...
LOGFONT CListBoxST::setFont(int fsize, CString fname, BOOL bBold, BOOL bItalic)
{
	LOGFONT	lf;
