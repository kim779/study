...
"Filter InStr InStrB InStrRev Join LBound Len LenB LCase UCase UBound Left LeftB Mid MidB Right RightB Replace Space Split StrComp String StrReverse LTrim RTrim Trim "
