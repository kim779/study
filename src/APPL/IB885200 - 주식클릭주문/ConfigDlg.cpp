...
//		((CButton *)GetDlgItem(PERCENT_RADIO2))->SetCheck(1);
	...
	((CButton *)GetDlgItem(PGSI_CHK))->SetCheck(m_config.pgsi);
...
void CConfigDlg::InitData()
{
	...
	m_config.pgsi = GetDataInt("HOGAJUMUN", "pgsi", 0, m_file);
}
...
void CConfigDlg::OnOK()
{
	...
	tmpS.Format("%d", m_config.pgsi);
	SetData("HOGAJUMUN", "pgsi", tmpS, m_file);
...
//		m_config.percentRadio = 1;
	...
	m_config.pgsi = ((CButton *)GetDlgItem(PGSI_CHK))->GetCheck();
}
