...
// Konstanden f?r Farben (TVM_SETBKCOLOR)
...
#define 	TVC_BOX					6					// Äu?ere Farbe der Schaltfl?chen
...
// Konstanden f?r GetNextItem (TVM_GETNEXTITEM)
...
// Konstanden f?r InsertColumn (mask)
...
#define 	TVS_EX_SUBSELECT		0x00040000			// Sub-Eitr?ge seperat ausw?hlen
...
// Konstanden f?r neue Nachrichten
