...
public:
	...
	void	SetMonthCalFont(const CFont& font, BOOL bRedraw = TRUE);
...
protected:
	...
	//}}AFX_MSG
	virtual BOOL OnDateTimeChangeNotify(NMHDR* phdr, LRESULT* pResult);
...
//	virtual BOOL OnFormat(NMDATETIMEFORMAT* lpNMFormat, LRESULT* pResult);
	virtual BOOL OnFormatQuery(NMHDR* phdr, LRESULT* pResult);
