...
BOOL CCategory::CreateCategory(CWnd* parent, CRect rect, CString root)
{
	...
	return CWnd::Create(nullptr, "category_window", WS_CHILD|WS_VISIBLE, rect, parent, 5001);
}
