/////////////////////////////////////////////////////////////////////////////
// colorBtn.cpp : implementation file for the CFxButton class
//
...
{  
#if (_MFC_VER < 0x0250)
  hwndOwner = nullptr;  // initialize hwndOwner for GetOwner() and SetOwner() support in MFC < 2.5
#endif 
} 
...
BOOL CFxButton::Attach(const UINT nID, CWnd* pParent, const COLORREF BGColor, const COLORREF FGColor, const COLORREF DisabledColor, const UINT nBevel)
{
...
void CFxButton::DrawFrame(CDC *DC, CRect R, int Inset)
{ 
...
void CFxButton::DrawFilledRect(CDC *DC, CRect R, COLORREF color)
{ 
	CBrush B;
...
void CFxButton::DrawLine(CDC *DC, CRect EndPoints, COLORREF color)
{ 
	CPen newPen;
