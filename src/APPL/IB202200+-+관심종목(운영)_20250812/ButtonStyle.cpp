...
void CButtonStyle::PaintBG(CDC *pDC)
{
	...
	pDC->FillSolidRect(&wndRect, RGB(100,200,225));
...
{
//		HBITMAP hBmp = ::LoadBitmap(::AfxGetInstanceHandle(), nullptr);//MAKEINTRESOURCE(IDB_BITMAP1));
//		m_hHdc = ::CreateCompatibleDC(nullptr);
