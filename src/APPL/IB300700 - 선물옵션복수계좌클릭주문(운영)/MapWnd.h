...
public:
	...
	void Send();
public:
	CRect m_rcAccn, m_rcSise, m_rcHoga, m_rcCtrl, m_rcCtrl2, m_rcGuide;
	int m_nWidth,m_nHeight;

public:
	void AddAccount(LPCSTR acno, LPCSTR pswd, LPCSTR acnm = "", int mult = 1, LPCSTR epswd = "");	//2013.10.11 KSJ 암호화비번 추가
...
protected:
	...
	LPCSTR GetEnPassword(LPCSTR acno); //2013.10.11 KSJ 암호화비번 추가
...
protected:
	...
	BOOL m_bFoldCtrl2, m_bFoldCtrl1, m_bShowConfirm, m_bShowRate, m_bShowBefore, m_bShowRsvd;
	BOOL m_bSiJangDBClick, m_bJumunReset;
	HBRUSH m_hBrush1,m_hBrush2;
