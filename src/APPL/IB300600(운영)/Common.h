...
#define WP_GRID_KEYUPDOWN		(0x00000018)
#define WP_DRAG_JANGO           (0x00000019)
#define WP_DRAG_ORDER			(0x00000020)
#define WP_MODIFY_DRAGORDER		(0x00000021)
#define WP_DRAG_MICHE           (0x00000022)
#define WP_KEY_ORDER			(0x00000023)
...
//typedef enum { CT_NONE=0, CT_FUTURE, CT_OPTION, CT_SPREAD, CT_MFUTURE, CT_MOPTION, CT_MSPREAD } CODE_TYPE;
typedef enum { CT_NONE=0, CT_FUTURE, CT_OPTION, CT_SPREAD, CT_MFUTURE, CT_MOPTION, CT_MSPREAD, CT_WEEK } CODE_TYPE;  //week
class SiseData {
public:
	SiseData() { code=""; type=CT_NONE; pcurr = FIRST_PCURR; }
	CString code;
	CODE_TYPE type;
	char udgb;
