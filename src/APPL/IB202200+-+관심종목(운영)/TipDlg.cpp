...
CTipDlg::CTipDlg(CWnd* pView, CWnd* pWnd, bool bMap, CWnd* pParent /*=nullptr*/)
...
void CTipDlg::ShowTips(CRect tRc, CRect wRc, CString tips)
{
	...
	MoveWindow(dispRc);
	SetWindowPos(nullptr, 0, 0, 0, 0, SWP_NOMOVE|SWP_NOSIZE|SWP_SHOWWINDOW|SWP_NOACTIVATE);	
	Invalidate(FALSE);
...
CFont* CTipDlg::getAxFont(CString fName, int point, bool bBold, bool bItalic)
{
	struct _fontR fontR;
