...
void AFXAPI DDX_DateTime(CDataExchange *pDX, int nIDC, const SYSTEMTIME &systime)
{
...
BOOL CDateTime::OnDateTimeChangeNotify(NMHDR* phdr, LRESULT* pResult)
//(NMDATETIMECHANGE *dtmh, LRESULT* pResult)
{
	*pResult = 0;    // docs say we must return 0
	...
	NMDATETIMECHANGE* dtmh = (NMDATETIMECHANGE*) phdr;
...
BOOL CDateTime::OnFormatQuery(NMHDR* phdr, LRESULT* pResult)
{
	*pResult = 0; 
