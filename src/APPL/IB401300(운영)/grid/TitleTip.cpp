...
//         28 Mar 2000  Aqiruse (marked with //FNA)z
                     ...
                     COLORREF crBackClr /* CLR_DEFAULT */)
{
    ...
    if ( rectDisplay.right > rectTitle.right-xoffset )
    {
...
#else
		SetWindowPos( &wndTop, rectDisplay.left, rectDisplay.top, rectTitle.Width(), rectTitle.Height(), SWP_SHOWWINDOW|SWP_NOACTIVATE );
#endif
		...
		//dc.DrawText(strTitle, CRect(0, 0, rectTitle.Width(), rectTitle.Height()), DT_VCENTER|DT_LEFT);
        SetCapture();
    }
