...
#define IDC_STATIC_TOTOLACCNT		(1010)
#define IDC_BTN_XLS					(1011)
...
protected:
	...
	CBitmap* m_hRndBmp[4]{}, * m_hGuide{}, m_hBackground{}, * m_hBtn2[3]{}, * m_hBtn4[3]{}, * m_hbtnXls[3]{};
	COLORREF m_crEven{}, m_crOdd{}, m_crHeader{}, m_crSelect{};

	// 0:GroupList, 1:GroupAccount, 2:RemainAccount
	int m_pGridSelectIdx[3];
	CGridCtrl* m_pGrid[3]{};
	CStatic m_stGroupName, m_stTotalAccnt;
	CEdit m_edGroupName;
	CfxImgButton* m_btnGroupUpdate{}, * m_btnGroupAdd{}, * m_btnGroupDelete{}, * m_btnReload{}, * m_btnLimit{}, * m_btnXls{};
	bool m_bAsc;
...
public:
	...
	bool RunExcel_();
	void GetGroupExcelData();	//2014.12.01 KSJ 등록된 그룹을 엑셀 데이터로 만든다.
