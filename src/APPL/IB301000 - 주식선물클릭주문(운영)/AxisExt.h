...
public:
	...
	int      GetNextPrice(int price, CODE_TYPE type, bool isplus, bool bKospi = true);
	int		 GetPriceUnit(int iPrice, bool bPlus, bool bKospi = true);
	int		 GetETFPrice( int price, bool isplus);
