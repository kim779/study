...
#define IDC_BTN_FUT6	(1015)
#define IDC_BTN_FUT7	(1016)
#define IDC_BTN_FUT8	(1017)
#define IDC_BTN_FUT9	(1018)
...
public:
	...
	void SetTabItems();
	CString GetTradeDataFromCode(CString scode);
...
protected:
	CfxImgButton *m_pBtnCheg, *m_pBtnChart, *m_pBtnJango, *m_pBtnFold, *m_pBtnFuture[9], *m_pBtnOption[4], *m_pBtnJvol, *m_pBtnSize;
