...
*/
	...
	if (m_bNewHOGA) {
		...
		else
		{
			...
			if (iPrice > 500000)
				iPrice -= 1000;
			else if (iPrice <= 500000 && iPrice > 200000)
				iPrice -= 500;
			else if (iPrice <= 200000 && iPrice > 50000)
				iPrice -= 100;
			else if (iPrice <= 50000 && iPrice > 20000)
				iPrice -= 50;
			else if (iPrice <= 20000 && iPrice > 5000)
				iPrice -= 10;
			else if (iPrice <= 5000 && iPrice > 2000)
				iPrice -= 5;
			else if (iPrice <= 2000 && iPrice >= -1999)//-------------
				iPrice -= 1;
			else if (iPrice <= -2000 && iPrice >= -5000)
				iPrice -= 5;
			else if (iPrice < -5000 && iPrice >= -20000)
				iPrice -= 10;
			else if (iPrice < -20000 && iPrice >= -500000)
				iPrice -= 50;
			else if (iPrice < -50000 && iPrice >= -200000)
				iPrice -= 100;
			else if (iPrice < -200000 && iPrice >= -500000)
				iPrice -= 500;
			else if (iPrice < -500000)
				iPrice -= 1000;
		}
	}
	else {
