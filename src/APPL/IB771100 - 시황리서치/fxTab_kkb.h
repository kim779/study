...
public:
	...
	CBitmap		*m_bmpSelL, *m_bmpSelM, *m_bmpSelR, *m_bmpL, *m_bmpM, *m_bmpR, *m_bmpRBk;
	DWORD		m_style;
	HBITMAP		m_pics[6];
...
public:
	...
	void	SetImage(HBITMAP hselectL, HBITMAP hSelectM, HBITMAP hSelectR, HBITMAP hL, HBITMAP hM, HBITMAP hR, HBITMAP hRBk);
	void	SetImage(CString imageDir, CString selectL, CString selectM, CString selectR, CString left, CString middle, CString right, CString rightBk);
