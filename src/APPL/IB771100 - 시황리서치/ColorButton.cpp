...
BOOL CColorButton::OnClicked()
{
	...
	std::unique_ptr<CColourPopup> colorPopup = std::make_unique<CColourPopup>(CPoint(rDraw.left, rDraw.bottom),		// Point to display popup
