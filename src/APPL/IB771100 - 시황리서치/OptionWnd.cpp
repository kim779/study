...
int COptionWnd::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
	...
	m_pContext_Check = std::make_unique<CButton>();
	...
	m_pHanNew_Static = std::make_unique < CStatic >();
	...
	m_pHanNews_Picker = std::make_unique < CColorButton>();
	...
	m_pEDaily_Static = std::make_unique <CStatic>();	
	...
	m_pEDaily_Picker = std::make_unique < CColorButton>();
	...
	// 인포스탁
	sx = GAP3;	sy = ey;		ex = sx + STATIC_WIDTH1;		ey = sy + STATIC_HEIGHT;
	m_pInfoStock_Static = std::make_unique < CStatic>();
	...
	sx = rc.right - PICKER_WIDTH - GAP10;	sy2 = ey2 + GAP5;	ex = sx + PICKER_WIDTH;		ey2 = sy2 + PICKER_HEIGHT;
	m_pInfoStock_Picker = std::make_unique < CColorButton >();
	...
	if (m_bDaetoo)	// 20071122
	{
		// 머니투데이
		sx = GAP3;	sy = ey;			ex = sx + STATIC_WIDTH1;		ey = sy + STATIC_HEIGHT;
		m_pMoneytoday_Static = std::make_unique < CStatic > ();
		...
		sx = rc.right - PICKER_WIDTH - GAP10;	sy2 = ey2 + GAP5;	ex = sx + PICKER_WIDTH;		ey2 = sy2 + PICKER_HEIGHT;
		m_pMoneytoday_Picker = std::make_unique < CColorButton>();
		...
		// 연합
		sx = GAP3;	sy = ey;		ex = sx + STATIC_WIDTH1;		ey = sy + STATIC_HEIGHT;
		m_pYounhap_Static = std::make_unique < CStatic> () ;
		...
		sx = rc.right - PICKER_WIDTH - GAP10;	sy2 = ey2 + GAP5;	ex = sx + PICKER_WIDTH;		ey2 = sy2 + PICKER_HEIGHT;
		m_pYounhap_Picker = std::make_unique <CColorButton>();
		...
		// 매일경제
		sx = GAP3;	sy = ey;		ex = sx + STATIC_WIDTH1;		ey = sy + STATIC_HEIGHT;
		m_pMaekyoung_Static = std::make_unique <CStatic>();
		...
		sx = rc.right - PICKER_WIDTH - GAP10;	sy2 = ey2 + GAP5;	ex = sx + PICKER_WIDTH;		ey2 = sy2 + PICKER_HEIGHT;
		m_pMaekyoung_Picker = std::make_unique <CColorButton>();
		...
		// 이투데이
		sx = GAP3;	sy = ey;		ex = sx + STATIC_WIDTH1;		ey = sy + STATIC_HEIGHT;
		m_pEToday_Static = std::make_unique <CStatic>();
		...
		sx = rc.right - PICKER_WIDTH - GAP10;	sy2 = ey2 + GAP5;	ex = sx + PICKER_WIDTH;		ey2 = sy2 + PICKER_HEIGHT;
		m_pEToday_Picker = std::make_unique <CColorButton>();
		...
		// 뉴스핌
		sx = GAP3;	sy = ey;		ex = sx + STATIC_WIDTH1;		ey = sy + STATIC_HEIGHT;
		m_pNewsp_Static = std::make_unique <CStatic>();
		...
		sx = rc.right - PICKER_WIDTH - GAP10;	sy2 = ey2 + GAP5;	ex = sx + PICKER_WIDTH;		ey2 = sy2 + PICKER_HEIGHT;
		m_pNewsp_Picker = std::make_unique <CColorButton>();
