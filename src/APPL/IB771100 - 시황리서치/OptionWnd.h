...
public:
	...
	// Color Picker
	std::unique_ptr <CColorButton> m_pHanNews_Picker;
	std::unique_ptr <CColorButton> m_pEDaily_Picker;
	std::unique_ptr <CColorButton> m_pInfoStock_Picker;
	std::unique_ptr <CColorButton> m_pMoneytoday_Picker;
	std::unique_ptr <CColorButton> m_pYounhap_Picker;
	std::unique_ptr <CColorButton> m_pMaekyoung_Picker;
	std::unique_ptr <CColorButton> m_pEToday_Picker;
	std::unique_ptr <CColorButton> m_pNewsp_Picker;

	std::unique_ptr <CStatic> m_pHanNew_Static;
	std::unique_ptr <CStatic> m_pEDaily_Static;
	std::unique_ptr <CStatic> m_pInfoStock_Static;
	std::unique_ptr <CStatic> m_pMoneytoday_Static;
	std::unique_ptr <CStatic> m_pYounhap_Static;
	std::unique_ptr <CStatic> m_pMaekyoung_Static;
	std::unique_ptr <CStatic> m_pEToday_Static;
	std::unique_ptr <CStatic> m_pNewsp_Static;
	...
	std::unique_ptr <CButton> m_pContext_Check;
	BOOL			m_bDaetoo;
// Operations
private:
	// ini File
