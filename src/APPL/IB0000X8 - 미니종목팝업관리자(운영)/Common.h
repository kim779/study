...
#define WX_INTEREST			(WM_USER+0x4002)
#define WX_NEWSVIEW			(WM_USER+0x4003)
...
#define WD_LASTVIEW			(WM_USER+0x4000)
#define WD_CODENEWS			(WM_USER+0x4001)
...
#define WD_INGONG			(WM_USER+0x5007)
#define WD_FOCUSNOTICE		(WM_USER+0x5008)	//2013.07.24 KSJ 화면이 다 열리면 이벤트 보냄
#define WD_WEBHWND			(WM_USER+0x500A)
#define WD_CLOSEWEB			(WM_USER+0x500B)
#define WD_PHONEPAD			(WM_USER+0x7001)    //2015.08.04 KDK 폰패드 특정화면 비밀번호 입력
#define WM_RESINTEREST		(WM_USER+9556)		//관심종목 저장 완료 메시지
#define WD_CAPTURE			(WM_USER+0x8002)
...
typedef enum { NEWS_MODE,SISE_MODE} SISE_TYPE;
