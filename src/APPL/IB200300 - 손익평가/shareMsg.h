...
enum	idPicker {idNotice = 0, idNews, idHanNews, idEDaily, idInfoStock, idMoneyToday, idYounhap, idMaekyoung, idEToday, idNewsp};
...
#define NEWS_WIDTH			690
#define TREE_WIDTH			120
#define TOOLHEIGHT			26
#define GAPW				3
#define GAPMINW				2
