...
#define GVMK_TEXT               LVIF_TEXT
#define GVMK_IMAGE              LVIF_IMAGE
#define GVMK_PARAM              LVIF_PARAM
#define GVMK_STATE              LVIF_STATE
#define GVMK_ATTR				(GVMK_STATE<<1)
#define	GVMK_SYMBOL				(GVMK_STATE<<2)
#define GVMK_BKCOLOR            (GVMK_STATE<<3)
#define GVMK_FGCOLOR            (GVMK_STATE<<4)
#define GVMK_FORMAT             (GVMK_STATE<<5)
#define GVMK_FONT               (GVMK_STATE<<6)
#define GVMK_MARGIN             (GVMK_STATE<<7)
#define	GVMK_MISC				(GVMK_STATE<<8)
