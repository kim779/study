...
public:
    ...
    virtual void SetSymbol( LPCTSTR  /*szSymbol*/ )			= 0 ;//	{ m_strSymbol = szSymbol; }	//KSJ
    virtual void SetAttr( UINT  attr )						{ m_nAttr = attr; }	//KSJ
	virtual void SetParam(LPARAM param)						{ m_param = param; }
    ...
    virtual LPCTSTR    GetSymbol()     const                = 0 ; //{ return m_strSymbol;  }	//KSJ
    virtual UINT       GetAttr()	   const                { return m_nAttr;  }	//KSJ
	virtual	LPARAM	   GetParam()	   const				{ return m_param; }
	...
	virtual BOOL IsCurrentCell()       const                { return (m_nState & GVIS_CURRCELL); }
