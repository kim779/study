...
public:
	...
	virtual void  SetSymbol(LPCTSTR szSymbol) { m_strSymbol = szSymbol; }                    //KSJ   
// 	virtual void  SetAttr(UINT attr)      { m_nAttr = attr;  }                    //KSJ   
	...
	virtual LPCTSTR		GetSymbol() const { return (m_strSymbol.IsEmpty()) ? _T("") : LPCTSTR(m_strSymbol); }	//KSJ                    //KSJ   
// 	virtual UINT		GetAttr() const     { return m_nAttr;  }	//KSJ                    //KSJ   

	virtual BOOL        IsEditing() const { return m_bEditing; }
	virtual BOOL        IsDefaultFont() const { return TRUE; }	// (m_plfFont == nullptr); }
	virtual void        Reset();
...
protected:
	...
	LOGFONT    m_lfFont;
	UINT       m_nMargin;
	CString	   m_strSymbol;	   // cell Symbol	KSJ
	UINT       m_nAttr;
