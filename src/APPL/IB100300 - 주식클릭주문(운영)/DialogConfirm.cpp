...
void CDialogConfirm::CreateTextWnd()
{
	...
	CFont* pFont = RequestFont("굴림체", 9, FALSE, NULL);
	CFont* pBFont = RequestFont("굴림체", 9, FALSE, FW_BOLD);
	...
	for (int i = 0; i < nCount; i++)
	{
		...
		COLORREF cl;
		if (m_nOrderKind == 1 || m_nOrderKind == 0) //매수, 매도
		{
			...
			switch (i)
			{
				...
				{
					cl = RGB(255, 255, 255); 
					m_pHead[i].SetFontFromParent(pBFont);
				}
				break;
				case 5: 
				{
				...
				break;
				default: cl = clrDataBack; break;
			}

			m_pData[i].Create(_T(""), NULL, CRect(nX + 83, nY, nWidth - GAP * 2, nY + ROW_HEIGHT),
				this, IDC_DATABASE + i, NULL, cl, CLR_FG, clrLine);

			switch (i)
			{
				case 2: case 4 : case 5:
					m_pData[i].SetFontFromParent(pBFont); break;
				default:
					m_pData[i].SetFontFromParent(pFont); break;
			}
		}
		else if(m_nOrderKind == 2) //취소
		{
			switch (i)
			{	
				case 3: 
				case 5: cl = RGB(255, 255, 255);  break;
				default: cl = clrDataBack; break;
			}
		...
		else if (m_nOrderKind == 3) //매수, 매도
		{
			switch (i)
			{
			case 3:
			case 6: cl = RGB(255, 255, 255); m_pHead[i].SetFontFromParent(pBFont); break;
			case 7: cl = RGB(255, 242, 183); m_pHead[i].SetFontFromParent(pBFont); break;
			default: cl = clrDataBack; break;
			}
		...
		else if (m_nOrderKind == 8 || m_nOrderKind == 7) //시장
		{
			switch (i)
			{
				case 2: cl = RGB(255, 255, 255); m_pHead[i].SetFontFromParent(pBFont);  break;
				case 4: cl = RGB(255, 255, 255); m_pHead[i].SetFontFromParent(pBFont);  break;
				default: cl = clrDataBack; break;
			}
