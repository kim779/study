...
private:
	void  sendRemainTR(CString sAccn, CString sPswd, bool bFuture, bool bCredit, int dFee, double dMass, double dSave, int dCalcType, int iMcgb, HWND sHwnd, CString sdata = _T(""));	//2015.04.22 KSJ 매체구분 추가
