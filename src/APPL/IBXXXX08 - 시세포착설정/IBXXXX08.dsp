# Microsoft Developer Studio Project File - Name="IBXXXX08" - Package Owner=<4>
...
# ADD LINK32 ../../control/fx_grid/release/fx_grid.lib winmm.lib Imm32.lib Msimg32.lib /nologo /subsystem:windows /dll /map /machine:I386 /out:"..\..\..\release\IBXXXX08.DLL"
...
# ADD LINK32 ../../control/fx_grid/Debug/fx_grid.lib winmm.lib Imm32.lib Msimg32.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:"..\..\..\dev\IBXXXX08.DLL" /pdbtype:sept

!ENDIF 

# Begin Target

# Name "IBXXXX08 - Win32 Release"
# Name "IBXXXX08 - Win32 Debug"
