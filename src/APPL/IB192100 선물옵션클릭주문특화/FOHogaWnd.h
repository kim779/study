...
public:
	...
	BOOL IsShowRate() { return m_pGrid->IsShowRate(); }
	void ShowBefore(bool bShowBefore);
	BOOL IsShowBefore() { return m_pGrid->IsShowBefore(); }
	void ShowRsvd(bool bShowRsvd);
	BOOL IsShowRsvd() { return m_pGrid->IsShowRsvd(); }
	...
	void SetCurrToCenter() { if (m_pGrid) m_pGrid->SetCurrToCenter(); }
	...
	BOOL GetEnterOrder() { return m_bEnterOrder; }
	void SetEnterOrder(BOOL bEnable = FALSE);
	...
	BOOL IsOneClickMode() { return m_bOneClickOrder; }
...
protected:
	...
	std::unique_ptr<CFOGridCtrl> m_pGrid{};
	std::unique_ptr<CGridCtrl> m_pBGrid{};
	std::unique_ptr <CfxButton> m_pMadoRsvd{}, m_pMadoJumn{}, m_pMasuRsvd{}, m_pMasuJumn{},  m_pHogaFix{};
...
protected:
	...
	BOOL m_bMouseOut{}, m_bOneClickOrder{}, m_bExtOdrColumn{}, m_bSpaceOrder{}, m_bRClickCancel{}, m_bEnterOrder{};
