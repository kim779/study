...
{
	const int line_h = 20, head_w = 50, pos_x = 0, pos_y = 0;

	CString qty_txt;
	const COLORREF crHeadBk = 0xE6CDBB, crTextBk = 0xF2D3A6, crLine = 0x9C8F87;
...
void CConfirmDlg::DrawBuyOrder( CDC *pDC, CRect *pRC )
{
	...
	CString qty_txt;
	const COLORREF crHeadBk = 0xC3BAF4, crTextBk = 0xC9C5F8, crLine = 0x8580F1;
...
void CConfirmDlg::DrawModifyOrder( CDC *pDC, CRect *pRC )
{
	...
	CString qty_txt;
	const COLORREF crHeadBk = 0xA2DEC3, crTextBk = 0xA5EAC0, crLine = 0x73C392, crBox = 0xD4F5E6;
...
void CConfirmDlg::DrawCancelOrder( CDC *pDC, CRect *pRC )
{
	...
	CString qty_txt;
	const COLORREF crHeadBk = 0xBCDAE7, crTextBk = 0xEBF9FF, crLine = 0x98BCCD, crBox = 0xD8EEF8;
...
std::shared_ptr<CfxImgButton> CConfirmDlg::CreateImgButton(LPCSTR caption, int nID, CBitmap** bmp)
{
	//CfxImgButton *pBtn = new CfxImgButton(m_pFont);
	std::shared_ptr<CfxImgButton> pBtn = std::make_unique<CfxImgButton>(m_pFont);
	if (pBtn)
	{
