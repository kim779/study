...
public:
	...
	CCmdTarget	*m_COpSensCal = nullptr;
	std::unique_ptr<IOpSensCal> m_IOpSensCal = nullptr;
	CString		m_root;

	HINSTANCE	m_hInst{};

	CCmdTarget* (APIENTRY* axCreate)(char*) = nullptr;
// Operations
public:
	...
	CString GetUserName();
	void SetUserName(LPCTSTR sUserName);
