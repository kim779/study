...
void CMainWnd::Init()
{
	...
	clientRC.bottom -= 100;
	m_grid->Create(clientRC, this, IDC_EXECELGRID, GVSC_BOTH);   //
...
void CMainWnd::loadFieldInfo()
{
	const struct	_gridHdr gridHdr[] = {
		...
		{IDS_GH_NAME,	70,	GVAT_TEXT,		"1022",	GVFM_LEFT,	0,				7},	// 9    GVAT_SORTSTR
#ifdef	CURR_COLOR
		{IDS_GH_CURR,	75,	GVAT_TEXT,		"2023",	GVFM_RIGHT,	GVAT_COMMA|GVAT_CONDITIONx,	8},	// 10  
#else
		{IDS_GH_CURR,	60,	GVAT_SORTABS,		"2023",	GVFM_RIGHT,	GVAT_COMMA,			8},	// 10
#endif
		{IDS_GH_DIFF,	80,	GVAT_TEXT,		"2024",	GVFM_RIGHT,	GVAT_COMMA|GVAT_CONTRAST,	9},	// 11   
		{IDS_GH_RATE,	56,	GVAT_TEXT,		"2033",	GVFM_RIGHT,	GVAT_CONDITION,			10},	// 12  
		{IDS_GH_ASK,	75,	GVAT_TEXT,		"2025",	GVFM_RIGHT,	GVAT_COMMA|GVAT_CONDITIONx,	11},	// 13  
		{IDS_GH_BID,	75,	GVAT_TEXT,		"2026",	GVFM_RIGHT,	GVAT_COMMA|GVAT_CONDITIONx,	12},	// 14  
		{IDS_GH_PREVOL,	85,	GVAT_TEXT,		"2927",	GVFM_RIGHT,	GVAT_COMMA|GVAT_CONDITIONx,	13},	// 16 
		{IDS_GH_VOL,	75,	GVAT_TEXT,		"2027",	GVFM_RIGHT,	GVAT_COMMA|GVAT_CONDITIONx,	14},	// 16  
		{IDS_GH_DAYPRC,	75,	GVAT_TEXT,		"DAYPRC",	GVFM_RIGHT,	GVAT_COMMA|GVAT_CONDITIONx,				15},	// 3 
		{IDS_GH_DAYVOL,	83,	GVAT_TEXT,		"DAYVOL",	GVFM_RIGHT,	GVAT_COMMA,				16},	// 3  
		{IDS_GH_UP1,	70,	GVAT_TEXT,		"UP1",	GVFM_RIGHT,	GVAT_COMMA,					17},	// 3 
		{IDS_GH_UP2,	70,	GVAT_TEXT,		"UP2",	GVFM_RIGHT,	GVAT_COMMA,				18},	// 3  
		{IDS_GH_HIGH,	75,	GVAT_TEXT,		"2030",	GVFM_RIGHT,	GVAT_COMMA|GVAT_CONDITIONx,				19},	// 3 
		{IDS_GH_LOW,	75,	GVAT_TEXT,		"2031",	GVFM_RIGHT,	GVAT_COMMA|GVAT_CONDITIONx,				20},	// 4  
		{IDS_GH_PRECURR,75,	GVAT_TEXT,		"2934",	GVFM_RIGHT,	GVAT_COMMA,				21},	// 5  
		{IDS_GH_SCURR  ,80,	GVAT_TEXT,		"SCURR",	GVFM_RIGHT,	GVAT_COMMA|GVAT_CONDITIONx,				22},	// 5 
		{IDS_GH_SVOL   ,80,	GVAT_TEXT,		"SVOL",	GVFM_RIGHT,	GVAT_COMMA,				23},	// 5  
	};	
