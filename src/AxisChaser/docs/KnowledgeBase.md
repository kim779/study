...
- [개요](#개요)
- [설계 의도 및 트러블슈팅 히스토리](#설계-의도-및-트러블슈팅-히스토리)
  - [1. WM_VSCROLL 배치 처리 (2026-07-30)](#1-wm_vscroll-배치-처리-2026-07-30)
  - [2. RichEdit Truncate (50MB 상한) (2026-07-30)](#2-richedit-truncate-50mb-상한-2026-07-30)
  - [3. 큐 상한 (RTM 200건, SND/RCV 500건) (2026-07-30)](#3-큐-상한-rtm-200건-sndrcv-500건-2026-07-30)
  - [4. OutputDebugString 조건부 (#ifdef _DEBUG) (2026-07-30)](#4-outputdebugstring-조건부-ifdef-_debug-2026-07-30)
  - [5. CQue 소멸자 메모리 누수 방지 (2026-07-30)](#5-cque-소멸자-메모리-누수-방지-2026-07-30)
- [도메인 지식](#도메인-지식)
  - [A. 데이터 흐름 및 우선순위](#a-데이터-흐름-및-우선순위)
  - [B. RichEdit 성능 특성](#b-richedit-성능-특성)
  - [C. 동시성 모델](#c-동시성-모델)
  - [D. 필터 및 검색](#d-필터-및-검색)
  - [E. Xecure 암호화 (현재 비활성)](#e-xecure-암호화-현재-비활성)
- [성능 측정 기준](#성능-측정-기준)
  - [목표 성능 (개선 후)](#목표-성능-개선-후)
  - [검증 방법](#검증-방법)
- [주의사항 및 제약](#주의사항-및-제약)
- [참고자료](#참고자료)
