...
- [개선사항 요약](#개선사항-요약)
- [테스트 계획](#테스트-계획)
  - [Phase 1: 회귀 테스트 (기존 기능 정상 작동)](#phase-1-회귀-테스트-기존-기능-정상-작동)
  ...
  - [Phase 2: WM_VSCROLL 배치 처리 검증](#phase-2-wm_vscroll-배치-처리-검증)
    - [TC-2.1: 중간 크기 배치 (RTM 50건/초)](#tc-21-중간-크기-배치-rtm-50건초)
    - [TC-2.2: 대량 배치 (RTM 200건/초)](#tc-22-대량-배치-rtm-200건초)
  ...
  - [Phase 4: 큐 상한 검증 (RTM 200건, SND/RCV 500건)](#phase-4-큐-상한-검증-rtm-200건-sndrcv-500건)
    - [TC-4.1: RTM 큐 상한 (200건)](#tc-41-rtm-큐-상한-200건)
    - [TC-4.2: SND/RCV 큐 상한 (500건)](#tc-42-sndrcv-큐-상한-500건)
  - [Phase 5: Stress Test (극한 시나리오)](#phase-5-stress-test-극한-시나리오)
    - [TC-5.1: 통합 Stress Test](#tc-51-통합-stress-test)
- [회귀 위험 항목 (Risk Assessment)](#회귀-위험-항목-risk-assessment)
- [테스트 실행 순서](#테스트-실행-순서)
- [검증 기준 (Pass/Fail)](#검증-기준-passfail)
  - [Pass 조건](#pass-조건)
  - [Fail 조건](#fail-조건)
- [검증 체크리스트](#검증-체크리스트)
  - [사전 준비](#사전-준비)
