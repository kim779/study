...
class RICHED_DECL CStringManip
: public CManip
{
...
class RICHED_DECL CControlManip
: public CManip
{
protected:
...
RICHED_DECL CRTFBuilder& operator << (		CRTFBuilder& , 
																							RTFSM_PFUNC ) ;
...
class RICHED_DECL CRichEditCtrlEx 
