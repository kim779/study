...
{
	m_dGap = mgap;
	const int	lcnt = m_pGrpWnd->m_lcnt;
	...
	struct _multi_lineD	*multi_lineD = nullptr;
	struct _multi_line	*multi_line = nullptr;
	
	int	dPos = 0;
	char* pQue{};
	const int	nSize = 14 + lcnt * 10;
