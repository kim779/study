...
protected:
	...
	std::unique_ptr<CreateDropDownGrid> m_pDropGridStruct{};
	std::unique_ptr<CDropDownCug> m_pGridCtrl{};
	CWnd m_popupWnd;
...
public:
	...
	virtual int OnSelectedGridItem( SelectedGridItem *pSelectedInfo = nullptr );
