/*************************************************************************
				Class Implementation : CUGCodeComboType
**************************************************************************
	Source file : UGCTcodecombo.cpp
	Copyright ? Dundas Software Ltd. 1994 - 2002, All Rights Reserved
*************************************************************************/

#include "stdafx.h"
#include "UGCtrl.h"
#include "UGCTcodecombo.h"
...
/***************************************************
CUGCodeComboType - Constructor
	Intialize all member variables here
****************************************************/
CUGCodeComboType::CUGCodeComboType(){

}
/***************************************************
~CUGCodeComboType - Destructor
...
Return:
	cell type name
****************************************************/
LPCTSTR CUGCodeComboType::GetName()
{
	return _T("CodeCombo Bar");
}
...
****************************************************/
LPCUGID CUGCodeComboType::GetUGID()
{
...
OnDraw - overloaded CUGCellType::OnDraw
	Draws the codecomboress bar, using the cells text field
    ...
    **See CUGCellType::OnDraw for more details
	about this function
****************************************************/
void CUGCodeComboType::OnDraw(CDC *dc,RECT *rect,int col,long row,
...
/*	DrawBorder(dc,rect,rect,cell);
	...
	if(properties&UGCELL_CELLTYPEEX_SET){
		if(cell->GetCellTypeEx() == UGCT_CODECOMBOUSELABEL){
...
Return:
	<none>
*****************************************************/
void CUGCodeComboType::GetBestSize(CDC *dc,CSize *size,CUGCell *cell)
{
	long percent;
	CString string;
