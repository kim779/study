// CX_NEWPHONEPAD.cpp : DLL의 초기화 루틴을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CCXNEWPHONEPADApp, CWinApp)
END_MESSAGE_MAP()


// CCXNEWPHONEPADApp 생성

CCXNEWPHONEPADApp::CCXNEWPHONEPADApp()
{
...
// 유일한 CCXNEWPHONEPADApp 개체입니다.

CCXNEWPHONEPADApp theApp;

const GUID CDECL _tlid = {0xe2703dbe,0xe48f,0x4ac6,{0xb5,0xf7,0x64,0x46,0x37,0xca,0x92,0x68}};
const WORD _wVerMajor = 1;
const WORD _wVerMinor = 0;


// CCXNEWPHONEPADApp 초기화

BOOL CCXNEWPHONEPADApp::InitInstance()
{
...
__declspec(dllexport) CWnd* APIENTRY axCreate(CWnd* parent, void* pParam)
{
	...
	CString slog;
	slog.Format("[cx_newphonepad] axcreate ret = [%d]", ret);
