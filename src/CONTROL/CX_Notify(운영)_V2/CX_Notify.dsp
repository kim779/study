# Microsoft Developer Studio Project File - Name="CX_Notify" - Package Owner=<4>
...
# ADD LINK32 /nologo /subsystem:windows /dll /map /debug /machine:I386 /out:"../../../dev/CX_Notify.dll"
...
# ADD LINK32 /nologo /subsystem:windows /dll /map /debug /machine:I386 /out:"../../../dev/CX_Notify.dll" /pdbtype:sept

!ENDIF 

# Begin Target

# Name "CX_Notify - Win32 Release"
# Name "CX_Notify - Win32 Debug"
