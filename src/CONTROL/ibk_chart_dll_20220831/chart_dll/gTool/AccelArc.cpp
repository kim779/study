// AccelArc.cpp: implementation of the CAccelArc class.
//
//////////////////////////////////////////////////////////////////////
...
double	accelARC[] = {33.3, 66.6};

CAccelArc::CAccelArc(CWnd *pView, CWnd *pParent, CRect toolRC, CRect drawRC, int bgColor, CIndcBase* pIndcBase, int tkname)
...
void CAccelArc::DrawTool(CDC* pDC)
{
	...
	for (int ii = 0; ii < maxACCELARC; ii++)
	{
...
void CAccelArc::HideTool()
{
	CClientDC ClientDC(m_pwndParent);
	DrawTool(&ClientDC);
}

void CAccelArc::CreateToolLBDN(CPoint pt, bool &bMouseCapture)
{
	m_pointStart = pt;
	m_pointEnd = pt;
...
void CAccelArc::CreateToolLBMV(CPoint pt, bool &bMouseCapture)
{
	CClientDC ClientDC(m_pwndParent);
...
void CAccelArc::CreateToolLBUP(CPoint pt, bool &bMouseCapture)
{
	CClientDC ClientDC(m_pwndParent);
...
void CAccelArc::ChangeToolLBDN(CPoint pt, bool &bMouseCapture)
{
	CClientDC ClientDC(m_pwndParent);
...
void CAccelArc::ChangeToolLBMV(CPoint pt, bool &bMouseCapture)
{
	CClientDC ClientDC(m_pwndParent);
...
void CAccelArc::ChangeToolLBUP(CPoint pt, bool &bMouseCapture)
{
	MoveToolLBUP(pt, bMouseCapture);
}

void CAccelArc::MoveToolLBDN(CPoint pt, bool &bMouseCapture)
{
	m_pointCur = pt;
...
void CAccelArc::MoveToolLBMV(CPoint pt, bool &bMouseCapture)
{
	CClientDC ClientDC(m_pwndParent);
	if (m_bShowHolder)
		CToolBase::DrawHolder(&ClientDC, false);
...
void CAccelArc::MoveToolLBUP(CPoint pt, bool &bMouseCapture)
{
	CClientDC ClientDC(m_pwndParent);
...
bool CAccelArc::PtInToolRegion(CPoint pt)
{
...
void CAccelArc::CalculateDrawingPosition()
{
	...
	for (int ii = 0; ii < maxACCELARC; ii++)
	{
		posRATE = int(maxLEN * accelARC[ii] / 100.);
