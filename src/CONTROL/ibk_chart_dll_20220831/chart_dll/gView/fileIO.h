...
public:
	...
	static void	PrintWindow(CString root, CWnd *pMain, bool bDlgPopup);
	static void	PrintWindow(CString root, CWnd *pMain, CWnd *pBottom, CString title, CFont *pFont, bool bDlgPopup);
