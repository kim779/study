...
CAxMDib::~CAxMDib()
{
	if (hDib) delete[] hDib;//free(hDib);
}
/////////////////////////////////////////////////////////////////////
bool CAxMDib::IsWin30Dib(){
	return ((*(LPDWORD)(hDib))==sizeof(BITMAPINFOHEADER));
}
/////////////////////////////////////////////////////////////////////
WORD CAxMDib::GetPaletteSize()
{
//    if (IsWin30Dib())
...
/////////////////////////////////////////////////////////////////////
BYTE* CAxMDib::GetBits()
{ 
	if (hDib)	return ((BYTE*)hDib + *(LPDWORD)hDib + GetPaletteSize()); 
	return NULL;
}
/////////////////////////////////////////////////////////////////////
HDIB  CAxMDib::Create(DWORD dwWidth, DWORD dwHeight, WORD wBitCount)
{
...
/////////////////////////////////////////////////////////////////////
long CAxMDib::Draw(HDC pDC, long xoffset, long yoffset)
{
	if((hDib)&&(pDC))  {
...
/////////////////////////////////////////////////////////////////////
long CAxMDib::Stretch(HDC pDC, long xoffset, long yoffset, long xsize, long ysize)
{
	if((hDib)&&(pDC)) {
		//palette must be correctly filled
		LPSTR lpDIB = (char*)hDib;	//set image to hdc...
...
/////////////////////////////////////////////////////////////////////
void CAxMDib::SetPaletteIndex(BYTE idx, BYTE r, BYTE g, BYTE b)
{
	if ((hDib)&&(m_nColors)){
...
/////////////////////////////////////////////////////////////////////
void CAxMDib::SetPaletteIndex(BYTE idx, RGBQUAD c)
{
	if ((hDib)&&(m_nColors)){
		BYTE* iDst = (BYTE*)(hDib) + sizeof(BITMAPINFOHEADER);
		if ((idx>=0)&&(idx<m_nColors)){	
...
/////////////////////////////////////////////////////////////////////
void CAxMDib::SetPaletteIndex(BYTE idx, COLORREF cr)
{
	if ((hDib)&&(m_nColors)){
		BYTE* iDst = (BYTE*)(hDib) + sizeof(BITMAPINFOHEADER);
		if ((idx>=0)&&(idx<m_nColors)){	
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CAxMDib::GetPaletteIndex(BYTE idx)
{
	RGBQUAD rgb = {0,0,0,0};
	if ((hDib)&&(m_nColors)){
		BYTE* iDst = (BYTE*)(hDib) + sizeof(BITMAPINFOHEADER);
...
/////////////////////////////////////////////////////////////////////
BYTE CAxMDib::GetPixelIndex(long x,long y)
{
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CAxMDib::GetPixelColor(long x,long y)
{
	RGBQUAD rgb={0,0,0,0};
...
/////////////////////////////////////////////////////////////////////
void CAxMDib::SetPixelIndex(long x,long y,BYTE i)
{
	if ((hDib==NULL)||(m_nColors==0)||
...
/////////////////////////////////////////////////////////////////////
void CAxMDib::SetPixelColor(long x,long y,COLORREF cr)
{
	SetPixelColor(x,y,RGB2RGBQUAD(cr));
	return;
}
/////////////////////////////////////////////////////////////////////
void CAxMDib::SetPixelColor(long x,long y,RGBQUAD c)
{
	if ((hDib==NULL)||(x<0)||(y<0)||
...
/////////////////////////////////////////////////////////////////////
BYTE CAxMDib::GetNearestIndex(RGBQUAD c)
{
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CAxMDib::RGBtoHSL(RGBQUAD lRGBColor)
{
...
/////////////////////////////////////////////////////////////////////
WORD CAxMDib::HueToRGB(WORD n1,WORD n2,WORD hue)
{ 
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CAxMDib::HSLtoRGB(COLORREF cHSLColor)
{
	return HSLtoRGB(RGB2RGBQUAD(cHSLColor));
}
/////////////////////////////////////////////////////////////////////
RGBQUAD CAxMDib::HSLtoRGB(RGBQUAD lHSLColor)
{ 
	WORD hue,lum,sat;
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CAxMDib::RGB2RGBQUAD(COLORREF cr)
{
	RGBQUAD c;
...
/////////////////////////////////////////////////////////////////////
COLORREF CAxMDib::RGBQUAD2RGB (RGBQUAD c)
{
	return RGB(c.rgbRed,c.rgbGreen,c.rgbBlue);
}
/////////////////////////////////////////////////////////////////////
void CAxMDib::SetGrayPalette()
{
...
/////////////////////////////////////////////////////////////////////
void CAxMDib::BlendPalette(COLORREF cr,long perc)
{
	if ((hDib==NULL)||(m_nColors==0)) return;
	BYTE* iDst = (BYTE*)(hDib) + sizeof(BITMAPINFOHEADER);
	long i,r,g,b;
...
/////////////////////////////////////////////////////////////////////
long CAxMDib::WriteBMP(LPTSTR bmpFileName)
{                         
...
/////////////////////////////////////////////////////////////////////
long CAxMDib::GetSize()
{
	return m_bi.biSize + m_bi.biSizeImage + GetPaletteSize();
}
/////////////////////////////////////////////////////////////////////
BOOL CAxMDib::IsValid()
{
	return (hDib!=NULL);
}
/////////////////////////////////////////////////////////////////////
void CAxMDib::Clone(CAxMDib *src)
{
