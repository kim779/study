...
CMainWnd::CMainWnd(CWnd* pParent, struct _param* pInfo)
{
	...
	CC_VolLine1App* pApp = (CC_VolLine1App *)AfxGetApp();
...
BEGIN_DISPATCH_MAP(CMainWnd, CWnd)
	...
	DISP_FUNCTION(CMainWnd, "ChangeName", ChangeName, VT_EMPTY, VTS_BSTR)
	DISP_FUNCTION(CMainWnd, "Clear", Clear, VT_EMPTY, VTS_NONE)
	DISP_FUNCTION(CMainWnd, "ShowPivot", ShowPivot, VT_EMPTY, VTS_BOOL)
	//}}AFX_DISPATCH_MAP
END_DISPATCH_MAP()
...
// {0E2CCEAD-B44E-4324-96A8-EB320938E408}
static const IID IID_IMainWnd =
{ 0xe2ccead, 0xb44e, 0x4324, { 0x96, 0xa8, 0xeb, 0x32, 0x9, 0x38, 0xe4, 0x8 } };
...
BSTR CMainWnd::GetProperties() 
{
	CString strResult;
	// TODO: Add your dispatch handler code here
	strResult = m_pGrpWnd->MakeOption();
	return strResult.AllocSysString();
}

void CMainWnd::ChangeName(LPCTSTR name) 
{
	// TODO: Add your dispatch handler code here
	m_pGrpWnd->ChangeName(name);
}
...
void CMainWnd::ShowPivot(BOOL bShow) 
{
	// TODO: Add your dispatch handler code here
	m_pGrpWnd->DisplayPivot(bShow);
}
