// C_MultiLine.cpp : Defines the initialization routines for the DLL.
//
...
BEGIN_MESSAGE_MAP(CC_MultiLineApp, CWinApp)
	//{{AFX_MSG_MAP(CC_MultiLineApp)
...
/////////////////////////////////////////////////////////////////////////////
// CC_MultiLineApp construction

CC_MultiLineApp::CC_MultiLineApp()
{
	m_pView = NULL;
	m_pImgCtrl = NULL;
}
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CC_MultiLineApp object

CC_MultiLineApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CC_MultiLineApp initialization

BOOL CC_MultiLineApp::InitInstance()
{
...
#include "../../h/axisvar.h"
bool CC_MultiLineApp::CreateImage()
{
...
CImageList* CC_MultiLineApp::getImage(CString path, int Width, int Height, UINT flag, COLORREF crMask)
{
...
CFont* CC_MultiLineApp::GetFont(CWnd* pView, int point, CString name, int bold, bool italic)
{
	_fontR rFont;
...
CPen* CC_MultiLineApp::GetPen(CWnd* pView, int style, int width, COLORREF clr)
{
	_penR rPen;
	rPen.clr = clr;
	rPen.width = width;
...
CBrush* CC_MultiLineApp::GetBrush(CWnd* pView, COLORREF rColor)
{
	return (CBrush*) pView->SendMessage(WM_USER, getBRUSH, rColor);
}

CImageList* CC_MultiLineApp::GetImage(CWnd* pView, CString path, int Width, int Height, UINT flag, COLORREF crMask)
{
