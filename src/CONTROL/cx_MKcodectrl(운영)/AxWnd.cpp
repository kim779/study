...
__declspec(dllexport) CWnd* WINAPI axCreate(CWnd *parent, void* pParam)
{
	...
	m_pControlWnd->Create(NULL, NULL, WS_CHILD|WS_VISIBLE|WS_CLIPSIBLINGS, ((struct _param*)pParam)->rect, parent, 100);
...
long CAxWnd::AxMessage(WPARAM wParam, LPARAM lParam)	
{
	...
	case DLL_INB:
		...
		return (long)m_rtnStr.GetString();   // Control 사용시 DLL_INB 로  platforme에 값을 반환...
	// TR 조회시 받는 초기 데이터	======================================================================================
	case DLL_OUBx:
		break;
	case DLL_OUB:	// NOT USED. Use DLL_OUBx Only !!
		...
		break;
	// RealData	======================================================================================================
	case DLL_ALERTx:	// array type data
		break;
	case DLL_ALERT:		// string type data
