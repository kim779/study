...
CRealCheckDlg::CRealCheckDlg(CWnd* pParent /*=nullptr*/)
...
/*
	if (m_edData.GetSafeHwnd())
	{
		...
		m_edData.SetWindowPos(nullptr, 0, 0, rcData.Width(), rcData.Height(), SWP_NOMOVE);
		...
		m_listGrid.SetWindowPos(nullptr, 0, 0, rcData.Width(), rcData.Height(), SWP_NOMOVE);
