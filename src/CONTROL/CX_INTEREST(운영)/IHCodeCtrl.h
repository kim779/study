...
public:
	...
	const bool	IsHistoryMode() const;
	const bool	IsCodeListMode() const;
	const bool	JCodeLoad(CString tabPath);
	const bool	ELWCodeLoad(CString tabPath);
	void	RemoveCode();
	HWND	GetListHwnd() 
	{ 
...
public:
	...
	void	SetEditData(CString sData) const;
	void	SetUnit(int unit);
	void	HistoryMode() const;
	void	CodeListMode() const;
	void	LButtonUp();
