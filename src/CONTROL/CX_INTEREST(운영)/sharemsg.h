...
#define MK_REFLESH				68
#define MK_SETRTSCODE 69
...
#define MK_MEMODATA 124
#define MK_MEMOFILEPROCESSCHECK 125
#define MK_MARKET	        126
...
#define TRKEY_INTER_MEMO_SEARCH 0x1A
#define TRKEY_INTER_MEMO_INSERT 0x1B
#define TRKEY_INTER_MEMO_UPDATE 0x1C
#define TRKEY_INTER_MEMO_DELETE 0x1D
...
} gridHdr[] = 
{
	...
	{ IDS_GH_MPRICEPER,	70,	GVAT_SORTABS | GVAT_DRAGMOVE,	"3181",	GVFM_RIGHT,	GVAT_CONDITION | GVAT_SIGNx,				0 },	// 	NXT중간값  
