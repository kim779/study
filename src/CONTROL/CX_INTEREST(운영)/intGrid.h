...
public:
	...
	void    Blink(const int nRow, const int nCol, const ULONGLONG tick, CRect& rcRect);
	...
	int		GetGridWidth();
	void    setReal(const bool bflag) { _bReal = bflag; }
...
//	void	RowSwitch(int nRow1, int nRow2);
	...
	const bool    getReal() const { return _bReal; }
...
protected:
	...
	CRect _filterRect = CRect(0,0,0,0);
	bool	_bReal = false;
	// blink (for rtm)
...
public:
	...
	bool	setmemoCheck(int xrow, bool bflag = false);
