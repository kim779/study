...
# ADD LINK32 /nologo /subsystem:windows /dll /machine:I386 /out:"../../../dev/CX_NotifyAPI.dll"
...
# ADD LINK32 /nologo /subsystem:windows /dll /incremental:no /machine:I386 /out:"../../../dev/CX_NotifyAPI.dll" /pdbtype:sept
