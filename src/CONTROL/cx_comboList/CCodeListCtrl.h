...
{
	DECLARE_DYNAMIC(CCodeListCtrl)

public:
	CCodeListCtrl(CWnd* pWizard, CString sItems);
...
//		Moidfy...........by H.B.G
///////////////////////////////////////////////////////////////////////
	void	SetID(UINT nRes) { m_res = nRes; }
...
protected:
	...
	// Member data	
	std::unique_ptr< CEdit> m_pWndEdit;
...
public:
	BOOL		m_bPopMenu{};
	CWnd*		m_pWizard{};
	CString		m_items{};  //종목코드 종목명\t종목코드 종목명\t
	void StringSplit(const CString& str, CStringArray& arr, TCHAR chDelimitior) { _StringSplit(str, arr, chDelimitior); };
