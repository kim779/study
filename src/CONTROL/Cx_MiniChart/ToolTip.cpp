...
CToolTip::CToolTip(CWnd	*pView, CWnd *pGrpWnd, CWnd *pMainWnd)
{
	WNDCLASS wndcls{};
	HINSTANCE hInst = AfxGetInstanceHandle();
	if(!(::GetClassInfo(hInst, MJ_TOOLTIP_CLASS, &wndcls)))
	{
		...
		wndcls.lpszClassName	= MJ_TOOLTIP_CLASS;
	...
	m_font = ((CMainWnd*)m_pMainWnd)->GetFont(9, "±¼¸²");
}
...
int CToolTip::Create()
{
	...
	return CreateEx(dwExStyle, MJ_TOOLTIP_CLASS, nullptr, dwStyle, 
