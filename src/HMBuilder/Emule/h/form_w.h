...
struct	_formR {
	...
	BYTE	iok;	// I/O kind
	BYTE	shape;		// FM_GRID : select type
	...
	DWORD	sRGB;			// FM_BUTTON Select Color
...
#define	FM_GRID			11	// memo
#define FM_GRIDEX		12	// grid
...
struct	_cellR {
	...
	char	dat[512];		// COMBO display string
	char	txt[256];		// BUTTON string
	char	str[256];		// COMBO data string
