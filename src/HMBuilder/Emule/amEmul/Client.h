...
private:
	CMap	<int, int, CamBase*, CamBase*>	m_tips;
	...
	CMap	<CString, LPCTSTR, CString, LPCTSTR>	m_mapLuaPushData;
...
public:
	...
	void	GetKeyObject(CScreen* screen, CamBase*& form);
	...
	bool	isVisible(CScreen* screen, CamBase* form);
	...
	bool	RunMenu(CScreen* screen, CamBase* form, CPoint point);
	void	ClearShift();
	...
	void	MakeFile(CScreen* screen, CamBase* form, CString path = _T(""), bool head = true, bool append = false);
	void	MakeXlsFile(CScreen* screen, CamBase* form, bool visible, CString path = _T(""), bool head = true);
	void	Export(CScreen* screen, CamBase* form, bool visible, CString data);
	void	OnPrint(CScreen* screen, CamBase* form, bool print);
	...
	void	OnAccount();
	void	EditColumns(CScreen* screen, CamBase* form);
...
// Implementation
protected:
	void	OnWrite(CScreen* screen, CamBase* form, CString text);
	void	FreeBK(bool reset = true);
	void	SetInitial(bool reset = true);
	void	SetCode(CString& codes);
	bool	SetCode(CScreen* screen, CamBase* form, CString& codes, bool force);
	bool	GetDragCell(CScreen* screen, CamBase* form, int& col, bool force);
	void	OnStart(CScreen* screen);
	void	OnDeclaretion(CScreen* screen);
	int		GetCodes(CString syms, CString& items, bool self);
	void	GetCodes(CString& codes);
	CString	GetFormat(CScreen* screen, CamBase* form);
