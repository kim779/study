...
// Operations
public:
	bool	OnDeclaretion(class CScreen* screen);
	...
	bool	OnReceive(class CScreen* screen);
	bool	OnKey(class CScreen* screen, class CamBase* form = NULL);
	...
	bool	OnChange(class CScreen* screen, class CamBase* form, bool byKey = false);
	bool	OnClick(class CScreen* screen, class CamBase* form, bool byKey = false);
	bool	OnDblClick(CScreen* screen, class CamBase* form);
	bool	OnMouseDown(class CScreen* screen, class CamBase* form);
	bool	OnMouseUp(class CScreen* screen, class CamBase* form);
	bool	OnCharChange(class CScreen* screen, class CamBase* form);
	...
	bool	IsAvailable(class CScreen* screen, int event, class CamBase* form = NULL);
