...
BEGIN_DISPATCH_MAP(CSockCtrl, COleControl)
	...
	DISP_FUNCTION(CSockCtrl, "WriteStream", WriteStream, VT_BOOL, VTS_I8 VTS_I4)
	...
	DISP_FUNCTION(CSockCtrl, "WriteDgram", WriteDgram, VT_BOOL, VTS_BSTR VTS_I8 VTS_I4 VTS_BOOL)
	DISP_FUNCTION(CSockCtrl, "StartAxis", StartAxis, VT_BOOL, VTS_I8 VTS_I4)
	DISP_FUNCTION(CSockCtrl, "GetEnum", GetEnum, VT_I4, VTS_I8 VTS_I4 VTS_I4)
	//}}AFX_DISPATCH_MAP
END_DISPATCH_MAP()
...
BEGIN_EVENT_MAP(CSockCtrl, COleControl)
	...
	EVENT_CUSTOM("OnStream", OnStream, VTS_I4  VTS_I8  VTS_I4)
	//}}AFX_EVENT_MAP
END_EVENT_MAP()
...
IMPLEMENT_OLECREATE_EX(CSockCtrl, "AxisSock.SockCtrl.KTB64",
	0xc8d8a27c, 0xb3e4, 0x4998, 0x97, 0xb6, 0x2e, 0xff, 0x95, 0x67, 0xb3, 0xf9)
