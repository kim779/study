...
public:
	...
	LPCTSTR	GetHeaderDirection();
	LPCTSTR	GetHeaderSortDirection();
	LPCTSTR	GetHeaderSortColumn();
	LPCTSTR	GetHeaderSave();
	LPCTSTR	GetHeaderPage();
	int	GetScrollX();
	void	SetSctollX(int x);
	int	GetScrollY();
	void	SetScrollY(int y);

	void	_SetFocus();
	void	_Refresh();
	LPCTSTR	_GetCell(long row, long col);
	void	_SetCell(long row, long col, LPCTSTR cells);
	LPCTSTR	_GetText(long row, long col);
	...
	void	_appendView(LPCTSTR mapName, int left, int top, int width, int Height);
	bool	_isCellChecked(long row, long col);
	void	_setCellChecked(long row, long col, bool checked);
	LPCTSTR	_getOrderInfo(bool isInitial);
	void	_setOrderInfo(LPCTSTR info);
	void	_scrollToRow(long row);
