...
#ifndef __IAmform_FWD_DEFINED__
#define __IAmform_FWD_DEFINED__
typedef interface IAmform IAmform;
#endif 	/* __IAmform_FWD_DEFINED__ */


#ifndef __Amform_FWD_DEFINED__
#define __Amform_FWD_DEFINED__

#ifdef __cplusplus
typedef class Amform Amform;
#else
typedef struct Amform Amform;
#endif /* __cplusplus */

#endif 	/* __Amform_FWD_DEFINED__ */
...
#ifndef __Amform_LIBRARY_DEFINED__
#define __Amform_LIBRARY_DEFINED__

/* library Amform */
/* [version][uuid] */ 


DEFINE_GUID(LIBID_Amform,0xFB34F483,0x60AC,0x4585,0xA2,0xD8,0x71,0x1C,0xC8,0x9D,0x90,0x49);

#ifndef __IAmform_DISPINTERFACE_DEFINED__
#define __IAmform_DISPINTERFACE_DEFINED__

/* dispinterface IAmform */
/* [uuid] */ 


DEFINE_GUID(DIID_IAmform,0x1AED3C4B,0x5A8A,0x48F3,0x82,0x1D,0xB0,0xE0,0xC6,0xC8,0x2D,0x3F);

#if defined(__cplusplus) && !defined(CINTERFACE)

    MIDL_INTERFACE("1AED3C4B-5A8A-48F3-821D-B0E0C6C82D3F")
    IAmform : public IDispatch
    {
    };
    
#else 	/* C style interface */

    typedef struct IAmformVtbl
    {
        BEGIN_INTERFACE
    ...
    interface IAmform
    {
        CONST_VTBL struct IAmformVtbl *lpVtbl;
    };
...
#define IAmform_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IAmform_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IAmform_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IAmform_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IAmform_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IAmform_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IAmform_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
...
#endif 	/* __IAmform_DISPINTERFACE_DEFINED__ */


DEFINE_GUID(CLSID_Amform,0x3E389F8A,0x3C8B,0x4E82,0xB5,0xB3,0x8B,0x98,0x9B,0xC8,0x78,0x5F);
...
fmCtrl;
#endif
#endif /* __Amform_LIBRARY_DEFINED__ */
