...
/////////////////////////////////////////////////////////////////////////////
// CamEditEx command target

class AFX_EXT_CLASS CamEditEx : public CamEdit
{
	DECLARE_DYNCREATE(CamEditEx)

public:
	CamEditEx();	           // protected constructor used by dynamic creation
	CamEditEx(CAmForm* axform, struct _formR* formR);
	virtual ~CamEditEx();
