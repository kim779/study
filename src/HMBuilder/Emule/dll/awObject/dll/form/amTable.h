...
public:
	...
	void	_Refresh();
	BSTR	_GetCell(long row);
	void	_SetCell(long row, LPCTSTR cells);
	BSTR	_GetText(long row);
	long	_GetPRgb(long row, long column);
	void	_SetPRgb(long row, long column, long rgb);
	long	_GetTRgb(long row, long column);
	void	_SetTRgb(long row, long column, long rgb);
	BSTR	_GetHead(long row);
