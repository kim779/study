...
public:
	...
	CTabPage(CWnd* pParent, struct _mapH* mapH, int index);
	virtual ~CTabPage();
...
public:
	...
	afx_msg void OnSetFocusForm1();
	afx_msg void OnSetFocusForm2();
	afx_msg void OnSetFocusForm3();
	afx_msg void OnSetFocusForm4();
	afx_msg void OnSetFocusForm5();
	afx_msg void OnSetFocusForm6();
	afx_msg void OnSetFocusForm7();
	afx_msg void OnSetFocusForm8();
	afx_msg void OnSetFocusForm9();
	afx_msg void OnSetFocusForm10();
	afx_msg void OnSetFocusForm11();
	afx_msg void OnSetFocusForm12();
	afx_msg void OnSetFocusForm13();
	afx_msg void OnSetFocusForm14();
	afx_msg void OnSetFocusForm15();
	afx_msg void OnSetFocusForm16();
};
