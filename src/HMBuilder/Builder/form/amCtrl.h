...
#include "ambase.h"
/////////////////////////////////////////////////////////////////////////////
// CamCtrl command target

class AFX_EXT_CLASS CamCtrl : public CamBase
{
	DECLARE_DYNCREATE(CamCtrl)

public:
	CamCtrl();           // protected constructor used by dynamic creation
	CamCtrl(CAmForm* axform, struct _formR* formR, bool drawOnly);
	virtual ~CamCtrl();
