...
#define KJCODE		"kjcode.dat"
#define	AXISMSG		"axismsg.dat"
#define	VTCODE		"vtcode.ini"
#define	PJCODE		"pjcode.dat"
#define	SFCODE		"sfcode.dat"
#define	CASTLST		"castlist.ini"
...
#define STANDARDLINE	"STANDARDLINE"
...
#define		fid_PINCH	'1'		// 대행유저
#define		fid_FACCT	'2'		// 선물계좌정보
#define		fid_FFUND	'3'		// 선물펀드정보
