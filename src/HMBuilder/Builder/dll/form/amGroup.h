...
/////////////////////////////////////////////////////////////////////////////
// CamGroup command target

class AFX_EXT_CLASS CamGroup : public CamBase
{
	DECLARE_DYNCREATE(CamGroup)

public:
	CamGroup();	           // protected constructor used by dynamic creation
	CamGroup(CAmForm* axform, struct _formR* formR);
	virtual ~CamGroup();
