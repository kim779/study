...
#include "afxtempl.h"
#include "afxmt.h"
#include "grid/range.h"
#include "grid/titletip.h"
#include "grid/griditem.h"
#include "grid/droptarget.h"
...
class  CfxGrid : public CWnd
{

// Construction
public:
	CfxGrid(LOGFONT* logfont = NULL);
...
// Force Focus
	void	SetForceFocusLine(BOOL bCheck = TRUE) { m_bForceFocuse = bCheck; }	// FALSE일 경우 강제로 보여주지 않는다.
// Attributes
protected:
	bool		m_oleInit;
	int		m_NOscroll;
...
protected:
	...
	void	DrawBong(CDC* pDC, CRect rect, double value[6], COLORREF clrUP, COLORREF clrDN);	/* 2009. 3. 23. 일봉 그리기 */
