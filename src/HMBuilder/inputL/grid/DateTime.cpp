...
BOOL CDateTime::OnDateTimeChangeNotify(NMHDR* nmhdr, LRESULT* pResult)
{
	*pResult = 0;    // docs say we must return 0

	NMDATETIMECHANGE *dtmh = (NMDATETIMECHANGE *)nmhdr;
...
BOOL CDateTime::OnFormat(NMHDR* nmhdr, LRESULT* pResult)
{
///	NMDATETIMEFORMAT* /*lpNMFormat*/
	*pResult = 0; 
	return FALSE; 
}

BOOL CDateTime::OnFormatQuery(NMHDR* nmhdr, LRESULT* pResult)
{
	NMDATETIMEFORMATQUERY* lpDTFormatQuery = (NMDATETIMEFORMATQUERY*)nmhdr;
	*pResult = 0; lpDTFormatQuery->szMax = CSize(366,16);
	return FALSE;
}

BOOL CDateTime::OnUserString(NMHDR* nmhdr, LRESULT* pResult)
{
///	NMDATETIMESTRING* /*lpDTstring*/
	*pResult = 0;
	return FALSE;
}
