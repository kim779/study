...
typedef struct _GVITEM
{
	...
	void Clear(){ row = 0; col = 0; mask = 0; state = 0; attr = 0; format = 0; text.Empty(); image = 0; ZeroMemory(&font, sizeof(LOGFONT)), fgcol = bkcol = 0; symbol.Empty(); misc.Empty(), param = 0; };
} GVITEM;
...
#define GVAT_PERCENTAGE		0x00080000	// Format '%'
...
#define GVAT_DRAWBONG		0x40000000	// 2009. 3. 23. 일봉 그리기 추가
