...
protected:
	...
	//}}AFX_MSG
	virtual BOOL OnDateTimeChangeNotify(NMHDR* nmhdr, LRESULT* result);	      
	virtual BOOL OnDropDown(NMHDR * pNotifyStruct, LRESULT* result);
	virtual BOOL OnCloseUp(NMHDR * pNotifyStruct, LRESULT* result);
	virtual BOOL OnFormat(NMHDR* nmhdr, LRESULT* pResult);				
	virtual BOOL OnFormatQuery(NMHDR* nmhdr, LRESULT* pResult);	         	
	virtual BOOL OnUserString(NMHDR* nmhdr, LRESULT* pResult);			
