...
BEGIN_MESSAGE_MAP(CDateTime, CWnd)
	...
	ON_WM_KILLFOCUS()
	//}}AFX_MSG_MAP
	//ON_NOTIFY_REFLECT_EX(DTN_DATETIMECHANGE, OnDateTimeChangeNotify) //vc2019  林籍

	ON_NOTIFY_REFLECT_EX(DTN_DROPDOWN,       OnDropDown)
	ON_NOTIFY_REFLECT_EX(DTN_CLOSEUP,        OnCloseUp)
	//ON_NOTIFY_REFLECT_EX(DTN_FORMAT,         OnFormat)									//vc2019 林籍
	//ON_NOTIFY_REFLECT_EX(DTN_FORMATQUERY,    OnFormatQuery)					//vc2019 林籍
	//ON_NOTIFY_REFLECT_EX(DTN_USERSTRING,     OnUserString)							//vc2019 林籍
//	ON_NOTIFY_REFLECT_EX(DTN_WMKEYDOWN,      OnKeyDown)							//vc2019 林籍
END_MESSAGE_MAP()
...
BOOL CDateTime::OnDateTimeChangeNotify(NMDATETIMECHANGE *dtmh, LRESULT* pResult)
{
...
BOOL CDateTime::OnFormatQuery(NMDATETIMEFORMATQUERY* lpDTFormatQuery, LRESULT* pResult)
{
