...
LRESULT CImgBtn::OnMouseHover(WPARAM wparam, LPARAM lparam) 
{
	m_bHover=TRUE;
	Invalidate();
	return 0;
...
LRESULT CImgBtn::HandleSetFont(WPARAM wParam, LPARAM lParam)
{
...
LOGFONT CImgBtn::setFont(int fsize, CString fname, BOOL bBold, BOOL bItalic)
{
	...
	strcpy_s(lf.lfFaceName, 32, fname);   
...
LRESULT CImgBtn::OnSetCheck(WPARAM wParam, LPARAM lParam)
{
...
BOOL CImgBtn::OnSetCursor(CWnd* pWnd, UINT nHitTest, UINT message)
{
