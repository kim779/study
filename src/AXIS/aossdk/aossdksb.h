...
#define	SBSDK_ACTIVATE_LAUNCHER					0x00000008L
#define	SBSDK_ACTIVATE_REMOTE					0x00000010L
...
#define SBSDK_CALLBACK_REMOTE_DETECT			0x020007
// Attempting remote access has been blocked
#define SBSDK_CALLBACK_REMOTE_BLOCKD			0x020008
