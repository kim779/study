...
{
    WCHAR szTitle[MAX_LOADSTRING] = L"TITLE_test";
    CHECK_FAILURE(CoInitializeEx(NULL, COINIT_APARTMENTTHREADED));
    //LoadStringW(hInst, IDS_ABOUTBOX, szTitle, MAX_LOADSTRING);
...
PCWSTR AppWindow::GetWindowClass()
{
    ...
    static PCWSTR windowClass = [] {
        static WCHAR windowClass[MAX_LOADSTRING] = L"WEBVIEW2SAMPLECOMP";
      //  LoadStringW(hInst, IDC_WEBVIEW2SAMPLEWINCOMP, windowClass, MAX_LOADSTRING);
        ...
        wcex.hIcon = LoadIcon(hInst, MAKEINTRESOURCE(IDR_MAINFRAME));
        wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
        wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
        wcex.lpszMenuName = MAKEINTRESOURCEW(IDS_ABOUTBOX);
