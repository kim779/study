...
//#include "ScenarioWebViewEventMonitor.h"  //test
...
ControlComponent::ControlComponent(CBrowserWnd* appWindow)
...
void ControlComponent::NavigateToAddressBar()
{
    ...
    std::wstring uri;
    std::string message_a = strurl;

    uri.assign(message_a.begin(), message_a.end());
   // std::wstring uri(strurl.GetLength(), 0);
    //PWSTR buffer = const_cast<PWSTR>(strurl.GetBuffer(0));
