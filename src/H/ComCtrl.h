...
public:
	...
	{
		return CreateControl("AXCOMCTL.AxComCtl.2", NULL, NULL,
	...
	void SetBtnTextColor(CWnd *key, COLORREF clText)
	{
		InvokeHelper(114, DISPATCH_METHOD, VT_EMPTY, (void*)NULL, (BYTE*)VTS_I4 VTS_I4,
			(long)key, clText);
	}
	...
	void	SetGridFocusLine(CWnd *key, BOOL focus, BOOL select, BOOL bFullRowSel = FALSE, BOOL bMultiRowSel = FALSE)
	{
		InvokeHelper(53, DISPATCH_METHOD, VT_EMPTY, (void*)NULL, (BYTE*) VTS_I4 VTS_BOOL VTS_BOOL VTS_BOOL VTS_BOOL,
			(long)key, focus, select, bFullRowSel, bMultiRowSel);
	}
