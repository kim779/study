// IWDblList.h: interface for the CIWDblList class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_IWDBLLIST_H__FF1643F1_98F5_4614_AD43_80DDF50F457C__INCLUDED_)
#define AFX_IWDBLLIST_H__FF1643F1_98F5_4614_AD43_80DDF50F457C__INCLUDED_
...
#include "../Include_AddIn/_IWUnknown.h"
#include "IDblList.h"

class CIWDblList : public CIWUnknown, public IDblList
{
typedef CList<double, double> CDblList;
// (2004.10.07, 배승원) Interface Wrapper의 기본 Interface (IUnknown용)를 제공한다.
protected:
	_IWRAPPER_IUNKNOWN_MANAGER( IDblList, CIWDblList, CDblList, m_plDblList);
...
#endif // !defined(AFX_IWDBLLIST_H__FF1643F1_98F5_4614_AD43_80DDF50F457C__INCLUDED_)
