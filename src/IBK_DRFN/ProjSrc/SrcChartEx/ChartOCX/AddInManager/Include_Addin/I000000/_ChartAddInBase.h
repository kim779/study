...
protected:
	void			RemoveAllInterface( void);
	virtual void	OnOcxDestroyWindow( void);
	virtual void	AfeterOnOcxDestroyWindow( void)							{}
...
protected:
	...
	virtual void	ChangeChartMode( CChartInfo::CHART_MODE p_eChartMode)	{	m_eChartMode = p_eChartMode;	}
