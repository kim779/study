...
public:
	...
	virtual BOOL	IsUseStandardValue(	const int p_nType = 0) = 0;		// 0:Base,	1:Upper Base,	2:Lower Base
	virtual double	GetStandardValue(	const int p_nType = 0) = 0;		// 0:Base,	1:Upper Base,	2:Lower Base
...
public:
	...
	virtual int		GetOrgBaseTimeDifference( void) = 0;
	virtual double	CalcTimeDiff( double dData, int nTimeDiff) = 0;
};
