...
//////////////////////////////////////////////////////////////////////
IChartCtrl *CIWChartOCX::GetIChartCtrl( void)
{
...
IChartManager *CIWChartOCX::GetIChartManager( void)
{
	...
	CIWChartManager *pChartManager = ( CIWChartManager *)CIWChartManager::CreateObject( pMainBlock);
	pChartManager->SetXScaleManager( m_pIChartCtrl->GetXScaleManager());
	pChartManager->SetIChartOCX( this);
...
void CIWChartOCX::LockWindowUpdate( void)
{
	if( m_pIChartCtrl) m_pIChartCtrl->LockWindowUpdate();
}
void CIWChartOCX::UnlockWindowUpdate( void)
{
	if( m_pIChartCtrl) m_pIChartCtrl->UnlockWindowUpdate();
}

// (2009/6/5 - Seung-Won, Bae) for CmdUI of AddIn
void CIWChartOCX::OnCmdMsg( HMENU p_hMenu, UINT p_nItemID, int p_nItemPos, int p_nItemCount, int p_nCmdCode)
{
	if( m_pIChartCtrl) m_pIChartCtrl->OnCmdMsg( p_hMenu, p_nItemID, p_nItemPos, p_nItemCount, p_nCmdCode);
}
...
IString *CIWChartOCX::GetProgID( void)
{
	if(!m_pIChartCtrl) return NULL;
	CString strProgID;
	m_pIChartCtrl->GetProgID( strProgID);
	return  CIWString::CreateObject( strProgID);
}
...
IString *CIWChartOCX::GetTestEnvValue( const char *p_szEnvKey)
{
	if(!m_pIChartCtrl) return NULL;
	CString strValue;
	m_pIChartCtrl->GetTestEnvValue( p_szEnvKey, strValue);
	return  CIWString::CreateObject( strValue);
}

// (2009/9/2 - Seung-Won, Bae) for Image Path
IString *CIWChartOCX::GetImagePathString( void)
{
	if(!m_pIChartCtrl) return NULL;
	CString strImagePath;
	m_pIChartCtrl->GetImagePath( strImagePath);
	return CIWString::CreateObject( strImagePath);
}
...
BOOL CIWChartOCX::IsOnNoZoomChart( void)
{
	if( m_pIChartCtrl) return m_pIChartCtrl->IsRunningNoZoomChart();
	return FALSE;
}
...
BOOL CIWChartOCX::IsEnableIndicatorCalculation( void)
{
	if( !m_pIChartCtrl) return TRUE;
	return m_pIChartCtrl->IsEnableIndicatorCalculation();
}
...
long CIWChartOCX::GetDrawingLoadTime( void)
{
	if( !m_pIChartCtrl) return 0;
	return m_pIChartCtrl->GetDrawingLoadTime();
}
...
BOOL CIWChartOCX::CanGraphMoveAndDelete( void)
{
	if( m_pIChartCtrl) return m_pIChartCtrl->CanGraphMoveAndDelete();
	return FALSE;
}
...
void CIWChartOCX::ResetScroll( BOOL p_bWithCalcDRI)
{
	...
	if( !m_pIChartCtrl || !nAllowScroll) return;
	m_pIChartCtrl->ResetScroll( p_bWithCalcDRI);
}
...
IString *CIWChartOCX::GetChartList( void)
{
	if( !m_pIChartCtrl) return NULL;
	return CIWString::CreateObject( m_pIChartCtrl->GetChartList());
}
void CIWChartOCX::SetChartList( const char *p_szChartList)
{
	if( !m_pIChartCtrl) return;
	m_pIChartCtrl->SetChartList( p_szChartList);
}
...
void CIWChartOCX::OnUserZoomChanged( const int p_nDataCountInView)
{
	if( m_pIChartCtrl) m_pIChartCtrl->OnUserZoomChanged( p_nDataCountInView);
}

// FX차트 주문 연동 - onlyojt (20091204)
BOOL CIWChartOCX::OnOrderInfomationChanged(const double dPirce, const int Qty, const int nOrderType, LPCTSTR szOrgOrderID, LPCTSTR strCustItem1, LPCTSTR strCustItem2, LPCTSTR strCustItem3)
{
	if( m_pIChartCtrl) 
		return m_pIChartCtrl->OnOrderInfomationChanged(dPirce, Qty, nOrderType, szOrgOrderID, strCustItem1, strCustItem2, strCustItem3);
	else 
		return FALSE;
}
...
//////////////////////////////////////////////////////////////////////
BOOL CIWChartOCX::SetBinTrHelpMsg( const char *p_szHelpMessage)
{
	if( m_pIChartCtrl) return m_pIChartCtrl->SetBinTrHelpMsg( p_szHelpMessage);
	return FALSE;
}
BOOL CIWChartOCX::SetBinTrDoubleData( const char *p_szPacketName, long p_nCount, double FAR* p_pdData)
{
	if( m_pIChartCtrl) return m_pIChartCtrl->SetBinTrDoubleData( p_szPacketName, p_nCount, p_pdData);
	return FALSE;
}
BOOL CIWChartOCX::SetBinTrStringData( const char *p_szPacketName, long p_nCount, long p_lData)
{
	if( m_pIChartCtrl) return m_pIChartCtrl->SetBinTrStringData( p_szPacketName, p_nCount, p_lData);
	return FALSE;
}
BOOL CIWChartOCX::SetBinTrEnd( void)
{
	if( m_pIChartCtrl) return m_pIChartCtrl->SetBinTrEnd();
	return FALSE;
}
...
void CIWChartOCX::SetOnRealProcessing( BOOL p_bOn)
{
	if( m_pIChartCtrl) m_pIChartCtrl->SetOnRealProcessing( p_bOn);
}
...
void CIWChartOCX::LockScrollUIUpdateWithScrollInfo( BOOL p_bLockScrollUIUpdate)
{
	if( m_pIChartCtrl) m_pIChartCtrl->LockScrollUIUpdateWithScrollInfo( p_bLockScrollUIUpdate);
}

// (2009/9/1 - Seung-Won, Bae) Define Chart Mode.
CChartInfo::CHART_MODE CIWChartOCX::GetChartMode( void)
{
