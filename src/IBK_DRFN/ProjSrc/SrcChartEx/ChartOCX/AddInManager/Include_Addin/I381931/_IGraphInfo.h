...
public:
	...
	virtual COLORREF	GetSubGraphColorWithZBI( const int p_nSubGraphIndex, const int p_nColorIndex) = 0;
	virtual BOOL		SetSubGraphColorWithZBI( const int p_nSubGraphIndex, const int p_nColorIndex, const COLORREF p_clrColor) = 0;
	...
	virtual int			GetSubGraphPenThicknessWithZBI( const int p_nSubGraphIndex, const int p_nPenIndex) = 0;
...
public:
	...
	virtual void	SetGraphDataDrawingData( BOOL p_bLowHigh, BOOL p_bLowCur, BOOL p_bHighCur, BOOL p_bPrevCur, int p_nCurData) = 0;
