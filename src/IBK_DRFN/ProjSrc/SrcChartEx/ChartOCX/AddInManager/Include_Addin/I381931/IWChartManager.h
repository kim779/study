...
protected:
	...
	virtual IString *		GetSubGraphPacketName( const char *p_szGraphName, const char *p_szSubGraphName, const int p_nPacketIndex);
...
protected:
	virtual POSITION	GetSubGraphViewData_First( const char *p_szRQ = "DEFAULT");
