...
public:
	...
	virtual IString *		FindFirstIndicator( const char *p_szIndicatorName, int &p_nR, int &p_nC, int &p_nV, int &p_nG, const char *p_szRQ = "DEFAULT") = 0;
	virtual IString *		FindNextIndicator( const char *p_szIndicatorName, int &p_nR, int &p_nC, int &p_nV, int &p_nG) = 0;
	...
	virtual IString *		GetSubGraphPacketName( const char *p_szGraphName, const char *p_szSubGraphName, const int p_nPacketIndex) = 0;
...
public:
	virtual POSITION	GetSubGraphViewData_First( const char *p_szRQ = "DEFAULT")																					= 0;
