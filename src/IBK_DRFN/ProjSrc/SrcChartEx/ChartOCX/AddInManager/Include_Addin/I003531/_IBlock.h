...
public:
	...
	virtual int									GetScaleTextType( void) = 0;
	virtual int									GetHorizontalScaleHeight( void) const = 0;		// XScale 높이 지정 - ojtaso (20080429)
...
public:
	virtual IString *	GetCoordinateInfos( IPacket *&p_pIPacketX, IPacket *&p_pIPacketY, double &p_dMinY, double &p_dMaxY, double &p_dDataType, BOOL &p_bLog, BOOL &p_bInvert) = 0;
};
