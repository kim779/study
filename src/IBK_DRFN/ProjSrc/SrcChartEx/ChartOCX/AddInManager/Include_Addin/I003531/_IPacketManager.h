...
public:
	...
	virtual ILPCSTR		GetRealTimeType( void) = 0;
	// (2009/11/12 - Seung-Won, Bae) Get NMTR Info
	virtual BOOL		GetLastClockAndRealTime( __int64 &p_nLastClockTime, __int64 &p_nLastRealTime) = 0;
	// (2009/11/12 - Seung-Won, Bae) for NMTR Step Width
	virtual __int64		GetTimeIntervalWithSecond( void) = 0;
};
