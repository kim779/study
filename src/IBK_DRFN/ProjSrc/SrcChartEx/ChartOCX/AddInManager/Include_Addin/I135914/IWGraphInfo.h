...
protected:																						
	...
	{																							
		...
		{																						
			m_ulReference = 0;																	
			if( m_bAutoDelete) delete m_pIndicatorInfo;											
...
protected:
	...
	virtual COLORREF	GetSubGraphColor( const int p_nSubGraphIndex, const int p_nColorIndex);
	virtual BOOL		SetSubGraphColor( const int p_nSubGraphIndex, const int p_nColorIndex, const COLORREF p_clrColor);
	...
	virtual int			GetSubGraphPenThickness( const int p_nSubGraphIndex, const int p_nPenIndex);
	...
	virtual int			GetBaseLinePenThickness( const int p_nSubGraphIndex, const int p_nPenIndex);
	virtual BOOL		SetBaseLinePenThickness( const int p_nSubGraphIndex, const int p_nThickness);
	virtual int			GetSubGraphDrawBaseLineStyle( const int p_nSubGraphIndex);
	virtual BOOL		SetSubGraphDrawBaseLineStyle( const int p_nSubGraphIndex, const int p_nGraphDrawStyle);
...
protected:
	virtual int		GetSubGraphPaintStyle(const int p_nSubGraphIndex);
	virtual void	SetSubGraphPaintStyle(const int p_nSubGraphIndex, const int p_nPaintStyle);
};
