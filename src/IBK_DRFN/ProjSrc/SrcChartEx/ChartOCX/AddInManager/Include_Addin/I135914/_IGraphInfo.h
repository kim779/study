...
public:
	...
	virtual int			GetBaseLinePenThickness( const int p_nSubGraphIndex, const int p_nPenIndex) = 0;
	virtual BOOL		SetBaseLinePenThickness( const int p_nSubGraphIndex, const int p_nThickness) = 0;
	virtual int			GetSubGraphDrawBaseLineStyle( const int p_nSubGraphIndex) = 0;
	virtual BOOL		SetSubGraphDrawBaseLineStyle( const int p_nSubGraphIndex, const int p_nGraphDrawStyle) = 0;
...
public:
	...
	virtual IString *	GetIndicatorNameString( void)				= 0;
	virtual IString *	GetIndicatorGroupNameString( void)			= 0;
...
public:
	virtual int		GetSubGraphPaintStyle(const int p_nSubGraphIndex) = 0;
	virtual void	SetSubGraphPaintStyle(const int p_nSubGraphIndex, const int p_nPaintStyle) = 0;
};
