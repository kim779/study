...
//						36	~ WF (Woori FX)
//						50	~ EJ (EuGene)
//						00	~ CO (Common)		// Addin분리 - onlyojt (20100305)
//
//	5. AddIn Code	:
...
//						3521	~ COLA ( Chart Order Line AddIn) ~ Not Used. Use 'Chart Period Summary AddIn'.
//						3721	~ CGLA ( Chart Guide Line AddIn)
//						1931	~ KSCA ( Korea Sorimachi Custom AddIn)
//						3531	~ COCA ( Chart Outside Custom AddIn)
...
interface IChartOCX133721;	// KC - CGLA
interface IChartOCX999092;	// SS - STIA2
interface IChartOCX139092;	// KC - STIA2
interface IChartOCX381931;	// WR - KSCA
interface IChartOCX333721;	// WW - CGLA
interface IChartOCX363721;	// WF - CGLA
interface IChartOCX503721;	// EG - CGLA
interface IChartOCX339092;	// WW - STIA2
interface IChartOCX509092;	// EG - STIA2
interface IChartOCX003531;	// CO - COCA		// Addin분리 - onlyojt (20100305)
interface IChartOCX003721;	// SM - COCA
...
//////////////////////////////////////////////////////////////////////
	...
	virtual IChartOCX133721 *	GetIChartOCX133721( void)	= 0;	// KC - CGLA
	virtual IChartOCX999092 *	GetIChartOCX999092( void)	= 0;	// SS - STIA2
	virtual IChartOCX139092 *	GetIChartOCX139092( void)	= 0;	// KC - STIA2
	virtual IChartOCX381931 *	GetIChartOCX381931( void)	= 0;	// WR - KSCA
	virtual IChartOCX333721 *	GetIChartOCX333721( void)	= 0;	// WW - CGLA
	virtual IChartOCX363721 *	GetIChartOCX363721( void)	= 0;	// WF - CGLA
	virtual IChartOCX503721 *	GetIChartOCX503721( void)	= 0;	// EG - CGLA
	virtual IChartOCX339092 *	GetIChartOCX339092( void)	= 0;	// WW - STIA2
	virtual IChartOCX509092 *	GetIChartOCX509092( void)	= 0;	// EG - STIA2
	virtual IChartOCX003531 *	GetIChartOCX003531( void)	= 0;	// CO - COCA	// Addin분리 - onlyojt (20100305)
	virtual IChartOCX003721 *	GetIChartOCX003721( void)	= 0;	// SM - COCA
//////////////////////////////////////////////////////////////////////
// (2006/1/5 - Seung-Won, Bae) Caution. Add to bottom!
//////////////////////////////////////////////////////////////////////
};

// (2007/6/11 - Seung-Won, Bae) Support AddIn Version Info Value in Code.
#define _NAIVER_GET( nAVersion)		( 1##nAVersion - 1000000)
#define _NAIVER						_NAIVER_GET( _AIVER)
#define _NAIMCODE					( _NAIVER % 10000)
