...
protected:
	...
	// (2006/11/12 - Seung-Won, Bae) Support AddIn ENV Value Map (ISSUE NO - 0008210).
...
protected:
	...
	virtual void	OnCaptureChanged(	HWND p_hWnd)	{}
...
protected:
	...
	virtual BOOL	OnAddInToolCommand(	const EAICommandType p_eCommandID, HWND p_hWnd, POINT &point)											{	return FALSE;	}
...
protected:
	...
	virtual BOOL	OnMouseMove(		HDC p_hDC, UINT nFlags, POINT &point, const DWORD p_dwMouseActionID)									{	return FALSE;	}
