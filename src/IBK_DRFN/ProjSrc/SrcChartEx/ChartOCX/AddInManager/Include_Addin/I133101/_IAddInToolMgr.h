...
public:
	...
	virtual BOOL	IsAddInLoaded( const char *p_szAddInItem) = 0;
...
public:
	...
	virtual void	OnPacketDataMultiItem( const char * p_szRQ, const char *p_szPacketNames, BOOL p_bWithReset) = 0;
	...
	virtual BOOL	OnPreRealData( const char *p_szPacketName, double &p_dData, const char *p_szRQ = NULL) = 0;
	virtual BOOL	OnPreIndexedRealData( const char *p_szPacketName, const int p_nIndex, double &p_dData) = 0;
	virtual BOOL	OnPreRealPacketEnd( const char *p_szRQ = NULL) = 0;
