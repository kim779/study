...
typedef enum EAICommandType
{
	...
	//		OnAddInToolCommand(	long &p_lResult, const EAICommandType p_eCommandID, const char *p_szParam1, const char *p_szParam2, CObject *p_pParam)
	//			p_lResult	: Return Value
	//			p_szParam1	: Indicator Name
	//			p_szParam2	: Graph Name
