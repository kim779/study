...
//			AfxMessageBox("Drds DLL을 Load할 수 없습니다.");
	...
	void* DrdsInit(HWND hWnd)
	{
		...
		if(fnDrdsInit == NULL)
		{
			AfxMessageBox("DrdsInit() is not found.");
			return NULL;
		}
	...
	HWND  DrdsGetBrodHwnd()
	{
		...
		{
			AfxMessageBox("DrdsGetBrodHwnd() is not found.");
			return NULL;
		}
	...
	BOOL  DrdsSetSocketHandle(HWND hWnd)
	{
		...
		{
			AfxMessageBox("DrdsSetSocketHandle() is not found.");
			return FALSE;	
		}
	...
	BOOL DrdsTerm(void* pDrds, HWND hWnd)
	{
		...
		if(fnDrdsTerm == NULL)
		{
			AfxMessageBox("DrdsTerm() is not found.");
			return FALSE;
		}
	...
	BOOL DrdsConnect(void* pDrds, HWND hWnd,LPSTR DataName)
	{
		...
		{
			AfxMessageBox("DrdsConnect() is not found.");
			return FALSE;
		}
		BOOL bResult; 
	...
	BOOL DrdsClose(void* pDrds, HWND hWnd,LPSTR DataName)
	{
		...
		if(fnDrdsClose == NULL)
		{
			AfxMessageBox("DrdsClose() is not found.");
			return FALSE;
		}
		BOOL bResult; 
	...
	BOOL DrdsAdvise(void* pDrds, HWND hWnd,UINT id, LPSTR DataName, LPSTR FieldName, LPSTR KeyName)
	{
		...
		{
			AfxMessageBox("DrdsAdvise() is not found.");
			return FALSE;
		}
		BOOL bResult; 
						 ...
						 LPSTR FieldName, LPSTR KeyName, LPSTR ObjectName)
	{
		...
		{
			AfxMessageBox("DrdsAdviseEx() is not found.");
			return FALSE;
		}
		BOOL bResult; 
	...
	BOOL DrdsUnadvise(void* pDrds, HWND hWnd,UINT id, LPSTR DataName, LPSTR FieldName, LPSTR KeyName)
	{
		...
		{
			AfxMessageBox("DrdsUnadvise() is not found.");
			return FALSE;
		}
	...
	BOOL DrdsUnadviseEx(int nComponentType, HWND hWnd,UINT id, LPSTR DataName, LPSTR FieldName, LPSTR KeyName, LPSTR ObjectName)
	{
		...
		{
			AfxMessageBox("DrdsUnadviseEx() is not found.");
			return FALSE;
		}
	...
	void	DrdsSendCode()
	{
		...
		{
			AfxMessageBox("DrdsSendCode() is not found.");
			return;
		}
		fnDrdsSendCode();
		return;
	...
	void DrdsSetFlag(BOOL bFlag)
	{
		...
		{
			AfxMessageBox("DrdsSetFlag() is not found.");
			return;
		}
	...
	int	UDPCreate()
	{
		...
		{
			AfxMessageBox("UDPCreate() is not found.");
			return 0;
		}
	...
	int	UDPCreate2(LPSTR strIP, LPSTR strPort)
	{
		...
		{
			AfxMessageBox("UDPCreate2() is not found.");
			return 0;
		}
	...
	int UdpCreate3(LPSTR sCfgFullPathName)
	{
		...
		{
			AfxMessageBox("UdpCreate3() is not found.");
			return 0;
		}
	...
	void	UDPDestroy()
	{
		...
		{
			AfxMessageBox("UDPDestroy() is not found.");
			return;
		}
		fnDrdsUDPDestroy();
		return;
	...
	int SetUserDefData(LPSTR sKeyName, LPSTR sData)
	{
		...
		{
			AfxMessageBox("SetUserDefData() is not found.");
			return 0;
		}
	...
	BOOL AdviseRealCodeData(BOOL bIsAdd, int nCount, LPSTR sPacketName, LPSTR sCodeList)
	{
		...
		{
			AfxMessageBox("AdviseRealCodeData() is not found.");
			return FALSE;
		}
