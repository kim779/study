...
private:
	COLORREF	m_color1;	// 상승/양봉 테두리 색
	COLORREF	m_color2;	// 상승/양봉 색
	COLORREF	m_color3;	// 하락/음봉 테두리 색
	COLORREF	m_color4;	// 하락/음봉 색
	COLORREF	m_color5;	// 보합 테두리 색
	COLORREF	m_color6;	// 보합 색
	// 상승, 양봉, 하락, 음봉 색상 분리 - ojtaso (20080707)
	COLORREF	m_color7;	// 상승/음봉 테두리 색
	COLORREF	m_color8;	// 상승/음봉 색
	COLORREF	m_color9;	// 하락/양봉 테두리 색
	COLORREF	m_color10;	// 하락/양봉 색
	// 상승, 양봉, 하락, 음봉 색상 분리 - ojtaso (20080707)
	bool		m_bUpPositiveGraphFill;	// 상승/양봉의 채움
	bool		m_bUpNegativeGraphFill;	// 상승/음봉의 채움
	bool		m_bDownPositiveGraphFill;	// 하락/양봉의 채움
	bool		m_bDownNegativeGraphFill;	// 하락/음봉의 채움
