...
CSubGraphViewData& CSubGraphViewData::operator=(const CSubGraphViewData& subGraphViewData)
{
	...
	m_strRQ = subGraphViewData.GetRQ();
	return *this;
}
...
CSubGraphViewData::CSubGraphViewData(const CGraphBaseData::GRAPHTYPE type, const CGraphStyle& style, const CString& title, const CString& packetNames, const CString& strRQ):
	m_TYPEGraph(type),
	m_graphStyle(style),
	m_strTitle(title),
	m_strPacketNames(packetNames),
...
CString CSubGraphViewData::GetRQ() const
{
	return m_strRQ;
}
//////////////////////////////////////////////////////////////////////
...
CList<CRowViewData, CRowViewData&>& CColumnViewData::GetRowViewDataList( void)
{
	return m_rowViewDataList;
}
