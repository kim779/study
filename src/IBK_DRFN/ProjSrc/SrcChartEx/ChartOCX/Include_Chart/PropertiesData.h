...
#define _DPV_ADDINLIST						"070112:DIRECT_REAL,ENV_SETUP,STYLE_DATA,DATA_VIEWER,DATA_SIMULATOR,ADD_INDICATOR_CMD,SAVE_IMAGE,RELPSA,GAP_REVISION,KBD_SCROLL,DRAG_ZOOM,CROSS_DRAG,NIDLG_DRAG,TOOL_TIP,TIME_MARKER,ASKED_PRICE,ORDER_LINK,OBJECT_TOOL,ST_INDICATOR,PERIOD_SUMMARY,SYMBOL_TOOL,ANALYSIS_TOOL,CROSS_TOOL,ORDER_LINK:GLANCEBALANCE_CURSOR"
...
// Property Short Key
extern const char *g_anPropertyShortKey[ CHART_PROPERTY_COUNT];
...
typedef enum CHART_ADDIN_TYPE
{
	...
	AID_EXCEL_IMPORT,			// 36
	AID_ORDER_LINK,				// 37
	AID_DATA_SIMULATOR,			// 38		// 20081011 이문수 데이터시뮬레이션 >>
	AID_GAP_REVISION,			// 39		// 갭보정 - vntsorl(20090217)
//==============================================
	AID_COUNT					// 40
};
// AddIn ID String
