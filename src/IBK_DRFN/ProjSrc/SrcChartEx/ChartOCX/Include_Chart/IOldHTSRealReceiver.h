// IOldHTSRealReceiver.h: interface for the IOldHTSRealReceiver class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_IOldHTSRealReceiver_H__4E6768EB_BD1F_4493_87B9_2DCB96D51980__INCLUDED_)
#define AFX_IOldHTSRealReceiver_H__4E6768EB_BD1F_4493_87B9_2DCB96D51980__INCLUDED_
...
interface IOldHTSRealReceiver : public IUnknown
{
protected:
	virtual ~IOldHTSRealReceiver()	{}
...
public:
	...
	virtual BOOL	SetRealDataRQ(LPCTSTR lpszRQ, const char *p_szPacketName, double p_dData) 	{	return FALSE;	}
	virtual BOOL	SetRealPacketEndRQ(LPCTSTR lpszRQ) {	return FALSE;	}
