...
void CSelectSubGraphData::SetGraphName(const CString& GraphName)
{
...
void CSelectSubGraphData::SetXScaleManager(CXScaleManager* pXScaleManager)
{
	m_pXScaleManager = pXScaleManager;
}

void CSelectSubGraphData::SetRQ(CString strRQ)
{
	m_strRQ = strRQ;
}
// ----------------------------------------------------------------------------
...
CString CSelectSubGraphData::GetGraphName() const
{
...
CXScaleManager* CSelectSubGraphData::GetXScaleManager() const
{
	return m_pXScaleManager;
}

CString CSelectSubGraphData::GetRQ() const
{
	return m_strRQ;
}
