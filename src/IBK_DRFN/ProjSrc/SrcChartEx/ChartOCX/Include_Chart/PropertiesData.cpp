...
// Property Short Key
const char *g_anPropertyShortKey[ CHART_PROPERTY_COUNT] = 
{
	"CBKG",		// 0
	"CBKB",		// 1
	"CB",		// 2
...
char *g_aszAddInItemName[ AID_COUNT] = 
{
	...
	"EXCEL_IMPORT",			// 36
	"ORDER_LINK",			// 37
	"DATA_SIMULATOR",		// 38	// 20081011 이문수 데이터시뮬레이션 >>
	"GAP_REVISION"			// 39	// 갭보정 - vntsorl(20090217)
};
...
char *g_aszAddInLoadString[ AID_COUNT] = 
{
	...
	"ChartCommonAddIn.dll:ORDER_LINK",				// 37
	"ChartDataListViewerAddIn.dll:DATA_SIMULATOR",	// 38	// 20081011 이문수 데이터시뮬레이션 >>
	"ChartCommonAddIn.dll:GAP_REVISION",			// 39	// 갭보정 - vntsorl(20090217)
};
