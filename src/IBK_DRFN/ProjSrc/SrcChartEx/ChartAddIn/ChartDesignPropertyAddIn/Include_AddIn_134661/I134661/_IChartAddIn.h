...
public:
	...
	typedef enum
	{
		...
		ADDINEVENT( OnAddInToolCommand_EAICommandType_CWnd_CPoint),				// OnAddInToolCommand(	const EAICommandType p_eCommandID, CWnd *p_pWnd, CPoint &point)
...
public:
	...
	virtual BOOL	OnAddInToolCommand(	const EAICommandType p_eCommandID, CWnd *p_pWnd, CPoint &point) = 0;
