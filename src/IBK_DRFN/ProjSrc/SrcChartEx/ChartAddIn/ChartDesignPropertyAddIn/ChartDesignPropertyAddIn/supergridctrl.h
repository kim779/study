...
class CItemInfo : public CObject//should have called this LV_INSERTITEM ..what ever
{
public:
...
public:
	...
	bool m_bDragandDrop;
	// Overrides
	//MUST override this to make a copy of CItemInfo..see the CPacketSuperGrid.cpp for implementation
...
public:
	...
	//set bUpdate to TRUE.(see the use of bUpdate in the HowToInsertItemsAfterTheGridHasBeenInitialized function in the CPacketSuperGrid)
...
// Implementation
public:
	void InsertOneItemToListCtrl(CTreeItem *pParent, CTreeItem *pItem, CItemInfo* lpInfo,  BOOL bUpdate);
	void InsertItemToListCtrl(CTreeItem* pParent, CTreeItem* pItem, CItemInfo* lpInfo, BOOL bUpdate=FALSE);
	void InsertRootItemToListCtrl(CTreeItem* pItem);
	CEdit* m_pEditLabel;
	CEdit* m_pLButtonDownEdit;
