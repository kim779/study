// ChartDesignPropertyAddIn.cpp : Defines the initialization routines for the DLL.
//
...
#include "ChartDesignPropertyAddInImp.h"			// for CChartDesignPropertyAddInImp
...
BEGIN_MESSAGE_MAP(CChartDesignPropertyAddInApp, CWinApp)
	//{{AFX_MSG_MAP(CChartDesignPropertyAddInApp)
...
/////////////////////////////////////////////////////////////////////////////
// CChartDesignPropertyAddInApp construction

CChartDesignPropertyAddInApp::CChartDesignPropertyAddInApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CChartDesignPropertyAddInApp object

CChartDesignPropertyAddInApp theApp;


int CChartDesignPropertyAddInApp::ExitInstance() 
{
	// TODO: Add your specialized code here and/or call the base class
	if( IsWindow( CChartDesignPropertyAddInImp::m_dlgGLT.GetSafeHwnd()))
		CChartDesignPropertyAddInImp::m_dlgGLT.DestroyWindow();
...
//_CHART_ADDIN_IVERSION( 914661)
//#elif defined _ADDIN_DB
//_CHART_ADDIN_IVERSION( 424661)
//#elif defined _ADDIN_KC
_CHART_ADDIN_IVERSION( 134661)
//#elif defined _ADDIN_SS
//_CHART_ADDIN_IVERSION( 994661)
//#else
...
ADDIN_API IChartAddIn *InitAddInDll( const char *p_szAddInItem, IAddInManager *p_pIAddInManager, IAddInDllBase *p_pIAddInDllBase)
{
	...
	GET_ADDIN_OBJECT( CChartDesignPropertyAddInImp);
