...
public:
	...
	virtual BOOL			IsOnNoZoomChart( void) = 0;
...
public:
	...
	virtual BOOL		OnOrderInfomationChanged(const double dPirce, const int Qty, const int nOrderType, LPCTSTR szOrgOrderID, CString strCustItem1, CString strCustItem2, CString strCustItem3) = 0;
};
