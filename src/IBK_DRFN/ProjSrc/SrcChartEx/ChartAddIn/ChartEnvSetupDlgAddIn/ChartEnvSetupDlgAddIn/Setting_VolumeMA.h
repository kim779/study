#if !defined(AFX_SETTING_VOLUMEMA_H__2667F588_0A40_4C7C_A778_B3966230F59B__INCLUDED_)
#define AFX_SETTING_VOLUMEMA_H__2667F588_0A40_4C7C_A778_B3966230F59B__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// Setting_VolumeMA.h : header file
//
...
class CSetting_VolumeMA_Condition;


/////////////////////////////////////////////////////////////////////////////
// CSetting_VolumeMA dialog

class CSetting_VolumeMA : public CBaseDialog
{
// Construction
public:
	CSetting_VolumeMA( IChartOCX *p_pIChartOCX, CWnd* pParent = NULL, CWnd *pTopWnd = NULL);   // standard constructor
	virtual ~CSetting_VolumeMA();
...
// Dialog Data
	//{{AFX_DATA(CSetting_VolumeMA)
	enum { IDD = IDD_VOLUMEMA };
...
private:
	...
	CSetting_VolumeMA_Condition *m_pDlgMACondition;
...
#endif // !defined(AFX_SETTING_VOLUMEMA_H__2667F588_0A40_4C7C_A778_B3966230F59B__INCLUDED_)
