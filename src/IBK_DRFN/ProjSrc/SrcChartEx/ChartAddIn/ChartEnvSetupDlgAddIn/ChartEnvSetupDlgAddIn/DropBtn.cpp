...
int CDropList::AddString(LPCTSTR lpszItem)
{
	...
	//return AddToList(1, lpszItem);		// Sort Item
	return AddToList(0, lpszItem);			// No Sort Item
}
...
void CDropButton::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct )
{
	...
	pDC->DrawText(csText, csText.GetLength(), CRect(4, 0, m_WindowRect.right - (cTri.cx + 10), m_WindowRect.bottom), DT_LEFT|DT_VCENTER|DT_END_ELLIPSIS|DT_SINGLELINE);
