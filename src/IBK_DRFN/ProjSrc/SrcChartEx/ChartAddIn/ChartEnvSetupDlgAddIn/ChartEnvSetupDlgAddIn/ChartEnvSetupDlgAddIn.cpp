// ChartEnvSetupDlgAddIn.cpp : Defines the initialization routines for the DLL.
//
...
#include "ChartStyleDataManagerAddInImp.h"	// for CChartStyleDataManagerAddInImp
...
BEGIN_MESSAGE_MAP(CChartEnvSetupDlgAddInApp, CWinApp)
	//{{AFX_MSG_MAP(CChartEnvSetupDlgAddInApp)
...
/////////////////////////////////////////////////////////////////////////////
// CChartEnvSetupDlgAddInApp construction

CChartEnvSetupDlgAddInApp::CChartEnvSetupDlgAddInApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CChartEnvSetupDlgAddInApp object

CChartEnvSetupDlgAddInApp theApp;

int CChartEnvSetupDlgAddInApp::ExitInstance() 
{
	// TODO: Add your specialized code here and/or call the base class
	
	// (2006/8/20 - Seung-Won, Bae) Release Static StyleData
	CStyleDataManager::RemoveAll();
...
//_CHART_ADDIN_IVERSION( 915914)
//#elif defined _ADDIN_DB
//_CHART_ADDIN_IVERSION( 425914)
//#elif defined _ADDIN_KC
_CHART_ADDIN_IVERSION( 135914)
//#elif defined _ADDIN_SS
//_CHART_ADDIN_IVERSION( 995914)
//#else
...
ADDIN_API IChartAddIn *InitAddInDll( const char *p_szAddInItem, IAddInManager *p_pIAddInManager, IAddInDllBase *p_pIAddInDllBase)
{
	...
	GET_ADDIN_OBJECT( CChartEnvSetupDlgAddInImp);
	GET_ADDIN_OBJECT( CChartStyleDataManagerAddInImp);
