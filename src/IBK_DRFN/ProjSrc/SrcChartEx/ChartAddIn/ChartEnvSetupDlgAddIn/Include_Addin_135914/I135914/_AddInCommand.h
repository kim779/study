...
typedef enum EAICommandType
{
	...
	//>>20100120_JS.Kim	상한가/하한가 정보표시
	EAI_CUSTOM_ENABLE_LOWHIGHMARK,
	//		OnAddInToolCommand(	const EAICommandType p_eCommandID, const long p_lParam)
	//			p_lParam	: LowHighMark Enable Flag
	
	EAI_CUSTOM_GET_LOWHIGHMARK_FLAG,
	//		OnAddInToolCommand(	long &p_lResult, const EAICommandType p_eCommandID)
	//			p_lResult	: LowHighMark Flag
	
	EAI_CUSTOM_GET_EXISTENCE_LOWHIGHMARK,
	//		OnAddInToolCommand(	long &p_lResult, const EAICommandType p_eCommandID)
	//			p_lResult	: LowHighMark Existence
	//<<
};
