...
#define	STOCK_SISE_PID			50		// 주식 실시간 시세 데이터
#define	STOCK_HOGA_PID			51		// 주식 실시간 종목호가 데이터
#define	UPJONG_SISE_PID			49		// 업종 실시간 시세 데이터
#define	FUTURE_SISE_PID			65		// 선물 실시간 시세 데이터
#define	OPTION_SISE_PID			67		// 옵션 실시간 시세 데이터
