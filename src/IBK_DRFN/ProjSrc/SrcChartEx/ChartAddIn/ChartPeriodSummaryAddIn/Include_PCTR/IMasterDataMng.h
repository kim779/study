...
DECLARE_INTERFACE(IMasterDataManager)
{
//$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
//	STDMETHOD_(CMaster_J_K*, J_K_SortByCode)() PURE;
	...
	// 그룹사 마스터데이터 구하기
	STDMETHOD_(BOOL, GetGroupMst)(CStringArray *&pastrCode, CStringArray *&pastrName) PURE;
	STDMETHOD_(BOOL, GetKRXUpMst)(CStringArray *&pastrJongCode, CStringArray *&pastrJongName, CStringArray *&pastrJongEngName) PURE;
