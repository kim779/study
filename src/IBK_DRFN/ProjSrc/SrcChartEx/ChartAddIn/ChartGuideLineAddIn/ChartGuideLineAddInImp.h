...
#include "./include_Addin/I133721/_AddInCommand.h"		// for DECLARE_ADDIN_EVENT_MAP()
#include <iostream>
...
protected:
	static CTypedPtrMap< CMapPtrToPtr, CChartGuideLineAddInImp *, HWND> m_mapGuideLines;
protected:
	void	OnChangeGuideLineSetting( BOOL p_bWithMAPeriodChange);

// (2008/10/26 - Seung-Won, Bae) for O/H/L/C (not LH/LC/HC)
protected:
	void			GetShowOHLC( BOOL &bDrawOHLC, COLORREF &clrUp, COLORREF &clrDown, const char *p_szRQ);
