...
//////////////////////////////////////////////////////////////////////////////////
public:
	BOOL	m_bEditSelected;
	
public:

	void	SetEditSelected(BOOL bEditSelected){ m_bEditSelected = bEditSelected; }
	BOOL	GetEditSelected(){ return m_bEditSelected;	}

public:
	LRESULT SendEndEditDataToParent(int nRow, int nCol, CString strData) const;
