...
#include "ChartDataSimulatorAddInImp.h"				// for CDataSimulatorAddInImp 20081011 이문수 데이터시뮬레이션 >>
...
ADDIN_API IChartAddIn *InitAddInDll( const char *p_szAddInItem, IAddInManager *p_pIAddInManager, IAddInDllBase *p_pIAddInDllBase)
{
	...
	GET_ADDIN_OBJECT( CChartDataSimulatorAddInImp);		//20081011 이문수 데이터시뮬레이션 >>
