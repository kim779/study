#if !defined(AFX_CMGRID_H__06DB84E6_C6EF_4667_8F76_878EE13E13C9__INCLUDED_)
#define AFX_CMGRID_H__06DB84E6_C6EF_4667_8F76_878EE13E13C9__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// CMGrid.h : header file
//
...
#define TYPE_GRID_COMMON    0
#define TYPE_GRID_ORDER     1

/////////////////////////////////////////////////////////////////////////////
// CCMGrid frame
class CDrSplitterCtrl;    //# Common Control
class CGridCommonView;
class CGridOrderView;
class AFX_EXT_CLASS CCMGrid : public CFrameWnd
{
public:
	CCMGrid();
	virtual ~CCMGrid();
...
public:
	void SetInit(int nType = TYPE_GRID_ORDER, BOOL bFocus = TRUE);		//# 초기화

	void SetSelectGroup(int nGroupNo, BOOL bMsgSend = TRUE);
	void SetAddGroup(BOOL bGroupForcus = FALSE);					//# 그룹 추가
	...
	BOOL GetDetailViewState() { return m_bDetail; };

	//# Grid Setting Function ####################
	void SetGridType(int nType);   //# TYPE_GRID_COMMON, TYPE_GRID_ORDER
...
#endif // !defined(AFX_CMGRID_H__06DB84E6_C6EF_4667_8F76_878EE13E13C9__INCLUDED_)
