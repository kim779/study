...
public:
	...
	//	배열 형식의 블럭일 경우 Grid Symbol 값.
	CString			m_strGridSym;
	//	그리드심볼과 일/주/월/분의 구분값이 틀릴경우 사용하는 그리드심볼.
	CString			m_strDiffGridSym;
...
public:
	...
	CFidItem*	GetItemNameAt(CString strID, CString strPrefix);
	//>>
