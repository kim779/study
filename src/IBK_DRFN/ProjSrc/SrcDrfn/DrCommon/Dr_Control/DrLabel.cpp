...
BEGIN_MESSAGE_MAP(CDrLabel, CStatic)
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CDrLabel::ReconstructFont
//
...
void CDrLabel::OnPaint() 
{
	...
	if (m_nAlignType == 0)
		...
		dwFlags = DT_CENTER | DT_VCENTER | DT_SINGLELINE;
	else if (m_nAlignType == 2)
		dwFlags = DT_RIGHT | DT_VCENTER | DT_SINGLELINE;
	else
		dwFlags = DT_LEFT | DT_VCENTER |DT_SINGLELINE;
...
//
//////////////////////////////////////////////////////////////////////////
void CDrLabel::OnTimer(UINT nIDEvent) 
{
...
//
//////////////////////////////////////////////////////////////////////////
BOOL CDrLabel::OnSetCursor(CWnd* pWnd, UINT nHitTest, UINT message) 
{
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CDrLabel::OnLButtonDown
//
...
//////////////////////////////////////////////////////////////////////////
void CDrLabel::OnLButtonDown(UINT nFlags, CPoint point) 
{
...
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetText(const CString& strText)
{
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CDrLabel::SetTextColor
//
...
//
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetTextColor(COLORREF crText)
{
...
//
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetFontBold(BOOL bBold)
{
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CDrLabel::SetFontUnderline
//
...
//
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetFontUnderline(BOOL bSet)
{	
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CDrLabel::SetFontItalic
//
...
//
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetFontItalic(BOOL bSet)
{
...
//
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetSunken(BOOL bSet)
{
...
//
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetBorder(BOOL bSet)
{
...
//
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetFontSize(int nSize)
{
	CFont cf;
	LOGFONT lf;
...
//
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetBkColor(COLORREF crBkgnd, COLORREF crBkgndHigh , BackFillMode mode)
{
...
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetFontName(const CString& strFont, BYTE byCharSet /* Default = ANSI_CHARSET */)
{	
...
//
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::FlashText(BOOL bActivate)
{
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CDrLabel::FlashBackground
//
// Description:		As the function states
//
// INPUTS:          True or false
...
//
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::FlashBackground(BOOL bActivate)
{
...
//
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetLink(BOOL bLink,BOOL bNotifyParent)
{
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CDrLabel::SetLinkCursor
//
...
//
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetLinkCursor(HCURSOR hCursor)
{
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CDrLabel::SetTransparent
//
...
//
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetTransparent(BOOL bSet)
{
...
//
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetFont3D(BOOL bSet,Type3D type)
{
...
void CDrLabel::OnSysColorChange() 
{
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CDrLabel::SetRotationAngle
//
...
//
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetRotationAngle(UINT nAngle,BOOL bRotation)
{
	// Arrrrh...
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CDrLabel::SetText3DHiliteColor
//
...
//
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetText3DHiliteColor(COLORREF cr3DHiliteColor)
{
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CDrLabel::PreSubclassWindow
//
...
//////////////////////////////////////////////////////////////////////////
void CDrLabel::PreSubclassWindow() 
{
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CDrLabel::PreCreateWindow
//
// Description:		
//
// INPUTS:          
...
// NT ALMOND				15092000    1.5     Origin
//////////////////////////////////////////////////////////////////////////
BOOL CDrLabel::PreCreateWindow(CREATESTRUCT& cs) 
{	
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CDrLabel::DrawGradientFill
//
...
// NT ALMOND				15092000    1.5     Origin
//////////////////////////////////////////////////////////////////////////
void CDrLabel::DrawGradientFill(CDC* pDC, CRect* pRect, COLORREF crStart, COLORREF crEnd, int nSegments)
{
...
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetFont(LOGFONT lf)
{
...
BOOL CDrLabel::OnEraseBkgnd(CDC* pDC) 
{
...
// NT ALMOND				02072002    1.6     Origin
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetMailLink(BOOL bEnable, BOOL bNotifyParent)
{
	if (bEnable)
		m_Link = MailLink;
	else
...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CDrLabel::SetHyperLink
//
...
// NT ALMOND				02072002    1.6     Origin
//////////////////////////////////////////////////////////////////////////
CDrLabel& CDrLabel::SetHyperLink(const CString& sLink)
{
	m_sLink = sLink;
...
CDrLabel& CDrLabel::SetAlign(AlignType AlignTypes)
{

//	if (nAlignType == _LEFT)
//		ModifyStyle(0,SS_LEFT);
//	else if (nAlignType = CENTER)
//		ModifyStyle(0,SS_CENTER);
//	else if (nAlignType = RIGHT)
//		ModifyStyle(0,SS_RIGHT);
//	else
//		ModifyStyle(0,SS_LEFT);

	m_nAlignType = AlignTypes;
