...
public:
  ...
  void DrawSign(CDC *dc, RECT *rect, int nSign);
  BOOL DrewSign_Max(CDC *pDC, RECT *pRect);
  BOOL DrewSign_Up(CDC *pDC, RECT *pRect);
  BOOL DrewSign_Min(CDC *pDC, RECT *pRect);
  BOOL DrewSign_Down(CDC *pDC, RECT *pRect);
  BOOL DrewSign_Steady(CDC *dc, RECT *rc);

  void DrawCandle(CDC *dc, RECT *rect, CString strCandleData);
  void DrawLHCandle(CDC *dc, RECT *rect, CString strCandleData);
};