...
/***************************************************
****************************************************/
int CPrint4Grid::ClearPrintList(){
...
/***************************************************
****************************************************/
int	CPrint4Grid::AddPageToList(int page,int startCol,int endCol,long startRow,long endRow){
...
/***************************************************
****************************************************/
int	CPrint4Grid::GetPageFromList(int page,int *startCol,int *endCol,long *startRow,long *endRow){
...
/***************************************************
****************************************************/
int CPrint4Grid::PrintInit(CDC * pDC, CPrintDialog* pPD, int startCol,long startRow,
...
/***************************************************
****************************************************/
int CPrint4Grid::PrintPage(CDC * pDC, int pageNum){
	...
	for(y = yy; y <= endRow ; y++){
		...
		if(y < 0 ){
			...
			cellrect.bottom+= (int)(m_ctrl->GetTHRowHeight(y) * m_printVScale);
...
/***************************************************
****************************************************/
int CPrint4Grid::PrintSetMargin(int whichMargin,int size){
	return UG_SUCCESS;
}
/***************************************************
****************************************************/
int CPrint4Grid::PrintSetScale(double scale){
	return UG_SUCCESS;
}
/***************************************************
****************************************************/
int CPrint4Grid::PrintSetOption(int option,long param){
...
/***************************************************
****************************************************/
int CPrint4Grid::PrintGetOption(int option,long *param){
...
/***************************************************
****************************************************/
void CPrint4Grid::InternPrintCell(CDC *dc,RECT * rect,int col,long row){
	...
	//paint the cell
	CPen * pOldPen = cell.GetBorderColor();
	if(m_ctrl->m_pBorderPen4Print)
		cell.SetBorderColor(m_ctrl->m_pBorderPen4Print);
	
	int nOldStyle = cell.GetBorder();
	if(m_ctrl->GetBorderStyle4Print())	
		cell.SetBorder(m_ctrl->GetBorderStyle4Print());	
	...
	cell.SetBorderColor(pOldPen);
	cell.SetBorder(nOldStyle);
}
