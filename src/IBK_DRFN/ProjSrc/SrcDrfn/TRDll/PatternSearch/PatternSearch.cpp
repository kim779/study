// PatternSearch.cpp : Defines the initialization routines for the DLL.
//
...
BEGIN_MESSAGE_MAP(CPatternSearchApp, CWinApp)
...
CPatternSearchApp::CPatternSearchApp()
{
}

CPatternSearchApp theApp;
...
BOOL CPatternSearchApp::InitInstance()
{
...
extern "C" __declspec(dllexport) CWnd* WINAPI axCreate(CWnd *parent)
{
	...
	if(pWnd->Create(NULL, "PATTERNSEARCH", WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS, CRect(0, 0, 0, 0), parent, 100) == FALSE)
		return NULL;
