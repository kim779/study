...
//유진
#define COLOR_MAIN_CANVAS		RGB(247,248,252)
//#define COLOR_MAIN_CANVAS		RGB(233, 232, 244)
...
#define IDB_SET_UP            FOLDER_IMG + "설정_on.bmp"
#define IDB_SET_DOWN          FOLDER_IMG + "설정_down.bmp"
#define IDB_SET_DIS           FOLDER_IMG + "설정_dis.bmp"	

#define IDB_ERASER_UP         FOLDER_IMG + "지움_on.bmp"
#define IDB_ERASER_DOWN       FOLDER_IMG + "지움_down.bmp"
#define IDB_ERASER_DIS        FOLDER_IMG + "지움_dis.bmp"	
