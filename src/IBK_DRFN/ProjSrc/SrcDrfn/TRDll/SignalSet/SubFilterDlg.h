...
public:
	...
	CSubFilterDlg(CWnd* pParent, CRect rePos, CString strType, 
		CList <SubFilterInfo, SubFilterInfo&>	*plistSubFilterInfo, CWnd* pMainFrmWnd);   // standard constructor
