...
/*  7. 출력항목   :                                                                  */
/*************************************************************************************/
#ifndef __EU_TRAN_EU_p0623_H__
#define __EU_TRAN_EU_p0623_H__
...
typedef struct
{
    ...
    char    giConditionCnt[4];                    /* 검색조건수(4)                   */
    char    gsRankGubun[50];                      /* 순위bitset(50)                  */
}EU_p0623_InRec1;
...
typedef struct
{
    char    giCallIndex[4];                       /* 클라이언트조회구분(4)           */
    char    giConditionCnt[4];                    /* 검색조건수(4)                   */
    char    gsCondiBitSet[50];                    /* 검색조건BitSet(50)              */
}EU_p0623_OutRec1;
