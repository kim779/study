...
/*  7. 출력항목   :                                                                  */
/*************************************************************************************/
#ifndef __EU_TRAN_EU_p0622_H__
#define __EU_TRAN_EU_p0622_H__
...
//     char    gsJongmokIndex[2500];                 /* 종목코드Bitset(2500)            */
...
typedef struct
{
    char    giCallIndex[1];                       /* 클라이언트조회구분(1)           */
