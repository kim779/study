...
const		int				Head_Width_FieldEditSource[] = { 142, 142, 0, 0 };
...
CGrid_Comm::CGrid_Comm(CWnd* pwndParent, CString strType, COLORREF	clrHeader)
{
	LOGFONT	  logFont;
...
void CGrid_Comm::HeaderSetup(int &nColCnt)
{
	ClearAll();
...
void CGrid_Comm::SetCellData(int nRow, int nCol, CString strData)
{
...
void CGrid_Comm::OnLClicked(int col, long row, int updn, RECT *rect, POINT *point, BOOL processed)
{
	if (( row != -1 && col != -1) && (updn == 1))
	{
		if (m_strType == "FieldEditSource")
			...
			OnCellChange(-1, m_nSelectRow, -1, row);
...
void CGrid_Comm::OnCellChange(long oldCol, long oldRow,
...
void CGrid_Comm::SetSelRow(int nRow)
{
	OnRowChange(m_nSelectRow, nRow);
}

void CGrid_Comm::SetData_MatchValSource(int nRow, CString strElement, int nFieldIndex, 
...
void CGrid_Comm::SetData_MatchValSource(int nRow, BOOL bUser)
{
	CUGCell cell;
...
BOOL CGrid_Comm::GetData_MatchValSource(int nRow, MatchInfo	&stMatchInfo)
{
	BOOL bResult = TRUE;
...
void CGrid_Comm::SetData_MatchValDest(int nRow, MatchInfo	stMatchInfo, BOOL bInvalidate)
{
	CUGCell cell;
	COLORREF clrBk;
	CString strTemp;
...
void CGrid_Comm::GetData_MatchValDest(int nRow, MatchInfo	&stMatchInfo)
{
...
void CGrid_Comm::SetData_QuickMakeDest(int nRow, QuickList stQuickList, BOOL bInvalidate)
{
	COLORREF clrBk;
	GetEvenOddBkColor(nRow, clrBk);
...
void CGrid_Comm::GetData_QuickMakeDest(int nRow, QuickList &stQuickList)
{
...
void CGrid_Comm::SetData_QuickMakeSource(int nRow, XMLTreeInfoFile stXMLTreeInfoFile, BOOL bInvalidate)
{
	CUGCell cell;
	COLORREF clrBk;
	GetEvenOddBkColor(nRow, clrBk);
...
void CGrid_Comm::GetData_QuickMakeSource(int nRow, XMLTreeInfoFile &stXMLTreeInfoFile)
{
...
void CGrid_Comm::SetData_Folder(int nRow, InfoFolder stInfoFolder, BOOL bInvalidate)
{
	CString strTemp;
...
BOOL CGrid_Comm::GetData_Folder(int nRow, InfoFolder &stInfoFolder)
{
...
void CGrid_Comm::SetData_File(int nRow, XMLTreeInfoFile	stXMLTreeInfoFile, BOOL bInvalidate)
{
	CUGCell cell;
	COLORREF clrBk;
	GetEvenOddBkColor(nRow, clrBk);
...
void CGrid_Comm::GetData_File(int nRow, XMLTreeInfoFile	&stXMLTreeInfoFile)
{
	CUGCell cell;
...
void CGrid_Comm::SetData_FieldEditSource(int nCol, int nRow, CStringArray *psaData, BOOL bInvalidate)
{
...
void CGrid_Comm::GetData_FieldEditSource(int nCol, int nRow, CStringArray &saData)
{
	saData.RemoveAll();
...
void CGrid_Comm::SetData_FieldEditDest(int nRow, CStringArray *psaData, BOOL bInvalidate)
{
	//# Name / Id / Index
...
void CGrid_Comm::GetData_FieldEditDest(int nRow, CStringArray &saData)
{
	saData.RemoveAll();
...
CString CGrid_Comm::GetCellData(int nRow, int nCol)
{
	...
	{
		strReault = cell.GetLabelText();
		if(strReault.GetLength()>0)
			return strReault;
...
void CGrid_Comm::SetColor_EvenOdd()
{
	CUGCell cell;
	COLORREF clrBk;
