...
private:
	...
	char m_cGubun;
	CStringArray	m_saCode_Target;
	CStringArray	m_saAccNo;
	ACCOUNT			m_accn;			// ³» °èÁÂ¸ñ·Ï hold
...
public:
	...
	void		setAccount();
	void		SendTr_AccountInfo(CString strAccNo);
...
private:
	...
	void		RevData_AccountInfo(char* buf, int len);
	void		SetDataStockAccount(char* buf);
