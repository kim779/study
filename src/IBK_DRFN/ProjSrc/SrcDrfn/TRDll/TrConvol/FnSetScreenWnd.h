...
private:
	...
	BOOL		m_bLoadLocalDataFileVersion;
	BOOL		m_bLoadSvrDataFileVersion;

	CString		m_strLocalFindDataVer;
...
public:
	...
	void		OpenScreen(CString strScreenNo, CStringArray* pSaCode, CString strOtherData);
