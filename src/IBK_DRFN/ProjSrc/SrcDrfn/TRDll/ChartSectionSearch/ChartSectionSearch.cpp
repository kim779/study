// ChartSectionSearch.cpp : Defines the initialization routines for the DLL.
//
...
BEGIN_MESSAGE_MAP(CChartSectionSearchApp, CWinApp)
...
CChartSectionSearchApp::CChartSectionSearchApp()
{
}

CChartSectionSearchApp theApp;
...
BOOL CChartSectionSearchApp::InitInstance()
{
...
extern "C" __declspec(dllexport) CWnd* WINAPI axCreate(CWnd *parent)
{
	...
	if(pWnd->Create(NULL, "CHARTSECTIONSEARCH", WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS, CRect(0, 0, 0, 0), parent, 100) == FALSE)
		return NULL;
