...
#define FIXFIELD_USER_CHART_SECTION_FILE	"fixfield_User_section.xml"

#define PATTERNINFO_INIFILE					"PatternInfo.ini"
#define CANDLEINFO_INIFILE					"CandleInfo.ini"

#define FINDERINFO_INIFILE					"FindInfo.ini"
#define FOLDER_FINDDATA						"\\FindData"

#define MIN_DATA_CHART						1		// 분	차트
#define DAY_DATA_CHART						2		// 일	차트
#define WEEK_DATA_CHART						3	   // 주	차트
#define MONTH_DATA_CHART					4		// 월	차트

#define CENTER_CHART						0
#define RESULT_CHART						1
...
#define INT2STR_BUF(pBuff, nSize, strData, strBuff)	\
	strBuff.Format("%*ld", nSize, strData);			\
	memcpy(pBuff, strBuff, strBuff.GetLength());
...
const UINT			MENU_RESULTCTRL_INDEX[] =		 { 11010, 11020, 11040, 11050, 11055};
...
#define SCREEN_INDEX_RUSULTPRINT	MENU_RESULTCTRL_INDEX[5]
...
#define ID_MENU_CONDITIONSAVE_START	20001
#define ID_MENU_CONDITIONSAVE_END	21000
...
typedef struct stChartSectionInfo
{
	CString			strName;
	BOOL			bType;
	CString			strCode;
	CString			strChartDate;
	CString			strStartDate;
	CString			strEndDate;
	CStringArray	arrDrawData;
} CHARTSECTIONINFO;

typedef CArray<CHARTSECTIONINFO*, CHARTSECTIONINFO*>	ArrChartSectionInfo;
