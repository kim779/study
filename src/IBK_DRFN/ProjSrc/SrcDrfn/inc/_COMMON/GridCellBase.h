...
#define	GVIS_STATIC				0x1000
#define	GVIS_STATIC_NOREDRAW	0x2000
...
public:
    ...
    virtual void SetGrid(CExGridCtrl* /* pGrid */)            = 0 ;
    ...
    virtual CExGridCtrl* GetGrid()       const                = 0 ;
...
public:
	...
	virtual void GetDrawTextRect(CDC* pDC, CRect rect, CString text, int nLen, int& left, int& top); // 20050322 
