...
public:
	...
	virtual long FP_nGetCtrlPos() {return 0;}

	// 컨트롤을 리사이즈 시킨다.
	virtual void FP_vResizeCtrl() {return;}

// {{ OCX에서 DESK로 메세지 보낼 수 있도록 요청(2003.12.3)
	virtual void SetMapMessage(long lType, LPCSTR lpData) {return;};
// }}
