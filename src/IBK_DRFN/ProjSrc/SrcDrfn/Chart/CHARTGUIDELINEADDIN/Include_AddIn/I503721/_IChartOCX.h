...
#include "../../Include_Chart/BlockBaseEnum.h"		// for CToolOptionInfo::TOOLOPTION
...
public:	// SetAllHorzScaleGridType & SetAllVertScaleGridType
	virtual	BOOL		SetAllHorzScaleGridType(		int			p_nGridHLineType,	BOOL p_bWithUpdate = FALSE)	= 0;
	virtual	BOOL		SetAllVertScaleGridType(		int			p_nGridVLineType,	BOOL p_bWithUpdate = FALSE)	= 0;
