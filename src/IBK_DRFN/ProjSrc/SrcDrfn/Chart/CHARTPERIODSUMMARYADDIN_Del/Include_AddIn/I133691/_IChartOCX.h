...
public:
	...
	virtual CMChartInterface *	GetMChartInterface( void)	= 0;
...
public:
	...
	virtual BOOL			GetRedrawAfterUpdatedAllPacketFlag( void) = 0;
...
public:
	...
	virtual int		GetRightMargin( void) = 0;
	virtual BOOL	SetRightMargin( const int p_nCount) = 0;
...
public:
	virtual	BOOL		AddChartBlock( const char *p_szIndicatorName) = 0;
...
public:	// Get
	...
	virtual	int			GetStyleValueGridHLineType(		void) = 0;
	virtual	int			GetStyleValueGridVLineType(		void) = 0;
...
public:	// SetAllHorzScaleGridType
	virtual	BOOL		SetStyleValueGridHLineType(		int			p_nGridHLineType,	BOOL p_bWithUpdate = FALSE)	= 0;
public:	// SetAllVertScaleGridType
	virtual	BOOL		SetStyleValueGridVLineType(		int			p_nGridVLineType,	BOOL p_bWithUpdate = FALSE)	= 0;
