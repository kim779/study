...
{
	//@SolomonGNF m_pITrCommManager = (IAUTrCommManager*)AfxGetPctrInterface(UUID_IAUTrCommManager, 3);
...
HRESULT CConfirmWnd::ReceiveData(long dwKey, LPCSTR szTR, LPCSTR szMsgCode, LPCSTR szMessage, LPVOID aTRData, long dwTRDateLen)
{
	...
	//@SolomonGNF IDataUtilManager* pUtilMng = (IDataUtilManager*)AfxGetPctrInterface(UUID_IDataUtilManager, 3);
