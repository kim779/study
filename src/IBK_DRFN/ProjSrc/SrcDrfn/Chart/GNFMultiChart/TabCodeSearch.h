...
// --> [Edit]  강지원 2008/08/06
	...
	void	SetCurListIndex(int nIndex);
	int		GetCurListIndex();
// <-- [Edit]  강지원 2008/08/06
// --> [Edit]  이도영 2008/09/23
// 
...
//		codesearch_stock_sel_gwan=0,		//관심
		codesearch_stock_sel_master_stock=0,	//주식
		codesearch_stock_sel_master_elw,	//elw
		codesearch_stock_sel_oneclick,		//빠른종목검색
//		codesearch_stock_sel_user, 
		codesearch_stock_sel_imsi,			//사용자종목검색

//		codesearch_upjong_sel_gwan=0,			//관심
		codesearch_upjong_sel_master_jisu=0,		//업종
//		codesearch_upjong_sel_oneclick,		//빠른종목검색
////		codesearch_upjong_sel_user, 
//		codesearch_upjong_sel_imsi,			//사용자종목검색

//		codesearch_future_sel_gwan=0,			//관심
		codesearch_future_sel_master_future=0,	//선옵
//		codesearch_future_sel_oneclick,		//빠른종목검색
////		codesearch_future_sel_user, 
//		codesearch_future_sel_imsi			//사용자종목검색
	};
...
//	CTrTreeCtrl*	m_pUserFindTree;		// 사용자종목검색처리를 하는 CTreeCtrl
...
//@유진삭제 CImageList		m_ImageOutbarIcon;
	//20061213 수정 end
...
//@유진삭제
//	afx_msg void OnSelchangeColumnType();
//@유진삭제
	afx_msg void OnBtnRetry();
	afx_msg void OnBtnAddapply();
//@유진삭제
//	afx_msg void OnBtgridExtend();
//@유진삭제
	//}}AFX_MSG
...
//@유진삭제
//	afx_msg void OnBtnColumnExtend();
//@유진삭제
	afx_msg long OnOutBarNotify(WPARAM wParam, LPARAM lParam);
	// 복수종목 UI추가 : 복수종목 - ojtaso (20070522)
//@유진삭제
//	CExComboBox m_cmbMultiItem;
//@유진삭제
};
