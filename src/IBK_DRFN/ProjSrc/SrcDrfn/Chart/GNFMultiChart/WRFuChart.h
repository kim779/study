#if !defined(AFX_WRFUCHART_H__78393149_A4E3_4CE8_9EB8_A39F6BF0FC78__INCLUDED_)
#define AFX_WRFUCHART_H__78393149_A4E3_4CE8_9EB8_A39F6BF0FC78__INCLUDED_
...
/////////////////////////////////////////////////////////////////////////////
// CWRFuChart wrapper class

#include <afxconv.h>

class CWRFuChart : public CWnd
{
protected:
	DECLARE_DYNCREATE(CWRFuChart)
public:
...
public:
	typedef enum {
		...
		IIx_BUseGapRevision,			// (2008/11/3 - Seung-Won, Bae) for Gap Revision Info.
		...
		IIx_SetItemInfo,
		IIx_NFullDataCount,		// (2008/11/3 - Seung-Won, Bae) Support m_nFullDataCount to MultiChart.
// --> [Edit]  강지원 2008/11/06
		IIx_RemoveBlockWithIndex,
//		IIx_LockWindowUpdate,
//		IIx_UnlockWindowUpdate,
...
public:
	...
	BOOL GetBUseGapRevision();		// (2008/11/3 - Seung-Won, Bae) for Gap Revision Info.
...
#endif // !defined(AFX_WRFUCHART_H__78393149_A4E3_4CE8_9EB8_A39F6BF0FC78__INCLUDED_)
