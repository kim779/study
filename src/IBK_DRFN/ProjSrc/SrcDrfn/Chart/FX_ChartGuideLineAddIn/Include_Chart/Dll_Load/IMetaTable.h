...
#define ML_LANGUAGE_RES						g_iMetaTable.LoadResourceDLL( m_hOcxWnd, AfxGetStaticModuleState()->m_hCurrentInstanceHandle)
#define ML_DEFAULT_RES						AfxGetStaticModuleState()->m_hCurrentInstanceHandle
...
public:
	...
	enum EDDC_INDICATOR_ID
	{
		...
		EDDC_ST_WILLIAMCHART,				// %R// ,	//// William's %R
		...
		EDDC_OCX_VOLUMESELLBYCHART,		//매수매도대기매물
...
friend class CKoscomChartCtrl;
friend class CKoscomChartApp;
public:
