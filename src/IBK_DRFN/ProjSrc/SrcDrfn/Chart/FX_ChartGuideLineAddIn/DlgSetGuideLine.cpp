...
//			OutputDebugString(sTTT);
			...
			{				
				...
				case 64: { m_clConfigSet.m_nLineTHprice		= nValue;	m_cmbTHprice		.SetCurSel((const)nValue - 1);  } break;	//당일가격 고가				라인 크기//20100329_JS.Kim 버그수정
				case 65: { m_clConfigSet.m_nLineTLprice		= nValue;	m_cmbTLprice		.SetCurSel((const)nValue - 1);  } break;	//당일가격 저가				라인 크기//20100329_JS.Kim 버그수정
				case 66: { m_clConfigSet.m_nLineTEprice		= nValue;	m_cmbTEprice		.SetCurSel((const)nValue - 1);  } break;	//당일가격 종가				라인 크기//20100329_JS.Kim 버그수정
