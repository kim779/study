...
//////////////////////////////////////////////////////////////////////
void CIWAddInToolMgr::OnUpdatePacketData( BOOL p_bTrUpdate)
{
	if( m_pAddInManager)
	{
		if( p_bTrUpdate)	m_pAddInManager->OnPacketData( NULL, FALSE);
		else				m_pAddInManager->OnManualRealData( NULL, 0, 0);
	}
}
