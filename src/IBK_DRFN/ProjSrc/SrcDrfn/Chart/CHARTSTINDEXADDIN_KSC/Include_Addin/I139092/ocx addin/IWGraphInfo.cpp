...
void CIWGraphInfo::GetGraphDataDrawingData( BOOL &p_bLowHigh, BOOL &p_bLowCur, BOOL &p_bHighCur, BOOL &p_bPrevCur, int &p_nCurData)
{
	...
	if( m_pIndicatorInfo) m_pIndicatorInfo->GetGraphDataDrawingData( bLowHigh, bLowCur, bHighCur, bPrevCur, p_nCurData);
	p_bLowHigh	= bLowHigh;
	p_bLowCur	= bLowCur;
	p_bHighCur	= bHighCur;
	p_bPrevCur	= bPrevCur;
...
void CIWGraphInfo::SetGraphDataDrawingData( BOOL p_bLowHigh, BOOL p_bLowCur, BOOL p_bHighCur, BOOL p_bPrevCur, int p_nCurData)
{
	if( m_pIndicatorInfo)
	{
		CGraphDataDrawingData graphDataDrawingData( p_bLowHigh ? true : false, p_bLowCur ? true : false, p_bHighCur ? true : false, p_bPrevCur ? true : false, p_nCurData);
