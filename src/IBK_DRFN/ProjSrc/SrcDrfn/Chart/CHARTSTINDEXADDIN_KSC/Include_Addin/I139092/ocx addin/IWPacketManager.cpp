...
{
	if( !m_pPacketList) return FALSE;
	return m_pPacketList->SetRealData( ( ( CIWPacket *)p_pIPacket)->GetPacketPtr(), p_dData, p_nRemovePacketDataCount);
}
...
{
	if( !m_pPacketList) return FALSE;
	return m_pPacketList->SetRealData( ( ( CIWPacket *)p_pIPacket)->GetPacketPtr(), p_szField, p_szKey, p_dData, p_nRemovePacketDataCount);
}
