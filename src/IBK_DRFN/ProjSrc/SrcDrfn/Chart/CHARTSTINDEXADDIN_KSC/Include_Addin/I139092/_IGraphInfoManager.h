...
public:
	virtual IGraphInfo *		GetGraphInfo( IEGraphInfoListType p_eGraphInfoType, const char *p_szGraphName) = 0;
...
public:
	...
	virtual IStringList *	GetAllGraphTypeStyleNameList( const char *p_szGraphTypeName) = 0;
	virtual IStringList *	GetAllGraphDrawStyleNameList( const char *p_szGraphTypeName) = 0;
