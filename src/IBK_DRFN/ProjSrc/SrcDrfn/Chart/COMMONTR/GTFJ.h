///////////////////////////////////////////////////////////////////////////////////////////////////
// 상품선물 ( GTFJ,attr,key=10,keycnt=2000,bufcnt=5,group=1 )
#pragma pack( push, 1 )

#define NAME_GTFJ     "GTFJ"

// 입력
typedef struct _GTFJ_InBlock
{
    char    symbol              [  10];    char    _symbol              ;    // [string,   10] KEY심볼코드
} GTFJ_InBlock, *LPGTFJ_InBlock;
#define NAME_GTFJ_InBlock     "InBlock"

// 출력
typedef struct _GTFJ_OutBlock
{
    char    symbol              [  10];    char    _symbol              ;    // [string,   10] KEY심볼코드
...
} GTFJ_OutBlock, *LPGTFJ_OutBlock;
#define NAME_GTFJ_OutBlock     "OutBlock"
