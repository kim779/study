...
/*  7. 출력항목   :                                                                  */
/*************************************************************************************/
#ifndef __KB_TRAN_KB_f3201_H__
#define __KB_TRAN_KB_f3201_H__
...
typedef struct _KB_f3201_OutRec1 {
	char		optcode[8];		/*  단축코드     */
	char		recprice[7];		/*  기준가격     */
	char		hprice[7];		/*  상한가     */
	char		lprice[7];		/*  하한가     */
...
public:
	...
	virtual void  Convert(KB_f3201_OutRec1* pInput)
	{
		CString sTemp1 ;
		char sTmp[50+1];
