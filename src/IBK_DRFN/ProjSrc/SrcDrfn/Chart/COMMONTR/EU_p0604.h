...
/*  7. 출력항목   :                                                                  */
/*************************************************************************************/
#ifndef __EU_TRAN_EU_p0604_H__
#define __EU_TRAN_EU_p0604_H__
...
typedef struct
{
    ...
    char    low[10];                              /* 저가(10)                        */
    char    close[10];                            /* 종가(10)                        */
}EU_p0604_OutRec2_COMP;

/* Chart Data:																		 */
typedef struct _EU_p0604_CHART
{
	char    fcnt[5];         			/* 차트카운트(5)                   */
	char    bojomsg[400];				/* 보조메시지(400)                 */
	//EU_p0604_OutRec2  chart[50000];
	EU_p0604_OutRec2  chart[1];						// 동적크기임.
} EU_p0604_CHART;

typedef struct _EU_p0604_CHART_COMP
{
	char    fcnt[5];         			/* 차트카운트(5)                   */
	char    bojomsg[400];				/* 보조메시지(400)                 */
	//EU_p0604_OutRec2_COMP  chart[50000];
	EU_p0604_OutRec2_COMP  chart[1];
} EU_p0604_CHART_COMP;
