...
/*  7. 출력항목   :                                                                  */
/*************************************************************************************/
#ifndef __EU_TRAN_EU_s3301_H__
#define __EU_TRAN_EU_s3301_H__
...
typedef struct _EU_s3301_OutRec1 {
	char		futcode[8];		/*  단축코드     */
	char		recprice[7];		/*  기준가격     */
	char		uplmtprice[7];		/*  상한가     */
	char		dnlmtprice[7];		/*  하한가     */
...
public:
	...
	virtual void  Convert(EU_s3301_OutRec1* pInput)
	{
		CString sTemp1 ;
		char sTmp[50+1];
