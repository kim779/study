...
/////////////////////////////////////////////////////////////////////////////
// GridCellBase
#define GRID_COLOR_HIGHLIGHT	RGB(200,255,230)
...
BOOL CGridCellBase::Draw(CDC* pDC, int nRow, int nCol, CRect rect,  BOOL bEraseBkgnd /*=TRUE*/)
{
    ...
    if ( IsFocused() || IsDropHighlighted() )
    {
        ...
        {
            TextBkClr = GRID_COLOR_HIGHLIGHT;//::GetSysColor(COLOR_HIGHLIGHT);
            TextClr = GetTextClr();//::GetSysColor(COLOR_HIGHLIGHTTEXT);
            bEraseBkgnd = TRUE;
        }
...
//            END_CATCH
    ...
    {
        rect.right++; rect.bottom++;    // FillRect doesn't draw RHS or bottom
        pDC->FillSolidRect(rect, GRID_COLOR_HIGHLIGHT/*::GetSysColor(COLOR_HIGHLIGHT)*/);
	...
	{
		pDC->Draw3dRect(rect.left-1 , rect.top, rect.Width()+2, rect.Height(), RGB(204,210,224), RGB(204,210,224));
	}        
