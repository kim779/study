...
public:
	...
	void	InsertCodeData(LPCTSTR lpCode, LPCTSTR lpName,CString strPrice,CString strChange,CString strChgrate,CString strExtCode, char chSign, int nMarketGubun=1);//,BOOL bKeeping = FALSE);
	BOOL	UpdateCodeData(LPCTSTR lpCode, LPCTSTR lpName,CString strPrice,CString strChange,CString strChgrate,CString strExtCode,char chSign, int nIndex);
	...
	void	GetCodeData(int nIndexIn, CString& rstrPriceOut,CString & rstrChangeOut,CString & rstrChgrateOut,CString & rstrExtCodeOut,char& rchSign);
