...
// if CXListCtrl2 is created via Create() instead of via dialog template.
//
...
UINT NEAR WM_XLISTCTRL2_COMBO_SELECTION  = ::RegisterWindowMessage(_T("WM_XLISTCTRL_COMBO_SELECTION"));
UINT NEAR WM_XLISTCTRL2_CHECKBOX_CLICKED = ::RegisterWindowMessage(_T("WM_XLISTCTRL_CHECKBOX_CLICKED"));
UINT NEAR WM_XLISTCTRL2_EDIT_RETURN = ::RegisterWindowMessage(_T("WM_XLISTCTRL_EDIT_RETURN"));
/////////////////////////////////////////////////////////////////////////////
// CXListCtrl2

BEGIN_MESSAGE_MAP(CXListCtrl2, CListCtrl)
	//{{AFX_MSG_MAP(CXListCtrl2)
...
#endif
	ON_REGISTERED_MESSAGE( WM_XLISTCTRL_EDIT_RETURN, OnEditReturn )
END_MESSAGE_MAP()


///////////////////////////////////////////////////////////////////////////////
// ctor
CXListCtrl2::CXListCtrl2()
{
	...
	m_crUsrHighLight = NULL;
	m_crUsrHighLightText = NULL;
	m_bShowEmptyMessage = FALSE;
...
///////////////////////////////////////////////////////////////////////////////
// PreSubclassWindow
void CXListCtrl2::PreSubclassWindow()
{
...
///////////////////////////////////////////////////////////////////////////////
// OnCreate
int CXListCtrl2::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	// When the CXListCtrl2 object is created via a call to Create(), instead
...
///////////////////////////////////////////////////////////////////////////////
// SubclassHeaderControl
void CXListCtrl2::SubclassHeaderControl()
{
...
///////////////////////////////////////////////////////////////////////////////
// OnClick
BOOL CXListCtrl2::OnClick(NMHDR*, LRESULT* pResult)
{
#ifndef DO_NOT_INCLUDE_XCOMBOLIST
	UnpressComboButton();
#endif
...
///////////////////////////////////////////////////////////////////////////////
// OnCustomDraw
void CXListCtrl2::OnCustomDraw(NMHDR* pNMHDR, LRESULT* pResult)
{
...
///////////////////////////////////////////////////////////////////////////////
// DrawProgress
void CXListCtrl2::DrawProgress(int nItem,
							  int nSubItem,
							  CDC *pDC,
							  COLORREF crText,
							  COLORREF crBkgnd,
							  ...
							  XLISTCTRLDATA *pXLCD)
{
	...
	CPen blackpen(PS_SOLID, 1, CLR_FONT_DEFAULT);
...
///////////////////////////////////////////////////////////////////////////////
// DrawComboBox
void CXListCtrl2::DrawComboBox(int nItem,
							  int nSubItem,
							  CDC *pDC,
							  COLORREF crText,
							  COLORREF crBkgnd,
							  ...
							  XLISTCTRLDATA *pXLCD)
{
	...
	{
		TRACE(_T("XListCtrl2: combo boxes require LVS_EX_FULLROWSELECT style\n"));
		ASSERT(FALSE);
	}
#endif
...
///////////////////////////////////////////////////////////////////////////////
// DrawCheckbox
void CXListCtrl2::DrawCheckbox(int nItem,
							  int nSubItem,
							  CDC *pDC,
							  COLORREF crText,
							  COLORREF crBkgnd,
...
///////////////////////////////////////////////////////////////////////////////
// GetDrawColors
void CXListCtrl2::GetDrawColors(int nItem,
							   int nSubItem,
							   COLORREF& colorText,
							   COLORREF& colorBkgnd)
{
...
//			crText  = m_crHighLightText;
			crText  = colorText;
			if(crBkgnd==RGB(255,255,255)||crBkgnd==RGB(239,243,246))
			{
...
///////////////////////////////////////////////////////////////////////////////
// DrawImage
int CXListCtrl2::DrawImage(int nItem,
						  int nSubItem,
						  CDC* pDC,
						  COLORREF crText,
						  COLORREF crBkgnd,
...
///////////////////////////////////////////////////////////////////////////////
// DrawText
void CXListCtrl2::DrawText(int nItem,
						  int nSubItem,
						  CDC *pDC,
						  COLORREF crText,
						  COLORREF crBkgnd,
						  ...
						  XLISTCTRLDATA *pXLCD)
{
	...
	if (!str.IsEmpty())
	{
		...
		boldfont.DeleteObject();//KHD
	}
}

///////////////////////////////////////////////////////////////////////////////
// GetSubItemRect
BOOL CXListCtrl2::GetSubItemRect(int nItem,
								int nSubItem,
								int nArea,
								CRect& rect)
{
...
///////////////////////////////////////////////////////////////////////////////
// OnLButtonDown
void CXListCtrl2::OnLButtonDown(UINT nFlags, CPoint point)
{
	TRACE(_T("in CXListCtrl2::OnLButtonDown\n"));
	...
	else
	{
		...
		else
		{
			...
			//==========================================================
			// 2005. 08. 22
			//돌려보기 가 자동으로 진행중일 경우 Check 해제 하지 않는다.
			//==========================================================
			if(m_bAutoRunRecycle)
			{
			...
			if (pXLCD[nSubItem].nCheckedState >= 0)
			{
				...
				if (pWnd && ::IsWindow(pWnd->m_hWnd))
					pWnd->SendMessage(WM_XLISTCTRL2_CHECKBOX_CLICKED, 
								nItem, nSubItem);
...
///////////////////////////////////////////////////////////////////////////////
// OnPaint
void CXListCtrl2::OnPaint()
{
    Default();
/*
	if (GetItemCount() <= 0&&m_bShowEmptyMessage)
	{
		CDC* pDC = GetDC();
...
///////////////////////////////////////////////////////////////////////////////
// InsertItem
int CXListCtrl2::InsertItem(const LVITEM* pItem)
{
...
///////////////////////////////////////////////////////////////////////////////
// InsertItem
int CXListCtrl2::InsertItem(int nItem, LPCTSTR lpszItem)
{
	ASSERT(nItem >= 0);
	if (nItem < 0)
		return -1;
...
///////////////////////////////////////////////////////////////////////////////
// InsertItem
int CXListCtrl2::InsertItem(int nItem,
						   LPCTSTR lpszItem,
						   COLORREF crText,
...
///////////////////////////////////////////////////////////////////////////////
// SetItem
int CXListCtrl2::SetItem(const LVITEM* pItem)
{
	ASSERT(pItem->iItem >= 0);
	if (pItem->iItem < 0)
		return -1;
...
///////////////////////////////////////////////////////////////////////////////
// SetItemImage
BOOL CXListCtrl2::SetItemImage(int nItem, int nSubItem, int nImage)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// SetItemText
BOOL CXListCtrl2::SetItemText(int nItem, int nSubItem, LPCTSTR lpszText)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// DeleteItem
BOOL CXListCtrl2::DeleteItem(int nItem)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// DeleteAllItems
BOOL CXListCtrl2::DeleteAllItems()
{
	int n = GetItemCount();
	for (int i = 0; i < n; i++)
	{
...
void CXListCtrl2::OnDestroy()
{
	...
	if(m_ListboxFont.GetSafeHandle())
	{
		m_ListboxFont.DeleteObject();//KHD
	}
	CListCtrl::OnDestroy();
}
...
//
BOOL CXListCtrl2::SetProgress(int nItem,
							 int nSubItem,
...
///////////////////////////////////////////////////////////////////////////////
// DeleteProgress
void CXListCtrl2::DeleteProgress(int nItem, int nSubItem)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// UpdateProgress
void CXListCtrl2::UpdateProgress(int nItem, int nSubItem, int nPercent)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// SetCheckbox
BOOL CXListCtrl2::SetCheckbox(int nItem, int nSubItem, int nCheckedState)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// GetCheckbox
int CXListCtrl2::GetCheckbox(int nItem, int nSubItem)
{
	ASSERT(nItem >= 0);
	int nTotItem = GetItemCount();
	ASSERT(nItem < GetItemCount()); 
	//함수는 논리식이 참이면 특별한 것을 하지 않습니다. 
	//그러나 거짓이면 에러를 표현 합니다. 
...
//
BOOL CXListCtrl2::GetEnabled(int nItem)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// SetEnabled
BOOL CXListCtrl2::SetEnabled(int nItem, BOOL bEnable)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// SetBold
BOOL CXListCtrl2::SetBold(int nItem, int nSubItem, BOOL bBold)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// GetBold
BOOL CXListCtrl2::GetBold(int nItem, int nSubItem)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
//
BOOL CXListCtrl2::SetComboBox(int nItem,
							 int nSubItem,
							 BOOL bEnableCombo,
							 CStringArray *psa,
...
//
CString	CXListCtrl2::GetComboText(int nItem, int nSubItem)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
// SetEditBox
//
// Note:  SetItemText may also be used to set the initial EditBox.
//
BOOL CXListCtrl2::SetEditBox(int nItem,
							 int nSubItem,
							 BOOL bUseEditBox /*= TRUE*/)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
	...
	// update flag
	pXLCD[nSubItem].bUseEditBox = bUseEditBox;
...
///////////////////////////////////////////////////////////////////////////////
// SetCurSel
BOOL CXListCtrl2::SetCurSel(int nItem, BOOL bSelect /*= TRUE*/)
{
	if(!bSelect)
	{
		return SetItemState(nItem,  !LVIS_SELECTED,
			LVIS_SELECTED);
	}
...
///////////////////////////////////////////////////////////////////////////////
// UpdateSubItem
void CXListCtrl2::UpdateSubItem(int nItem, int nSubItem)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
//
DWORD CXListCtrl2::GetItemData(int nItem)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// SetItemData
BOOL CXListCtrl2::SetItemData(int nItem, DWORD dwData)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
//     2 = checked
//
int CXListCtrl2::GetHeaderCheckedState(int nSubItem)
{
	ASSERT(nSubItem >= 0);
	ASSERT(nSubItem < GetColumns());
	if ((nSubItem < 0) || nSubItem >= GetColumns())
...
BOOL CXListCtrl2::SetHeaderCheckedState(int nSubItem, int nCheckedState)
{
	ASSERT(nSubItem >= 0);
	ASSERT(nSubItem < GetColumns());
	if ((nSubItem < 0) || nSubItem >= GetColumns())
...
///////////////////////////////////////////////////////////////////////////////
// OnColumnClick
BOOL CXListCtrl2::OnColumnClick(NMHDR* pNMHDR, LRESULT* pResult)
{
...
///////////////////////////////////////////////////////////////////////////////
// CountCheckedItems
int CXListCtrl2::CountCheckedItems(int nSubItem)
{
	ASSERT(nSubItem >= 0);
	ASSERT(nSubItem < GetColumns());
	if ((nSubItem < 0) || nSubItem >= GetColumns())
...
///////////////////////////////////////////////////////////////////////////////
// OnSysColorChange
void CXListCtrl2::OnSysColorChange()
{
	TRACE(_T("in CXListCtrl2::OnSysColorChange\n"));
	...
	if(m_crUsrHighLight)
	{
		m_crHighLight     = m_crUsrHighLight;
	}
	else
	{
		m_crHighLight     = ::GetSysColor(COLOR_HIGHLIGHT);
	}
	if(m_crUsrHighLightText)
	{
		m_crHighLightText = m_crUsrHighLightText;
	}
	else
	{
		m_crHighLightText = ::GetSysColor(COLOR_HIGHLIGHTTEXT);
...
///////////////////////////////////////////////////////////////////////////////
// UnpressComboButton
void CXListCtrl2::UnpressComboButton()
{
...
//
void CXListCtrl2::OnTimer(UINT nIDEvent)
{
			...
			if (i != LB_ERR)
			{
					...
					(m_nComboSubItem >= 0 && m_nComboSubItem < GetColumns()))
				{
					...
					if (!pWnd)
						pWnd = GetOwner();
					if (pWnd && ::IsWindow(pWnd->m_hWnd))
						pWnd->SendMessage(WM_XLISTCTRL2_COMBO_SELECTION, 
...
///////////////////////////////////////////////////////////////////////////////
// OnComboEscape
LRESULT CXListCtrl2::OnComboEscape(WPARAM, LPARAM)
{
	KillTimer(1);
	SetTimer(2, 50, NULL);
...
///////////////////////////////////////////////////////////////////////////////
// OnComboReturn
LRESULT CXListCtrl2::OnComboReturn(WPARAM, LPARAM)
{
	TRACE(_T("in CXListCtrl2::OnComboReturn\n"));
	KillTimer(1);
	SetTimer(3, 50, NULL);
	return 0;
}
...
///////////////////////////////////////////////////////////////////////////////
// OnComboLButtonUp
LRESULT CXListCtrl2::OnComboLButtonUp(WPARAM, LPARAM)
{
	TRACE(_T("in CXListCtrl2::OnComboLButtonUp\n"));
	KillTimer(1);
	SetTimer(3, 50, NULL);
	return 0;
}
...
///////////////////////////////////////////////////////////////////////////////
// OnComboKeydown
LRESULT CXListCtrl2::OnComboKeydown(WPARAM, LPARAM)
{
	SetTimer(4, 50, NULL);
	return 0;
}
...
///////////////////////////////////////////////////////////////////////////////
// OnToolHitTest
int CXListCtrl2::OnToolHitTest(CPoint point, TOOLINFO * pTI) const
{
...
///////////////////////////////////////////////////////////////////////////////
// OnToolTipText
BOOL CXListCtrl2::OnToolTipText(UINT /*id*/, NMHDR * pNMHDR, LRESULT * pResult)
{
	UINT nID = pNMHDR->idFrom;
	TRACE(_T("in CXListCtrl2::OnToolTipText: id=%d\n"), nID);
...
///////////////////////////////////////////////////////////////////////////////
// SetItemToolTipText
BOOL CXListCtrl2::SetItemToolTipText(int nItem, int nSubItem, LPCTSTR lpszToolTipText)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// GetItemToolTipText
CString CXListCtrl2::GetItemToolTipText(int nItem, int nSubItem)
{
	CString strToolTip;
	strToolTip = _T("");
...
///////////////////////////////////////////////////////////////////////////////
// DeleteAllToolTips
void CXListCtrl2::DeleteAllToolTips()
{
...
BOOL CXListCtrl2::OnDblclk(NMHDR* pNMHDR, LRESULT* pResult) 
{
	// TODO: Add your control notification handler code here
	NMLISTVIEW* pnmlv = (NMLISTVIEW*)pNMHDR;

	//2005. 07. 23 ===========================================
	if(pnmlv->iItem < 0) return FALSE;
	//========================================================

	XLISTCTRLDATA *pXLCD = (XLISTCTRLDATA *) CListCtrl::GetItemData(pnmlv->iItem);
	if (!pXLCD)
	{
		*pResult = 0;
		return FALSE;
	}
	if (!pXLCD[pnmlv->iSubItem].bEnabled)
	{
		*pResult = 0;
		return FALSE;
	}
	if(pXLCD[pnmlv->iSubItem].bUseEditBox)
	{
		CRect rect;
		m_nEditItem = pnmlv->iItem;
		m_nEditSubItem = pnmlv->iSubItem;
		m_pEdit = new CXEdit;
		m_strEdit = GetItemText( m_nEditItem, m_nEditSubItem );
		GetSubItemRect(m_nEditItem, m_nEditSubItem , LVIR_LABEL, rect );
		rect.InflateRect(0,2);
		m_pEdit->Create( WS_VISIBLE | WS_BORDER | ES_AUTOHSCROLL | ES_LEFT | ES_WANTRETURN, rect, this, NULL );
		m_pEdit->SetFont(GetFont());
		m_pEdit->SetWindowText( m_strEdit );
		m_pEdit->SetFocus();	
		m_pEdit->SetSel( 0, m_strEdit.GetLength() );
		*pResult = 0;
		return TRUE;
	}
...
LRESULT CXListCtrl2::OnEditReturn( WPARAM wParam, LPARAM lParam )
{	
	LRESULT lResult = NULL;
	CString clstrLParam = (LPCTSTR)lParam;
	if ( clstrLParam == "esc" )
	{
		if ( m_pEdit != NULL )
		{
	...
	CString clstrText = (LPCTSTR)wParam;

	delete m_pEdit;
	m_pEdit = NULL;

	if ( m_strEdit == clstrText )
	{
		return lResult;
	}
	SetItemText( m_nEditItem, m_nEditSubItem, clstrText );	
	return( lResult );
}

void CXListCtrl2::SetSortImage(int nCol,int nType)
{
	if(nType==2)
	{
		m_HeaderCtrl.SetSortImage( nCol, !m_HeaderCtrl.IsAscending());
	}
	else
	{
		m_HeaderCtrl.SetSortImage( nCol, (BOOL)nType);
	}
