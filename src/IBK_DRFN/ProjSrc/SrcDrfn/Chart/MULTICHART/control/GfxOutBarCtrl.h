...
#define WMU_OUTBAR_NOTIFY		WM_USER + 1217
...
public:
//	COLORREF	m_crBgTop;
//	COLORREF	m_crBgButtom;
	COLORREF	crBackGroundColor, crBackGroundColor1;
	COLORREF	crTextColor, crSelTextColor;
	COLORREF	cr3dFace, cr3dUnFace, crHilightBorder, crDkShadowBorder;

//	COLORREF	m_clBarSelStart;		// 선택된 바 시작 색
//	COLORREF	m_clBarSelEnd;			// 선택된 바 끝 색
//	COLORREF	m_clBarStart;			// 보통 바 시작 색
//	COLORREF	m_clBarEnd;				// 보통 바 끝 색
//	COLORREF	m_clTextShadow;			// 텍스트 그림자(보통일때만)
...
public:
	...
	void SetBackColor(BOOL bGradient, COLORREF bgTop, COLORREF bgBottom, COLORREF TextColor, COLORREF sTextColor);
	...
	void SetFolderData(int iFolder, DWORD dwData);
	...
	int SetSelFolder(LPCSTR szFolder);
...
//2006.09.25 by LYH Folder Image 처리
