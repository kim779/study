...
BEGIN_MESSAGE_MAP(CDlgSettingToolBar, CDialog)
	...
	ON_BN_CLICKED(IDC_BTN_MOVSYP, OnBtnMovsyp)
...
void CDlgSettingToolBar::OnApply() 
{
	...
	strConfigPath.Format("%s\\%s", strPath, "ChartToolBarSetting.dat");
...
//-----------------------------------------------------------------------------
// Author		:	Hui-Syn, Lee	Date :2006.09.11
// Modifier		: 
...
void CDlgSettingToolBar::OnBtnMovsyp() 
{
	int nSelectedKey;
