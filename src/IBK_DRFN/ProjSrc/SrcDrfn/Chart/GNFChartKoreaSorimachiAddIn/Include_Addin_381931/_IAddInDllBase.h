...
public:
	typedef enum
	{
		...
		ADDINEVENT( OnPacketData_Not_Used),			// OnPacketData( const char *p_szPacketNames, BOOL p_bWithReset)
		//	********************************************************************************
		//	* Caution! Do not change the Order. It is already referenced by other AddIn DLLs
		//	********************************************************************************
		...
		ADDINEVENT( OnUpdatePacketData),							// OnUpdatePacketData( BOOL p_bTrUpdate)	//2008.08.07 김진순
