...
#undef _XTP_INCLUDE_TABMANAGER

#undef __XTPVERSION_H__

#include "XTPIncludes.h"

#undef _SYSTEMTRADING_FILE_PREFIX
#define _SYSTEMTRADING_FILE_PREFIX _T("SystemTrading")

// #undef _SYSTEMTRADING_FOLDER_PREFIX
// #if defined( _DEBUG )
// 	#define _SYSTEMTRADING_FOLDER_PREFIX _T("libd/")
// #else
// 	#define _SYSTEMTRADING_FOLDER_PREFIX _T("lib/")
// #endif // _DEBUG
...
//#define _XTPLIB_FILE_PREFIX _T("../../../Library/")
#define _XTPLIB_FILE_PREFIX _T("../../Lib/")

#if defined(_XTP_DEMOMODE)
	//#define _XTPLIB_FILE_PREFIX_FULL _XTPLIB_FILE_PREFIX _SYSTEMTRADING_FOLDER_PREFIX _SYSTEMTRADING_FILE_PREFIX "Eval"
#define _XTPLIB_FILE_PREFIX_FULL _XTPLIB_FILE_PREFIX _SYSTEMTRADING_FILE_PREFIX "Eval"
#else
	//#define _XTPLIB_FILE_PREFIX_FULL _XTPLIB_FILE_PREFIX _SYSTEMTRADING_FOLDER_PREFIX _SYSTEMTRADING_FILE_PREFIX
#define _XTPLIB_FILE_PREFIX_FULL _XTPLIB_FILE_PREFIX _SYSTEMTRADING_FILE_PREFIX
#endif
