...
protected:
	...
	CPen m_penShadow;						// Shadow pen.
	CPen m_penBackSel;						// Selected background pen.
	CPen m_penBackNonSel;					// Non-selected background pen.
	CPen m_penOutline;						// Outline pen.
	CPen m_penWindow;						// Window pen.
...
public:
	...
	// Input:   nBar - Specifies the type of scroll bar. The parameter can take one of the following values:
	//			<pre>
	//			SB_HORZ - Retrieves the position of the horizontal scroll bar. 
	//			SB_VERT - Retrieves the position of the vertical scroll bar.
	//			</pre>
	// Summary: This method obtains a pointer to the specified sibling scroll bar for the flat tab control. 
