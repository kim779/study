...
//     color.
//===========================================================================
class _XTP_EXT_CLASS CXTEyeDropper : public CWnd
{
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTEyeDropper object
	//-----------------------------------------------------------------------
	CXTEyeDropper();

	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTEyeDropper object, handles cleanup and deallocation
	//-----------------------------------------------------------------------
	virtual ~CXTEyeDropper();

	//{{AFX_VIRTUAL(CXTEyeDropper)
protected:
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called by the CXTEyeDropper class to
...
protected:
	...
	CXTEyeDropper m_wndEyeDropper; // TODO
...
AFX_INLINE void CXTEyeDropper::SetClipboard(BOOL bSetClipboard) {
	m_bSetClipboard = bSetClipboard;
}
AFX_INLINE void CXTEyeDropper::ShowPreview(BOOL bShowPreview) {
	m_bShowPreview = bShowPreview;
}

/////////////////////////////////////////////////////////////////////////////
// CXTEyeDropper window
...
const DWORD CPS_XT_SHOWEYEDROPPER  = 0x0080;  //<ALIAS CXTColorDialog::CXTColorDialog@COLORREF@COLORREF@DWORD@CWnd*>
