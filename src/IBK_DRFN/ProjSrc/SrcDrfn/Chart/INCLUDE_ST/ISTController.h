...
#if !defined(AFX_ISTCONTROLLER_H__75B03A52_3933_4AD6_AF22_9F4DB37584F8__INCLUDED_)
#define AFX_ISTCONTROLLER_H__75B03A52_3933_4AD6_AF22_9F4DB37584F8__INCLUDED_
...
#define CISTController CISTController0001

// 20060705 클래스선언 제거
//class CDBMgr;

class CISTController0001  
{
public:
	virtual ~CISTController0001() {};
	...
	virtual short Execute(LPCTSTR lpInputData) = 0;// return value: 0 = Fail, 1 = Normal Execution, 2 = Normal Execution but Raw data exists, 3 = execution after pause, 4 = cfg execuation
	virtual long Stop() = 0;
	...
	virtual BOOL PrepareGraph() = 0;
	virtual void SetPath(LPCTSTR lpPath) = 0;
	virtual void SetChartItem(long pChartItem) = 0;// KHD
	virtual long GetChartItem() = 0;// KHD
	...
	virtual void SetUserID(LPCTSTR lpUserID) = 0;
	virtual void SetPassword(LPCTSTR lpPassword) = 0;
	virtual void SetExpiredDate(long lExpriedDate) = 0;
	virtual long GetSourceType() = 0;
	virtual void SetSourceType(long lSourceType) = 0;
	virtual BOOL GetUseUserID() = 0;
	virtual BOOL GetUsePassword() = 0;
	virtual BOOL GetUseExpiredDate() = 0;
	virtual void SetUseUserID(BOOL bUse) = 0;
	virtual void SetUsePassword(BOOL bUse) = 0;
	virtual void SetUseExpiredDate(BOOL bUse) = 0;
	virtual void SetSTName(LPCTSTR lpSTName, int nSTPos) = 0;
	virtual void SetAdditonalOption(LPCTSTR lpAdditionalOption) = 0;
	virtual void SetpStringArrayInputs(CStringArray *pStringArrayInputs) = 0;

	virtual LPCTSTR GetError() = 0;
	virtual void ResetLastSignal_ForReal(long lCurrentPos) = 0;
...
#endif // !defined(AFX_ISTCONTROLLER_H__75B03A52_3933_4AD6_AF22_9F4DB37584F8__INCLUDED_)
