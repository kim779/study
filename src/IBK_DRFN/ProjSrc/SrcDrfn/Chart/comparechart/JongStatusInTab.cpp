	...
	: CRscDlg(CJongStatusInTab::IDD, pParent)
{
	...
	m_lCnt = 0;
	m_dDaebiRate = 0;
//	m_crUpLimit = RGB(190,2,1);
//	m_crUp = RGB(221,130,47);
//	m_crSteady = RGB(111,126,155);
//	m_crDown = RGB(107,191,228);
//	m_crDownLimit = RGB(1,83,165);
...
//	m_brUpLimit.CreateSolidBrush(m_crUpLimit);
//	m_brUp.CreateSolidBrush(m_crUp);
//	m_brSteady.CreateSolidBrush(m_crSteady);
//	m_brDown.CreateSolidBrush(m_crDown);
//	m_brDownLimit.CreateSolidBrush(m_crDownLimit);
	m_brBkColor.CreateSolidBrush(m_crBk);

//	COLORREF clrText = RGB(255,255,255);
//	m_stUpLimit.SetStaticColor(m_crUpLimit, m_crUpLimit, clrText);
//	m_stUp.SetStaticColor(m_crUp, m_crUp, clrText);
//	m_stSteady.SetStaticColor(m_crSteady, m_crSteady, clrText);
//	m_stDown.SetStaticColor(m_crDown, m_crDown, clrText);
//	m_stDownLimit.SetStaticColor(m_crDownLimit, m_crDownLimit, clrText);
	COLORREF clrText =	RGB(0,0,0);	// RGB(255,255,255);
...
//		if(pWnd->GetDlgCtrlID() == IDC_UPLIMIT)
//		{
//			pDC->SetBkColor(m_crUpLimit);
//			return (HBRUSH)m_brUpLimit;
//		}		
//		else if(pWnd->GetDlgCtrlID() == IDC_UP)
//		{
//			pDC->SetBkColor(m_crUp);
//			return (HBRUSH)m_brUp;
//		}		
//		else if(pWnd->GetDlgCtrlID() == IDC_STEADY)
//		{
//			pDC->SetBkColor(m_crSteady);
//			return (HBRUSH)m_brSteady;
//		}		
//		else if(pWnd->GetDlgCtrlID() == IDC_DOWN)
//		{
//			pDC->SetBkColor(m_crDown);
//			return (HBRUSH)m_brDown;
//		}		
//		else if(pWnd->GetDlgCtrlID() == IDC_DOWNLIMIT)
//		{
//			pDC->SetBkColor(m_crDownLimit);
//			return (HBRUSH)m_brDownLimit;
//		}
//		else if(pWnd->GetDlgCtrlID() == IDC_RATE)
//		{
...
//	m_brUpLimit.DeleteObject();
//	m_brUp.DeleteObject();
//	m_brSteady.DeleteObject();
//	m_brDown.DeleteObject();
//	m_brDownLimit.DeleteObject();	
