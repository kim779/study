...
//xSkinButton
#define	WM_CXSHADE_RADIO			(WM_USER + 2400)
/////////////////////////////////////////////////////////////////////////////
// CxSkinButton window
...
public:
	...
	void SetSkin(CString strnormal="", CString strdown="", CString strover="", CString strdisabled="", 
						 CString strmask="", CString strfocus="",	 short drawmode=1,short border=1,short margin=4);
