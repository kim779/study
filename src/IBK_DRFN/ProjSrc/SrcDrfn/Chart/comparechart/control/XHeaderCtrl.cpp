...
//	m_cr3DShadow = RGB(103,119,138);
	m_cr3DShadow	= RGB(186,176,141); //RGB(64,144,222);
//	m_cr3DFace      = ::GetSysColor(COLOR_3DFACE);
//	m_cr3DFace		= RGB(239,242,249);
	m_cr3DFace		= RGB(232,226,210);
//	m_crBtnText     = ::GetSysColor(COLOR_BTNTEXT);
	m_crBtnText		= RGB(0,0,1);
...
//	pDC->SelectObject(GetStockObject(DEFAULT_GUI_FONT));
	CFont* pof = pDC->SelectObject(&m_Font);
...
int CXHeaderCtrl::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
