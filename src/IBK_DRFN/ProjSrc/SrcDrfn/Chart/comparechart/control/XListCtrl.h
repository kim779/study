...
extern UINT NEAR WM_XLISTCTRL_DBCLICK;
///////////////////////////////////////////////////////////////////////////////
...
//	void	ShowEmptyMessage() { m_bShowEmptyMessage = TRUE; Invalidate();}
	...
	BOOL	SetCheckbox(int nItem, int nSubItem, int nCheckedState, BOOL bDraw=TRUE);
	...
	XLISTCTRLDATA* GetItemListCtrlData(int nItem);
