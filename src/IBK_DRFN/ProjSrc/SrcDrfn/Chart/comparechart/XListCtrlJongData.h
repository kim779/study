...
public:
	...
	//2005. 07. 27 ===================================================================
	void InsertCodeData_HanHwa(LPCTSTR lpCode, LPCTSTR lpName, BOOL bKeeping);
	//================================================================================
	...
	void	InsertCodeData(LPCTSTR lpCode, LPCTSTR lpName,CString strPrice,CString strChange,CString strChgrate,CString strVolume, char chSign,BOOL bKeeping = FALSE);
	...
	void	SetCursorPrev(int nCnt);
	void	SetCursorNext(int nCnt);
...
private:	
	...
	CStringArray	m_arKOSPICode , m_arKOSPIName ;
	CStringArray	m_arKOSDAQCode, m_arKOSDAQName;
