...
public:
	...
	afx_msg long OnWinixNotifyLoad(WPARAM wParam, LPARAM lParam); //@Solomon 위닉스의 관심
	afx_msg long OnWinixNotifySave(WPARAM wParam, LPARAM lParam); //@Solomon 위닉스의 관심
	afx_msg long OnWinixNotifyGroup(WPARAM wParam, LPARAM lParam); //@Solomon 위닉스의 관심
	afx_msg long OnWinixNotifyGroupList(WPARAM wParam, LPARAM lParam); //@Solomon 위닉스의 관심
	afx_msg long OnWinixNotifySaveCode(WPARAM wParam, LPARAM lParam); //@Solomon 위닉스의 관심
