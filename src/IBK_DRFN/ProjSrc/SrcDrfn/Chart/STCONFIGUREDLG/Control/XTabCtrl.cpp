...
//		pWnd->ShowWindow(SW_SHOW);
		...
		pWnd->SetWindowPos(NULL, rc.left + m_ptTabs.x, rc.top + m_ptTabs.y, rc.Width() - m_ptTabs.x + m_nLeftOffset, rc.Height() - m_ptTabs.y + m_nUpperOffset, SWP_SHOWWINDOW|SWP_NOSIZE);
