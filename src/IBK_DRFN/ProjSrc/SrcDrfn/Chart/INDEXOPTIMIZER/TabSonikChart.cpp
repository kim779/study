...
int nInCount : 데이터갯수(수익률 수), RoundToUnit( int p_nIndex)는 데이터의 영역을 계산한다.
------------------------------------------------------------------------------------- */
...
//*보합(0)에 대한 데이터는 차트상에 그려지지 않는다. 그리고
// 이익건수와 손실건수에 포함되지 않으며 총매매건수에 포함되어 승률에 반영된다.
--------------------------------------------------------------------------------------- */
...
//////////////////////////////////////////////////////////////////////////////////////////
//		m_ctlBarTChart.Series(0).AddXY(nIndex, nValue, "", clr);
//		봉의 위치를 수정할때 차트상의 0을 없애고 데이터의 중간에 넣고 싶다면...
//		밑의 소스를 사용. 그리고 teechart속성에서series에 size의 barwidth를 100%한다. 
//////////////////////////////////////////////////////////////////////////////////////////
