...
CLabel& CLabel::SetBorderColor(COLORREF crBorderParm, int nWidth)
{
...
//		pDCMem->Rectangle(&rc);
	...
	// JSJ_Block	COMMENT: 위의 dwFlags 설정값들을 바꿔버리므로 막자!
...
BOOL CLabel::SignDraw(CWnd *pWnd, int Style)
{
	pStyle = Style;
	CRect rect;
