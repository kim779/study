...
/////////////////////////////////////////////////////////////////////////
// CSCBButton (button info) helper class Start
...
// CSCBButton (button info) helper class End
/////////////////////////////////////////////////////////////////////////
...
// Operations
public:
    virtual void LoadState(LPCTSTR lpszProfileName, BOOL bInit = FALSE);
...
public:
	...
	void SetBkColor(COLORREF color);
	void SetUseGradient(BOOL bUse, COLORREF clStart, COLORREF clEnd);
	void SetMinSize(int x, int y);
	void NcPaintGripperWithExitBtn(CDC* pDC, CRect rcClient);
...
protected:
	...
	void SetHVEdges(CSize szEdges = CSize(5, 5));
...
public:
	...
	int		m_nUserType;
	CString	m_szRootPath, m_szUserID;
	int		m_nType;
	CRect	m_rect;
