...
public:
	...
	void SetDragDrop(BOOL bDnD = FALSE){ m_bDragDrop = bDnD; }
...
protected:
	...
	BOOL		m_bEmulated;
	BOOL		m_bBandLabel;
	BOOL		m_bDragDrop;	// 드래그 드롭 지원 위해..(2003/7/25 최유강 추가)
...
#define DD_LBDOWN		WM_USER+1
#define DD_MOUSEMOVE	WM_USER+2
#define DD_LBUP			WM_USER+3
