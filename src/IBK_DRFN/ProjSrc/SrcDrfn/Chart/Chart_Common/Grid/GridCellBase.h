...
#define	GVIS_STATIC				0x0100
#define	GVIS_BOLDFONT			0x0200				// JSJ_ADD_041015(for bold font)
#define	GVIS_CHARTPRICE			0x0400				// JSJ_ADD_041015(for chart price row)
#define GVIS_CELLEDITABLE		0x0800				// JSJ_ADD_050126(for unit cell editable)

// Cell data mask
#define GVIF_TEXT               LVIF_TEXT			// 0x0001
#define GVIF_IMAGE              LVIF_IMAGE			// 0x0002
#define GVIF_PARAM              LVIF_PARAM			// 0x0004
#define GVIF_STATE              LVIF_STATE			// 0x0008
