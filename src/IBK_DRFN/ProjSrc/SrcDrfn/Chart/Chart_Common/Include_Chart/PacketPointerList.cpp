...
void CSubGraphPacketList::AddTail(CPacket* pPacket)
{
	if(pPacket != NULL)
...
// ----------------------------------------------------------------------------
const CList<CPacket*, CPacket*>& CSubGraphPacketList::GetSubGraphPacketList() const
{
	return m_packetList;
}

CList<CPacket*, CPacket*>* CSubGraphPacketList::GetSubGraphPacketList()
{
	return &m_packetList;
}
