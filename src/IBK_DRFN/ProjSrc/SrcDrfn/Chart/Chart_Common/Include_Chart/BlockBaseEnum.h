...
public:
	...
	enum TOOLOPTION
	{
		...
		T_TOOL_OVER_CROSS,				// (2006/2/8 - Seung-Won, Bae) CrossLine Tool for Numerical Inquiry
		T_TOOL_OVER_CROSS_WITH_NIDLG,	// (2006/2/14 - Seung-Won, Bae) CrossLine Tool with Numerical Inquiry Dialog

		T_TOOL_DRAG_CROSS,				// (2006/2/16 - Seung-Won, Bae) CrossLine Tool on Drag
		T_TOOL_DRAG_INQUIRY_VALUE,		// (2006/2/16 - Seung-Won, Bae) Numerical Inquiry Tool on Drag
		T_TOOL_DRAG_CROSS_WITH_NIDLG,	// (2006/2/14 - Seung-Won, Bae) CrossLine Tool with Numerical Inquiry on Drag

		//////////////////////////////////////////////////////////////////////
		// (2005/10/26 - Seung-Won, Bae) Add AddIn Tool ID
		//////////////////////////////////////////////////////////////////////
		T_ADDIN_ORDER_LINE = 1000			// Order Line
