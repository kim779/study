// IWAddInDll050116.cpp: implementation of the CIWAddInDll050116 class.
//
//////////////////////////////////////////////////////////////////////

//////////////////////////////////////////////////////////////////////
// *. 주의!	050116 Version의 OCX에서 이용되는 AddIn측 Interface의 Wrapper로 기능 추가만 가능합니다.
...
#include "stdafx.h"
#include "IWAddInDll050116.h"

#include "IChartAddIn050116.h"	// for IChartAddIn050116
...
CIWAddInDll050116::CIWAddInDll050116( const char *p_szAddInModule, HMODULE p_hAddInDll)
{
	m_hAddInDll		= p_hAddInDll;
	m_strModuleName	= p_szAddInModule;
	if( !m_hAddInDll)
	{
		AfxMessageBox( "CIWAddInDll050116 Null Wrapping Error!");
		return;
	}
...
CIWAddInDll050116::~CIWAddInDll050116()
{
...
IAddInDll *CIWAddInDll050116::CreateAddInDLLIWrapper( const char *p_szAddInModule, HMODULE p_hAddInDll, int p_nAddInIVersion)
{
	...
	{
		case CIWAddInDll050116::IVERSION:	pIAddInDll = new CIWAddInDll050116( p_szAddInModule, p_hAddInDll);
											break;
	}
...
// (2004.10.08, 배승원) 초기화시에 IAddInManager(ChartOcx Interface Gateway)를 전달하여
//		DLL의 AddIn Interface를 확보한다.
typedef IChartAddIn050116 *( *FN_InitAddInDll)( IAddInManager *p_pIAddInManager);	
BOOL CIWAddInDll050116::InitAddInDll( IAddInManager *p_pIAddInManager)
{
...
IUnknown *CIWAddInDll050116::GetIChartAddIn( void)
{
