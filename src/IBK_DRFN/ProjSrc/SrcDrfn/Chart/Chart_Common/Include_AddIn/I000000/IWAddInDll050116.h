// IWAddInDll050116.h: interface for the CIWAddInDll050116 class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_IWADDINDLL050116_H__65094346_094B_47EE_B618_FD0F5DC225F8__INCLUDED_)
#define AFX_IWADDINDLL050116_H__65094346_094B_47EE_B618_FD0F5DC225F8__INCLUDED_
...
#include "../I000000/IChartAddIn050116.h"	// IChartAddIn050116

class CIWAddInDll050116 : public CIWUnknown, public IAddInDll
{

// [04/10/07]
public:
	CIWAddInDll050116( const char *p_szAddInModule, HMODULE p_hAddInDll);
protected:
	virtual ~CIWAddInDll050116();
...
typedef enum EIVERSION	{ IVERSION = _IWRAPPER_DECIMAL( 050116)	};
...
protected:
	IChartAddIn050116 *	m_pIChartAddIn;
public:
...
#endif // !defined(AFX_IWADDINDLL050116_H__65094346_094B_47EE_B618_FD0F5DC225F8__INCLUDED_)
