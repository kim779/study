...
BOOL CEuChart::SaveandOpenFromAnalToolFile(LPCTSTR lpszOpenFileName, LPCTSTR lpszSaveFileName, BOOL bOpenOption, BOOL bSaveOption) 
{
	BOOL result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR VTS_BOOL VTS_BOOL;
...
void CEuChart::UseDummyPacketData(BOOL bUse) 
{
	static BYTE parms[] =
		VTS_BOOL;
