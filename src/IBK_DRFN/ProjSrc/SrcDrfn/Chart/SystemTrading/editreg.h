...
#define	REG_CONV_SUBKEY		_T("ConvertFile\\Flag")
#define REG_FIND_SUBKEY		_T("CrystalEdit\\Find")
#define REG_FINDFILE_SUBKEY	_T("CrystalEdit\\FindFile")
...
#define REG_FINDFILE_STS	_T("Strategy")
#define REG_FINDFILE_UFT	_T("Function")
#define	REG_CONV_FLAG		_T("FLAG")
