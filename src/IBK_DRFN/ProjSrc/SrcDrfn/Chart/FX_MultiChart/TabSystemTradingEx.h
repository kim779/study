...
public:
	...
	public:
		...
		//<<20100308_JS.Kim
		STDMETHOD_(LONG, GetOutBarColor) (COLORREF& clrOLBkgrnd, COLORREF& clrOLOutLine) { return NULL; }
		//>>
	}m_xSTInterface;
...
//	STMNG_ITEMINFO	m_LastRunInfo;		// 전략,지표,강세약세 등 최종 실행되었을 때의 정보,070215
	...
	public:
		...
		//<<20100308_JS.Kim 솔로몬
		STDMETHOD_(LONG, GetViewHandle) () { return 0; };
		STDMETHOD_(LONG, GetOutBarColor) (COLORREF& clrOLBkgrnd, COLORREF& clrOLOutLine)	{return 0; };
		//>>
	} m_xSTRunManager;
