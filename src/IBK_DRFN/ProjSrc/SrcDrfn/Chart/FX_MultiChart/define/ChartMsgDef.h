...
// --> [Edit]  강지원 2008/12/11
#define UMSG_CREATESCREEN_LINK				WM_USER+221	// 호가테이블에서 주문화면을 띄워준다.
// <-- [Edit]  강지원 2008/12/11
...
#define HOUR_DATA_CHART			'5'		// 시	차트	2006. 09. 27 삼성차트
#define SEC_DATA_CHART			'6'		// 초   차트	2005. 09. 28 add by sy, nam
#define YEAR_DATA_CHART			'7'		// 년	차트	2005. 05. 19 add by sy, nam
...
#define QUERY_STRJONGMOK		"x56000$"
...
//{{ JS.Kim_20100903 Solomon 360분 이상 설정 가능토록 수정
//#define EDITPERIOD_MAX_CNT		(61)
#define EDITPERIOD_MAX_CNT		(360)
//}}

#define GWANSIM_GRPNO_LEN	(2)		//2005. 07. 25
#define GWANSIM_MAX			(100)	//2005. 07. 25

#define MK_STOCK_CHE 0
#define MK_STOCK_JAN 1
#define MK_FO_CHE 2
#define MK_FO_JAN 3
#define	MK_FX_CHE 4
#define	MK_FX_JAN 5
...
typedef struct _ST_SELCHART {
	...
	CString			m_strKey;
	int				m_nOrderType;			//20100316 솔로몬.FX  매매구분   0:매도, 1:매수
} ST_SELCHART;
...
typedef struct tagOpenPosition
{
...
}OPEN_POSITION; //포지션 리스트

// FX차트 주문 연동 - onlyojt (20091204)
typedef struct tagPendingOrder
{
