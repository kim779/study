...
// AxisAgent.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CAxisAgentApp, CWinApp)
...
// 유일한 CAxisAgentApp 개체입니다.

CAxisAgentApp theApp;

const GUID CDECL BASED_CODE _tlid =
		{0xb0af1f1d,0xaf01,0x4788,{0x94,0xfc,0xed,0x24,0xf9,0x13,0x7d,0xe3}};
...
BOOL CAxisAgentApp::InitInstance()
{
...
int CAxisAgentApp::ExitInstance()
{
	AfxOleTerm(FALSE);
