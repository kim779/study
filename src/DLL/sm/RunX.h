...
protected:
	...
	std::unique_ptr<class CNButton> m_play;
	std::unique_ptr<class CNButton> m_pause;
	std::unique_ptr<class CNButton> m_continue;
	std::unique_ptr<class CNButton> m_stop;
	std::unique_ptr<class CNButton> m_prev;
	std::unique_ptr<class CNButton> m_next;
#else
