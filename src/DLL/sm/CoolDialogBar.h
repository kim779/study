...
public:
    CCoolDialogBar(CWnd* parent, bool (*callback)(int, WPARAM, LPARAM), CWnd* wizard = NULL);
...
public:
    ...
    void ParingGroupList(char* data, int len);
    void ParingGroupCode(char* data, int len);
    //////////////////////////
    void	make_Ctrl();
...
protected:
    ...
    std::unique_ptr<class CBasebar0> m_cDialog;
#else
    class CBasebar0* m_cDialog;
#endif
