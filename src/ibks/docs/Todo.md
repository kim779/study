...
- [문서 목적](#문서-목적)
- [1. VBScript → Python 엔진 전환 프로젝트 (2026-06-08 ~ )](#1-vbscript-python-엔진-전환-프로젝트-2026-06-08)
  - [진행 현황 요약](#진행-현황-요약)
  - [단계 10: 실운영 테스트 (현재 진행 중)](#단계-10-실운영-테스트-현재-진행-중)
  - [단계 11: TEST 블록 제거](#단계-11-test-블록-제거)
  - [단계 12: VBScript → Python 일괄 변환 도구](#단계-12-vbscript-python-일괄-변환-도구)
- [2. 실운영 배포 계획](#2-실운영-배포-계획)
  - [배포 대상](#배포-대상)
  - [배포 체크리스트](#배포-체크리스트)
- [3. 알려진 버그 및 미처리 항목](#3-알려진-버그-및-미처리-항목)
  - [높은 우선순위](#높은-우선순위)
  - [중간 우선순위](#중간-우선순위)
  - [낮은 우선순위](#낮은-우선순위)
- [4. 문서 작업](#4-문서-작업)
...
- [5. 테스트 계획](#5-테스트-계획)
  ...
  - [회귀 테스트 (Regression Tests)](#회귀-테스트-regression-tests)
- [6. 리스크 분석](#6-리스크-분석)
  - [높은 리스크](#높은-리스크)
  - [중간 리스크](#중간-리스크)
- [7. 마일스톤](#7-마일스톤)
