...
BEGIN_DISPATCH_MAP(CfmObject, CfmBase)
	...
	DISP_FUNCTION(CfmObject, "SendMarket", _SendMarket, VT_EMPTY, VTS_I4)  //modi NTX
	//}}AFX_DISPATCH_MAP
END_DISPATCH_MAP()
...
void CfmObject::_SendMarket(long market)
{
	m_axform->DoSomething(doMARKETSEND, this, (WPARAM)market);
}
