...
BOOL CUpdate::OnInitDialog() 
{
	...
	//GetDlgItem(IDC_PROGRESS)->MoveWindow(CRect(83, 52, 233, 66));	// 2009.09.01 scbang : progress 바 위치이동
	GetDlgItem(IDC_PROGRESS)->MoveWindow(CRect(96, 52, 316, 66));	// 2010.01.04 scbang : 바 위치이동
