...
//#endif
	...
	{
#ifdef _DEBUG
		m_slog.Format("[axSock][patch][%s][%x][%s]�������� ������ ���� ������ �����ϴ� �ܰ�", __FUNCTION__, rsmH->resK, rsmH->resN);
		OutputDebugString(m_slog);
#endif
...
bool CWsh::GetUpdateList()
{
	...
	if (CFile::GetStatus(path, fs))  //�̰� �հ� ��ü �޴� ����?
	{
...
bool CWsh::MakeUpdateList()
{
	...
	if (m_state == stFlag::stAXIS)
	{
		...
		for (int ii = 0; ii < arr.GetSize(); ii++) //infoAXIS.new�� �ִ� ������ arr
		{
			str  = arr.GetAt(ii);
...
void CWsh::BeginRTM()
{
	...
	//	DWORD_PTR dwProcessAffinityMask = 0x01 | 0x02 | 0x03 | 0x04 | 0x05 | 0x06 | 0x07 | 0x08 | 0x09 | 0x0a;
		...
		//  
		//    slog.Format("[MULTICORE]axissock ������ ģȭ�� ����[%d]", ierror);
		//	OutputDebugString(slog);
		//}
		//else
		//{
		//	slog.Format("[MULTICORE]  axissock ���μ��� ģȭ�� ����");
		//	OutputDebugString(slog);
		//}
