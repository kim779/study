...
CfmCtrl::CfmCtrl(CAxisForm* axform, struct _formR* formR, bool drawOnly)
...
void CfmCtrl::ReadData(CString& data, bool edit, int col, int row)
{
...
LRESULT CALLBACK ControlProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	CfmCtrl* ctrl = (CfmCtrl *)GetWindowLongPtr(hwnd, GWLP_USERDATA);
	if (ctrl == NULL)
		return 0;
