...
CfmTreeView::CfmTreeView(CAxisForm* axform, struct _formR* formR)
...
void CfmTreeView::ReadData(CString& data, bool edit, int col, int row)
{
	data = _T("");
...
INT_PTR CfmTreeView::addSelect(Ctreeitem* item)
{
	int	index = -1;
