...
int CSearchListCtrl::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CSearchListCtrl::AddItem(int item, int subItem, CString str)
{
	LV_ITEM	lvi;
...
void CSearchListCtrl::OnLButtonDown(UINT nFlags, CPoint point)
{
...
void CSearchListCtrl::UpdateFocusCell(int nCol)
{
	m_FocusCol = nCol;
...
BOOL CSearchListCtrl::GetCellRect(int nRow, int nCol, CRect& rect)
{
	CRect rowRect;
