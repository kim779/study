...
protected:
	...
	CMap	<int, int, CString, CString>	m_infoMapHTS;
	CMap	<int, int, CString, CString>	m_infoMapMTS;
	CMap	<int, int, CString, CString>	m_infoMapCTMOBJ;
...
public:
	...
	void	SetCmtObjProp(DWORD idx, CString strProp);
	void	SetData(char media, CString sGroup);
...
protected:
	...
	void	initPropList();
	void	setPropList();
	void	loadPropertyFile(BYTE media, CString path);
	void	parseProperties(BYTE media, CString data);
