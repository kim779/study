...
int COutputWnd::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	{
		LONG_PTR ret;
		pWizard->InvokeHelper(DI_WIZARD, DISPATCH_METHOD, VT_I8, (void*)&ret, (BYTE*)(VTS_I4 VTS_I8), MAKEWPARAM(setTRACE, WM_USER), (LONG_PTR)this->m_hWnd);
	}
...
void COutputWnd::AddText(CString txt)
{
	m_edit.SetSel(-1, -1);
