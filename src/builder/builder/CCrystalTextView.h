...
protected:
	...
	bool	IsLeadByte(LPCTSTR pChar, int nLen);
	...
	virtual void DrawLineNumber(CDC *pdc, const CRect &rect, int nLineIndex);
...
// Implementation
public:
	CString SelCursorWord();
	void AdjustHangulCursor();
...
public:
	...
	afx_msg void OnSetLinNumber() { m_bLineNum = !m_bLineNum; Invalidate(); UpdateCaret(); }
};
