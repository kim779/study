...
struct	_formR {
	...
	DWORD	tRGB;			// text RGB   (0 ~ 255 or RGB value)
					// GRID data line RGB (0 ~ 255 or RGB value)
	...
	BYTE	cursor;			// cursor type on MouseOver
	...
	DWORD	rsvL[2];		// reserved DWORD
	BYTE	rsvB[4];		// reserved BYTE
};
...
#define	PN_ROUND		4	// round border
...
#define	FA_SAVE		0x20000000	// save data field
...
#define	PR_CHECKED	0x00000004		// checked
#define	PR_TRANSPARENT	0x00000008		// transparent
#define	PR_FLEXCB	0x00000008		// flexible combo item
#define	PR_IMAGE	0x00000010		// image including
#define	PR_SUM		0x00000010		// sum (on RTM)
#define	PR_ACCN		0x00000010		// account COMBO
#define	PR_HOVER	0x00000020		// hover image
#define	PR_SORT		0x00000020		// cellR : sort
#define	PR_LINES	0x00000020		// FM_TREE : has lines(indentation)
#define	PR_GRADIENT	0x00000020		// gradient brush
#define	PR_SPIN		0x00000020		// FM_EDIT : has spin control
#define	PR_CODE		0x00000040		// FM_EDIT : has code list
#define	PR_SUPRESS	0x00000040		// FM_GRID : supress same data
#define	PR_VERT		0x00000040		// FM_LABEL, FM_BUTTON, FM_PANEL : vertical text
#define	PR_IMAGETEXT	0x00000080		// FM_BUTTON : BTN_PUSH style image+text
#define	PR_LIST		0x00000080		// FM_EDIT : input history list
#define	PR_EDIT		0x00000100		// show edit format
#define	PR_THOUSAND	0x00000200		// convert '.' into "000"
#define	PR_BOLD		0x00000400		// bold font column
#define	PR_CODEx	0x00000400		// FM_EDIT : has code list, but recent code sort
#define	PR_MARK		0x00000800		// FM_GRID : head action mark
#define	PR_HIMAGE	0x00001000		// FM_GRID : image head
#define	PR_HIMAGETEXT	0x00002000		// FM_GRID : image+text head


//
//	formR.cursor
//	cellR.cursor, cellR.hcursor
//
#define	CS_NONE		0
#define	CS_SORTd	1			// sort cursor : descending
#define	CS_SORTa	2			// sort cursor : ascening (internal used)
#define	CS_POP		3			// pop onMouseOver
#define	CS_IBEAM	4			// I-beam cursor
#define	CS_CURSOR	10			// user-defined cursor base
...
struct	_cellR {
	...
	DWORD	properties;		// visible
					// sort
	BYTE	cursor;			// cursor type on MouseOver
	BYTE	hcursor;		// head cursor type on MouseOver
	...
	DWORD	vals[6];		// vals[0]
					...
					// vals[3]
					// COMBO style head data offset
					// sort start index (with PR_SORT)

					// vals[4]
					// COMBO style head display offset
					// BUTTON style head image files

					// vals[5]
					// COMBO style head entry count

	DWORD	rsvL[1];		// reserved DWORD
	BYTE	rsvB[4];		// reserved BYTE
};
...
#define	GO_LINE		0x02000000	// line border
#define	GO_BOTTOM	0x04000000	// bottom line
#define	GO_XXLS		0x08000000	// prohibit right-mouse excel menu
